...
`}),x=H.createShaderModule({code:e}),S=H.createShaderModule({code:Yt||`struct Camera {
  view: mat4x4f,
  proj: mat4x4f,
  eye: vec3f,
  _pad: f32,
...
`}}[e]||{}}var Ft=!1,Y=null,It={},Lt={};function Rt(){let e=document.getElementById(`shader-toggle`),t=document.getElementById(`shader-panel`);e.addEventListener(`click`,()=>{Ft=!Ft,t.classList.toggle(`open`,Ft),e.classList.toggle(`active`,Ft),Ft&&zt()}),document.getElementById(`shader-compile`).addEventListener(`click`,Ut),document.getElementById(`shader-reset`).addEventListener(`click`,Wt),document.getElementById(`shader-editor`).addEventListener(`keydown`,e=>{if(e.key===`Tab`){e.preventDefault();let t=e.target,n=t.selectionStart;t.value=t.value.substring(0,n)+`  `+t.value.substring(t.selectionEnd),t.selectionStart=t.selectionEnd=n+2}})}function zt(){let e=Pt(T.mode);Lt={...e},(!It._mode||It._mode!==T.mode)&&(It={...e,_mode:T.mode});let t=document.getElementById(`shader-tabs`);t.innerHTML=``;let n=Object.keys(e);Y=Y&&n.includes(Y)?Y:n[0];for(let e of n){let n=document.createElement(`button`);n.className=`shader-tab`+(e===Y?` active`:``),n.textContent=e,n.addEventListener(`click`,()=>{Bt(),Y=e,t.querySelectorAll(`.shader-tab`).forEach(t=>t.classList.toggle(`active`,t.textContent===e)),Vt()}),t.appendChild(n)}Vt()}function Bt(){Y&&(It[Y]=document.getElementById(`shader-editor`).value)}function Vt(){let e=document.getElementById(`shader-editor`);e.value=It[Y]||``,document.getElementById(`shader-status`).textContent=``,document.getElementById(`shader-status`).className=`shader-success`}function Ht(){Ft&&It._mode!==T.mode&&zt()}function Ut(){Bt();let e=It[Y],t=document.getElementById(`shader-status`);try{H.createShaderModule({code:e}).getCompilationInfo().then(n=>{let r=n.messages.filter(e=>e.type===`error`);r.length>0?(t.className=`shader-error`,t.textContent=r.map(e=>`Line ${e.lineNum}: ${e.message}`).join(`; `),t.title=r.map(e=>`Line ${e.lineNum}: ${e.message}`).join(`
`)):(t.className=`shader-success`,t.textContent=`Compiled OK — reset simulation to apply`,t.title=``,Gt(T.mode,Y,e))})}catch(e){t.className=`shader-error`,t.textContent=e.message,t.title=e.message}}function Wt(){Y&&Lt[Y]&&(It[Y]=Lt[Y],Vt(),Gt(T.mode,Y,Lt[Y]),document.getElementById(`shader-status`).className=`shader-success`,document.getElementById(`shader-status`).textContent=`Shader reset to original`)}function Gt(e,t,n){let r={boids:{"Compute (Flocking)":()=>{Kt=n},"Render (Vert+Frag)":()=>{qt=n}},physics:{"Compute (Gravity)":()=>{Jt=n},"Render (Vert+Frag)":()=>{Yt=n}},physics_classic:{"Compute (Classic)":()=>{Xt=n},"Render (Classic)":()=>{Zt=n}},fluid:{"Forces + Advect":()=>{Qt=n},Diffuse:()=>{$t=n},Divergence:()=>{en=n},"Pressure Solve":()=>{tn=n},"Gradient Sub":()=>{nn=n},Render:()=>{rn=n}},parametric:{"Compute (Mesh Gen)":()=>{an=n},"Render (Phong)":()=>{on=n}},reaction:{"Compute (Gray-Scott)":()=>{sn=n},"Render (Raymarch)":()=>{cn=n}}}[e]?.[t];r&&r()}var Kt=null,qt=null,Jt=null,Yt=null,Xt=null,Zt=null,Qt=null,$t=null,en=null,tn=null,nn=null,rn=null,an=null,on=null,sn=null,cn=null,X=null,Z=null,ln=null,un=null,dn=null,fn=!1,pn={boids:{key:`maxSpeed`,label:`Speed`,min:.1,max:10},physics:{key:`G`,label:`Gravity`,min:.01,max:100},physics_classic:{key:`G`,label:`Gravity`,min:.01,max:100},fluid:{key:`forceStrength`,label:`Force`,min:1,max:500},parametric:{key:`scale`,label:`Scale`,min:.1,max:5},reaction:{key:`feed`,label:`Feed`,min:0,max:.1}},Q=[`boids`,`physics`,`physics_classic`,`fluid`,`parametric`,`reaction`],$={hover:`none`,pressed:`none`,pressingSource:null,pendingPressSource:null,grabbed:!1,lastHitPx:0,lastHitPy:0,lastHitActive:!1,grabDragOriginWorld:null,grabDragOriginCenter:null};function mn(){let e=pn[T.mode],t=T[T.mode][e.key];return typeof t==`number`?Math.max(0,Math.min(1,(t-e.min)/(e.max-e.min))):0}function hn(e,t){let[n,r,i]=K,[a,o]=xe;if(Math.abs(t[2])<1e-6)return null;let s=(i-e[2])/t[2];if(s<0)return null;let c=e[0]+t[0]*s,l=e[1]+t[1]*s,u=(c-n)/a+.5,d=(l-r)/o+.5;if(u<0||u>1||d<0||d>1)return null;let f=a/o,p=(u-.5)*f,m=d-.5,h=`none`;if(Math.abs(p-Te*f)<Ce&&Math.abs(m-Se)<we)h=`prev`;else if(Math.abs(p-Ee*f)<Ce&&Math.abs(m-Se)<we)h=`next`;else if(Math.abs(m-Ae)<Me&&Math.abs(p)<je)h=`grab`;else{let e=f*ke;Math.abs(m-De)<Oe&&Math.abs(p)<e+.04&&(h=`slider`)}return{px:p,py:m,element:h}}function gn(e,t,n){if(Math.abs(t[2])<1e-6)return null;let r=(n-e[2])/t[2];return r<0?null:[e[0]+t[0]*r,e[1]+t[1]*r,n]}function _n(e){let t=xe[0]/xe[1]*ke,n=Math.max(0,Math.min(1,(e+t)/(2*t))),r=pn[T.mode],i=T[T.mode];i[r.key]=r.min+(r.max-r.min)*n}function vn(e){let t=Q[(Q.indexOf(T.mode)+e+Q.length)%Q.length];ft(t)}function yn(e,t){if(!Z)return null;let n=e.getPose(t.targetRaySpace,Z);if(!n)return null;let r=n.transform.position;return{origin:[r.x,r.y,r.z],dir:Cn(n.transform)}}function bn(e){e?($.lastHitPx=e.px,$.lastHitPy=e.py,$.lastHitActive=!0):$.lastHitActive=!1}function xn(e){if($.pendingPressSource){let t=$.pendingPressSource,n=yn(e,t);if(n){let e=hn(n.origin,n.dir);if($.pendingPressSource=null,bn(e),e&&e.element!==`none`){if($.pressed=e.element,$.pressingSource=t,$.hover=e.element,e.element===`slider`)$.grabbed=!0,_n(e.px);else if(e.element===`grab`){let e=gn(n.origin,n.dir,K[2]);e&&($.grabDragOriginWorld=e,$.grabDragOriginCenter=[K[0],K[1],K[2]])}return}Sn(t)}return}if($.pressingSource){let t=yn(e,$.pressingSource);if(t){if($.pressed===`grab`&&$.grabDragOriginWorld&&$.grabDragOriginCenter){let e=gn(t.origin,t.dir,$.grabDragOriginCenter[2]);e&&(K[0]=$.grabDragOriginCenter[0]+(e[0]-$.grabDragOriginWorld[0]),K[1]=$.grabDragOriginCenter[1]+(e[1]-$.grabDragOriginWorld[1])),$.lastHitPx=0,$.lastHitPy=Ae,$.lastHitActive=!0,$.hover=`grab`;return}let e=hn(t.origin,t.dir);bn(e),$.hover=e?e.element:`none`,$.grabbed&&e&&_n(e.px)}else $.lastHitActive=!1;return}if(dn){let t=yn(e,dn);t?bn(hn(t.origin,t.dir)):$.lastHitActive=!1}else $.lastHitActive=!1;$.hover=`none`}function Sn(e){dn=e,fn=!1,J()}function Cn(e){let t=e.matrix;return j([-t[8],-t[9],-t[10]])}function wn(e){if($.pressed!==`none`){J();return}let t=dn;if(!t||!Z){J();return}let n=e.getPose(t.targetRaySpace,Z);if(!n){J(),fn=!1;return}let r=[n.transform.position.x,n.transform.position.y,n.transform.position.z],i=Cn(n.transform),a=T.mode===`fluid`?xt(r,i,0):St(r,i);if(!a){J(),fn=!1;return}if(T.mouse.down=!0,T.mouse.worldX=a[0],T.mouse.worldY=a[1],T.mouse.worldZ=a[2],T.mode===`fluid`){let e=bt(a);if(!e){J(),fn=!1;return}T.mouse.dx=fn?(e[0]-T.mouse.x)*10:0,T.mouse.dy=fn?(e[1]-T.mouse.y)*10:0,T.mouse.x=e[0],T.mouse.y=e[1]}else T.mouse.dx=0,T.mouse.dy=0,T.mouse.x=a[0],T.mouse.y=a[1];fn=!0}function Tn(){let e=document.getElementById(`btn-xr`);if(!navigator.xr){e.textContent=`VR Not Available`;return}navigator.xr.isSessionSupported(`immersive-vr`).then(t=>{t?(e.disabled=!1,e.addEventListener(`click`,En)):e.textContent=`VR Not Supported`}).catch(()=>{e.textContent=`VR Check Failed`})}async function En(){if(X){X.end();return}let e=document.getElementById(`btn-xr`);e.textContent=`Starting...`;try{X=await navigator.xr.requestSession(`immersive-vr`,{requiredFeatures:[`webgpu`],optionalFeatures:[`layers`,`local-floor`]});let t=!1;try{Z=await X.requestReferenceSpace(`local-floor`),t=!0}catch{Z=await X.requestReferenceSpace(`local`)}let n=t?1.6:0,r=globalThis.XRRigidTransform;Z=Z.getOffsetReferenceSpace(new r({x:0,y:n,z:-5})),ln=new XRGPUBinding(X,H);let i=ln.getPreferredColorFormat();pe(i,1);let a=ln.nativeProjectionScaleFactor,o=[{colorFormat:i,scaleFactor:a,textureType:`texture-array`},{colorFormat:i,textureType:`texture-array`},{colorFormat:i,scaleFactor:a},{colorFormat:i}];for(let e of o)try{un=ln.createProjectionLayer(e);break}catch(e){console.warn(`[XR] Projection layer config failed, trying next:`,e.message),un=null}if(!un)throw Error(`All projection layer configurations failed`);X.updateRenderState({layers:[un]}),X.addEventListener(`selectstart`,e=>{$.pendingPressSource=e.inputSource}),X.addEventListener(`selectend`,e=>{let t=e.inputSource;if($.pressingSource===t){let e=$.pressed,t=$.grabbed;e===`prev`&&$.hover===`prev`?vn(-1):e===`next`&&$.hover===`next`&&vn(1),$.pressed=`none`,$.pressingSource=null,$.grabbed=!1,$.grabDragOriginWorld=null,$.grabDragOriginCenter=null,$.hover=`none`,$.lastHitActive=!1,t&&(Un(),Vn());return}if($.pendingPressSource===t){$.pendingPressSource=null;return}Sn(dn===t?null:dn)}),e.textContent=`Exit VR`,T.xrEnabled=!0,X.requestAnimationFrame(Dn),X.addEventListener(`end`,()=>{X=null,Z=null,ln=null,un=null,T.xrEnabled=!1,pe(de,1),Sn(null),e.textContent=`Enter VR`,requestAnimationFrame(zn)})}catch(t){if(console.error(`[XR] Failed to start session:`,t),e.textContent=`XR Error: ${t.message}`,X)try{X.end()}catch{}X=null,setTimeout(()=>{e.textContent=`Enter VR`},4e3)}}function Dn(e,t){if(X){X.requestAnimationFrame(Dn),S(e);try{let e=t.getViewerPose(Z);if(!e)return;let n=q[T.mode];if(!n)return;xn(t),wn(t);let r=H.createCommandEncoder();T.paused||n.compute(r);for(let t=0;t<e.views.length;t++){let i=e.views[t],a=ln,o=a.getViewSubImage?a.getViewSubImage(un,i):a.getSubImage(un,i);if(!o)continue;let s=o.getViewDescriptor?o.getViewDescriptor():{},c=o.colorTexture.createView(s),l=i.transform.position;I={viewMatrix:new Float32Array(i.transform.inverse.matrix),projMatrix:new Float32Array(i.projectionMatrix),eye:[l.x,l.y,l.z]};let{x:u,y:d,width:f,height:p}=o.viewport;oe(f,p),L.needsClear=!0;let m=L.sceneIdx;n.render(r,L.scene[m].createView(),null,t);let h=r.beginRenderPass({colorAttachments:[{view:L.scene[m].createView(),loadOp:`load`,storeOp:`store`}],depthStencilAttachment:{view:L.depth.createView(),depthLoadOp:`load`,depthStoreOp:`store`}});Ye(h,f/p,t),h.end(),Ln(r,L.scene[m]);let g=o.colorTexture.format;Rn(r,L.scene[m],c,g,[u,d,f,p])}I=null,H.queue.submit([r.finish()])}catch(e){console.error(`[XR] Frame error:`,e)}}}var On=0,kn=0,An=0;function jn(e,t){console.error(`[sim:${e}]`,t);let n=document.getElementById(`gpu-error-overlay`);n||(n=document.createElement(`div`),n.id=`gpu-error-overlay`,n.style.cssText=`position:fixed;top:60px;left:10px;right:10px;max-height:60vh;overflow:auto;background:rgba(20,0,0,0.92);color:#ff8080;font:11px monospace;padding:10px;border:1px solid #ff4040;border-radius:4px;z-index:9999;white-space:pre-wrap;`,document.body.appendChild(n));let r=new Date().toLocaleTimeString();n.textContent=`[${r}] [sim:${e}] ${t}\n\n`+n.textContent}function Mn(){let e=T.mode;if(q[e])return;let t={boids:Xe,physics:Ze,physics_classic:Qe,fluid:$e,parametric:et,reaction:tt};H.pushErrorScope(`validation`),H.pushErrorScope(`internal`),H.pushErrorScope(`out-of-memory`);let n=null;try{n=t[e]()}catch(t){jn(e,`factory threw: ${t.message}`)}let r=n,i=e,a=e=>{if(jn(i,e),r&&q[i]===r){try{r.destroy()}catch{}delete q[i]}};H.popErrorScope().then(e=>{e&&a(`OOM: ${e.message}`)}),H.popErrorScope().then(e=>{e&&a(`internal: ${e.message}`)}),H.popErrorScope().then(e=>{e&&a(`validation: ${e.message}`)}),n&&(q[e]=n)}function Nn(){let e=T.mode;q[e]&&(q[e].destroy(),delete q[e]),Mn()}function Pn(){document.getElementById(`stat-fps`).textContent=`FPS: ${An}`;let e=q[T.mode],t=e?e.getCount():`--`;document.getElementById(`stat-count`).textContent=T.mode===`fluid`||T.mode===`reaction`?`Grid: ${t}`:`Particles: ${t}`}function Fn(){let e=document.getElementById(`canvas-container`),t=window.devicePixelRatio||1,n=Math.floor(e.clientWidth*t),r=Math.floor(e.clientHeight*t);(U.width!==n||U.height!==r)&&(U.width=n,U.height=r),oe(U.width,U.height)}function In(e,t,n){if(L.needsClear)return;let r=T.fx.trailPersistence;if(r<.001)return;H.queue.writeBuffer(L.fadeUBO,0,new Float32Array([r,0,0,0]));let i=H.createBindGroup({layout:L.fadeBGL,entries:[{binding:0,resource:L.scene[t].createView()},{binding:1,resource:L.linSampler},{binding:2,resource:{buffer:L.fadeUBO}}]}),a=e.beginRenderPass({colorAttachments:[{view:L.scene[n].createView(),clearValue:p,loadOp:`clear`,storeOp:`store`}]});a.setPipeline(L.fadePipeline),a.setBindGroup(0,i),a.draw(3),a.end()}function Ln(e,t){let n=T.fx;for(let r=0;r<z;r++){let i=r===0?t:L.bloomMips[r-1],a=L.bloomMips[r],o=i.width,s=i.height;H.queue.writeBuffer(L.downsampleUBO[r],0,new Float32Array([1/o,1/s,n.bloomThreshold,r===0?1:0]));let c=H.createBindGroup({layout:L.downsampleBGL,entries:[{binding:0,resource:i.createView()},{binding:1,resource:L.linSampler},{binding:2,resource:{buffer:L.downsampleUBO[r]}}]}),l=e.beginRenderPass({colorAttachments:[{view:a.createView(),clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}]});l.setPipeline(L.downsamplePipeline),l.setBindGroup(0,c),l.draw(3),l.end()}for(let t=z-1;t>0;t--){let r=L.bloomMips[t],i=L.bloomMips[t-1];H.queue.writeBuffer(L.upsampleUBO[t],0,new Float32Array([1/r.width,1/r.height,n.bloomRadius,0]));let a=H.createBindGroup({layout:L.upsampleBGL,entries:[{binding:0,resource:r.createView()},{binding:1,resource:L.linSampler},{binding:2,resource:{buffer:L.upsampleUBO[t]}}]}),o=e.beginRenderPass({colorAttachments:[{view:i.createView(),clearValue:{r:0,g:0,b:0,a:1},loadOp:`load`,storeOp:`store`}]});o.setPipeline(L.upsamplePipelineAdditive),o.setBindGroup(0,a),o.draw(3),o.end()}}function Rn(e,t,n,r,i=null){let a=T.fx,o=x(),s=new Float32Array(16);s[0]=a.bloomIntensity,s[1]=a.exposure,s[2]=a.vignette,s[3]=a.chromaticAberration,s[4]=a.grading,s[8]=o.primary[0],s[9]=o.primary[1],s[10]=o.primary[2],s[12]=o.accent[0],s[13]=o.accent[1],s[14]=o.accent[2],H.queue.writeBuffer(L.compositeUBO,0,s);let c=ae(r),l=H.createBindGroup({layout:L.compositeBGL,entries:[{binding:0,resource:t.createView()},{binding:1,resource:L.bloomMips[0].createView()},{binding:2,resource:L.linSampler},{binding:3,resource:{buffer:L.compositeUBO}}]}),u=e.beginRenderPass({colorAttachments:[{view:n,clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}]});u.setPipeline(c),u.setBindGroup(0,l),i&&u.setViewport(i[0],i[1],i[2],i[3],0,1),u.draw(3),u.end()}function zn(e){if(T.xrEnabled)return;requestAnimationFrame(zn),S(e),Fn(),On++,e-kn>=1e3&&(An=On,On=0,kn=e,Pn());let t=q[T.mode];if(!t)return;let n=T.mode,r=H.createCommandEncoder();try{T.paused||t.compute(r);let e=L.sceneIdx,n=1-e;L.sceneIdx=n,In(r,e,n);let i=L.scene[n].createView();t.render(r,i,null),Ln(r,L.scene[n]);let a=ue.getCurrentTexture().createView();Rn(r,L.scene[n],a,de),H.queue.submit([r.finish()]),L.needsClear=!1}catch(e){if(jn(n,`frame threw: ${e.message}`),q[n]===t){try{t.destroy()}catch{}delete q[n]}}}var Bn=`shader-playground-state`;function Vn(){try{let e={};for(let t of Object.keys(s))e[t]=w(t);let t={mode:T.mode,colorTheme:T.colorTheme,camera:T.camera,fx:T.fx,...e};localStorage.setItem(Bn,JSON.stringify(t))}catch{}}function Hn(){try{let e=localStorage.getItem(Bn);if(!e)return;let t=JSON.parse(e);t.mode&&t.mode in s&&(T.mode=t.mode),t.colorTheme&&u[t.colorTheme]&&(T.colorTheme=t.colorTheme);for(let e of Object.keys(s))t[e]&&Object.assign(w(e),t[e]);t.camera&&Object.assign(T.camera,t.camera),t.fx&&Object.assign(T.fx,t.fx),C(T.colorTheme)}catch{}}function Un(){document.querySelectorAll(`.mode-tab`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===T.mode)),document.querySelectorAll(`.param-group`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===T.mode));for(let e of Object.keys(l)){let t=e,n=document.getElementById(`params-${t}`),r=w(t);n.querySelectorAll(`input[type="range"]`).forEach(e=>{let n=e.dataset.key;if(n&&n in r){e.value=String(r[n]);let i=e.parentElement?.querySelector(`.control-value`);if(i){let e=ut(t,n);i.textContent=ct(Number(r[n]),e?e.step??.01:.01)}}}),n.querySelectorAll(`select`).forEach(e=>{let t=e.dataset.key;t&&t in r&&(e.value=String(r[t]))})}document.querySelectorAll(`#theme-presets .preset-btn`).forEach(e=>e.classList.toggle(`active`,e.dataset.theme===T.colorTheme)),st()}async function Wn(){await fe()&&(Tt=wt.matches,document.body.classList.toggle(`mobile`,Tt),wt.addEventListener(`change`,e=>{let t=e.matches;t!==Tt&&(Tt=t,document.body.classList.toggle(`mobile`,Tt),window.location.reload())}),ye(),Ge(),Hn(),Tt&&kt(),C(T.colorTheme),it(),ht(),pt(),mt(),Tt?(Et(),Dt(),Ot()):Ct(),Rt(),Un(),Fn(),Mn(),Nt(),new ResizeObserver(()=>Fn()).observe(document.getElementById(`canvas-container`)),requestAnimationFrame(zn))}Wn();