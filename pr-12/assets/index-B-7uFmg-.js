...
`)):(t.className=`shader-success`,t.textContent=`Compiled OK — reset simulation to apply`,t.title=``,Jn(L.mode,q,e))})}catch(e){t.className=`shader-error`,t.textContent=e.message,t.title=e.message}}function qn(){q&&Bn[q]&&(zn[q]=Bn[q],Wn(),Jn(L.mode,q,Bn[q]),document.getElementById(`shader-status`).className=`shader-success`,document.getElementById(`shader-status`).textContent=`Shader reset to original`)}function Jn(e,t,n){let r={boids:{"Compute (Flocking)":()=>{Yn=n},"Render (Vert+Frag)":()=>{Xn=n}},physics:{"Compute (Gravity)":()=>{Zn=n},"Render (Vert+Frag)":()=>{Qn=n}},physics_classic:{"Compute (Classic)":()=>{$n=n},"Render (Classic)":()=>{er=n}},fluid:{"Forces + Advect":()=>{tr=n},Diffuse:()=>{nr=n},Divergence:()=>{rr=n},"Pressure Solve":()=>{ir=n},"Gradient Sub":()=>{ar=n},Render:()=>{or=n}},parametric:{"Compute (Mesh Gen)":()=>{sr=n},"Render (Phong)":()=>{cr=n}},reaction:{"Compute (Gray-Scott)":()=>{lr=n},"Render (Raymarch)":()=>{ur=n}}}[e]?.[t];r&&r()}var Yn=null,Xn=null,Zn=null,Qn=null,$n=null,er=null,tr=null,nr=null,rr=null,ir=null,ar=null,or=null,sr=null,cr=null,lr=null,ur=null,dr=new Map,J={phase:`idle`,phaseDeadline:0,bounded:!1,samples:[],startedAt:0,unsubs:[],preDelayTimer:null,stopTimer:null,resolve:null},Y={channel(e){let t=dr.get(e);if(t)return t;let n={name:e,subscribers:new Set};return dr.set(e,n),n},subscribe(e,t){return e.subscribers.add(t),()=>{e.subscribers.delete(t)}},emit(e,t){for(let n of e.subscribers)n(t)},record(e){if(J.phase!==`idle`)return Promise.reject(Error(`metrics.record: recording already in progress`));let t=e.preDelayMs??0;return J.samples=[],J.bounded=e.durationMs!==void 0,new Promise(n=>{J.resolve=n;let r=()=>{let t=e.channels??Array.from(dr.values());J.startedAt=performance.now(),J.phase=`recording`,J.phaseDeadline=e.durationMs===void 0?0:J.startedAt+e.durationMs,J.preDelayTimer=null;for(let e of t){let t=e.name;J.unsubs.push(Y.subscribe(e,e=>{J.samples.push({t:performance.now()-J.startedAt,channel:t,payload:e})}))}e.durationMs!==void 0&&(J.stopTimer=setTimeout(()=>Y.stop(),e.durationMs))};t>0?(J.phase=`pre-delay`,J.phaseDeadline=performance.now()+t,J.preDelayTimer=setTimeout(r,t)):r()})},stop(){if(J.phase===`idle`)return;J.preDelayTimer&&=(clearTimeout(J.preDelayTimer),null),J.stopTimer&&=(clearTimeout(J.stopTimer),null);for(let e of J.unsubs)e();J.unsubs=[];let e=J.samples;J.samples=[],J.phase=`idle`,J.phaseDeadline=0,J.bounded=!1;let t=J.resolve;J.resolve=null,t&&t(e)},status(){return J.phase===`idle`?{phase:`idle`,remainingMs:0,bounded:!1}:{phase:J.phase,remainingMs:J.phaseDeadline===0?0:Math.max(0,J.phaseDeadline-performance.now()),bounded:J.bounded}}},X=null,Z=null,fr=null,pr=null,mr=null,hr=!1,gr=[`wrist`,`thumb-metacarpal`,`thumb-phalanx-proximal`,`thumb-phalanx-distal`,`thumb-tip`,`index-finger-metacarpal`,`index-finger-phalanx-proximal`,`index-finger-phalanx-intermediate`,`index-finger-phalanx-distal`,`index-finger-tip`,`middle-finger-metacarpal`,`middle-finger-phalanx-proximal`,`middle-finger-phalanx-intermediate`,`middle-finger-phalanx-distal`,`middle-finger-tip`,`ring-finger-metacarpal`,`ring-finger-phalanx-proximal`,`ring-finger-phalanx-intermediate`,`ring-finger-phalanx-distal`,`ring-finger-tip`,`pinky-finger-metacarpal`,`pinky-finger-phalanx-proximal`,`pinky-finger-phalanx-intermediate`,`pinky-finger-phalanx-distal`,`pinky-finger-tip`];function _r(e){return{hand:e,tracked:!1,source:null,pinch:{active:!1,startTime:0,origin:[0,0,0],current:[0,0,0]},gazeRay:null,currentRay:null,ray:null,palmNormal:null,joints:null,grip:null}}var Q={left:_r(`left`),right:_r(`right`)},vr={left:{kind:`idle`},right:{kind:`idle`}},yr=[],br={gainMultiplier:1},xr=`left`,Sr={bindings:e,layouts:new Map,activeLayoutId:null},Cr=w(),wr=[],Tr={left:!1,right:!1},Er=null,Dr=null,Or={x:0,y:0,z:-5},kr=0,Ar={startDistance:0,startOffset:{x:0,y:0,z:0}},jr={left:!1,right:!1};function Mr(){return{fineModifier:!1,palmUp:!1,wristOrient:null,wristTime:0,flickArmed:!1,lastFlickAt:0}}var Nr={left:Mr(),right:Mr()},Pr=.7,Fr=.4,Ir=4,Lr=300,Rr=Y.channel(`xr.gesture`),zr=Y.channel(`xr.state`),Br=Y.channel(`xr.snap`);function Vr(e,t){let n=vr[e];vr[e]=t,zr.subscribers.size>0&&n.kind!==t.kind&&Y.emit(zr,{hand:e,from:n.kind,to:t.kind})}var Hr={left:-1,right:-2},Ur=150;function Wr(e){let t=e.matrix;return B([-t[8],-t[9],-t[10]])}function Gr(e,t){if(!Z)return null;let n=e.getPose(t.targetRaySpace,Z);if(!n)return null;let r=n.transform.position;return{origin:[r.x,r.y,r.z],dir:Wr(n.transform)}}function Kr(e,t){if(!Z)return null;let n=e.getPose(t.gripSpace||t.targetRaySpace,Z);if(!n)return null;let r=n.transform.position;return[r.x,r.y,r.z]}function qr(e){let t=!Q.left.source,n=!Q.right.source;return e.handedness===`left`&&t?`left`:e.handedness===`right`&&n?`right`:t?`left`:n?`right`:null}function Jr(e){return Q.left.source===e?`left`:Q.right.source===e?`right`:null}var Yr=.03,Xr=Yr*Yr;function Zr(e){return[-e[0],-e[1],-e[2],e[3]]}function Qr(e,t){return[e[3]*t[0]+e[0]*t[3]+e[1]*t[2]-e[2]*t[1],e[3]*t[1]-e[0]*t[2]+e[1]*t[3]+e[2]*t[0],e[3]*t[2]+e[0]*t[1]-e[1]*t[0]+e[2]*t[3],e[3]*t[3]-e[0]*t[0]-e[1]*t[1]-e[2]*t[2]]}function $r(e,t,n){let r={};for(let i of gr){let a=t.get(i),o=a?e.getJointPose(a,n):null;if(!o){r[i]=null;continue}let s=o.transform.position,c=o.transform.orientation;r[i]={position:[s.x,s.y,s.z],orientation:[c.x,c.y,c.z,c.w],radius:o.radius}}return r}function ei(e,t){let n=e.wrist,r=e[`index-finger-metacarpal`],i=e[`pinky-finger-metacarpal`];if(!n||!r||!i)return null;let a=st(r.position,n.position),o=st(i.position,n.position),s=B(t===`right`?V(o,a):V(a,o));return s[0]===0&&s[1]===0&&s[2]===0?null:s}function ti(e){let t=e[`thumb-tip`];if(!t)return null;let n=e=>{if(!e)return null;let n=st(t.position,e.position);return ct(n,n)<Xr};return{thumbIndex:n(e[`index-finger-tip`]),thumbMiddle:n(e[`middle-finger-tip`]),thumbRing:n(e[`ring-finger-tip`]),thumbPinky:n(e[`pinky-finger-tip`])}}function ni(){if(!fr)return;let e=globalThis.XRRigidTransform;Z=fr.getOffsetReferenceSpace(new e({x:Or.x,y:Or.y+kr,z:Or.z}))}function ri(e){for(let t=yr.length-1;t>=0;t--){let n=yr[t],r=Gr(e,n);if(!r)continue;yr.splice(t,1);let i=qr(n);if(!i)continue;let a=Kr(e,n)??r.origin,o=Q[i];o.tracked=!0,o.source=n,o.pinch.active=!0,o.pinch.startTime=performance.now(),o.pinch.origin=a,o.pinch.current=a,o.gazeRay={origin:[...r.origin],dir:[...r.dir]},o.currentRay=r}for(let t of[`left`,`right`]){let n=Q[t];if(!n.pinch.active||!n.source)continue;let r=Gr(e,n.source);r&&(n.currentRay=r);let i=Kr(e,n.source);i&&(n.pinch.current=i)}for(let e of[`left`,`right`]){let t=Q[e];t.joints=null,t.palmNormal=null,t.grip=null,t.ray=null}if(Z)for(let t of e.session.inputSources){if(t.handedness===`none`||!t.hand)continue;let n=t.handedness,r=Q[n],i=$r(e,t.hand,Z);r.joints=i,r.palmNormal=ei(i,n),r.grip=ti(i),r.ray=ii(i)}}function ii(e){let t=e.wrist,n=e[`index-finger-metacarpal`];if(!t||!n)return null;let r=B(st(n.position,t.position));return r[0]===0&&r[1]===0&&r[2]===0?null:{origin:[...n.position],dir:r}}function ai(){let e=[],t=Q.left.pinch.active,n=Q.right.pinch.active,r=t&&n,i=jr.left&&jr.right,a=performance.now();for(let t of[`left`,`right`]){let n=Q[t],r=jr[t],i=n.pinch.active;i&&!r&&n.gazeRay?e.push({kind:`pinch-start`,hand:t,gazeRay:n.gazeRay}):i&&r?e.push({kind:`pinch-hold`,hand:t,dur:a-n.pinch.startTime}):!i&&r&&e.push({kind:`pinch-end`,hand:t,dur:a-n.pinch.startTime});let o=Nr[t];if(n.grip){let r=n.grip.thumbRing===!0;r&&!o.fineModifier?e.push({kind:`fine-modifier-on`,hand:t}):!r&&o.fineModifier&&e.push({kind:`fine-modifier-off`,hand:t}),o.fineModifier=r}if(n.palmNormal){let r=n.palmNormal[1],i=o.palmUp?r>Fr:r>Pr;i&&!o.palmUp?e.push({kind:`palm-up`,hand:t}):!i&&o.palmUp&&e.push({kind:`palm-down`,hand:t}),o.palmUp=i}let s=n.joints?.wrist?.orientation??null,c=0;if(s&&o.wristOrient&&!n.pinch.active){let n=Math.max(.001,(a-o.wristTime)/1e3),r=Qr(s,Zr(o.wristOrient)),i=Math.min(1,Math.abs(r[3])),l=2*Math.acos(i),u=Math.sqrt(Math.max(0,1-i*i)),d=r[3]<0?-1:1,f=u>1e-6?r[0]*d/u:0,p=u>1e-6?r[1]*d/u:0,m=u>1e-6?r[2]*d/u:0;c=l/n;let h=c>Ir;if(h&&o.flickArmed&&a-o.lastFlickAt>Lr){let n=Math.abs(f),r=Math.abs(p),i=Math.abs(m),s=n>=r&&n>=i?`pitch`:r>=i?`yaw`:`roll`,c=(s===`pitch`?f:s===`yaw`?p:m)>=0?1:-1;e.push({kind:`wrist-flick`,hand:t,axis:s,sign:c}),o.lastFlickAt=a}o.flickArmed=h}else o.flickArmed=!1;o.wristOrient=s?[...s]:null,o.wristTime=a,Br.subscribers.size>0&&Y.emit(Br,{hand:t,handTracked:n.joints!==null,pinching:n.pinch.active,palmDot:n.palmNormal?n.palmNormal[1]:null,palmUp:o.palmUp,fineModifier:o.fineModifier,flickSpeed:c,grip:n.grip})}if(r&&!i?e.push({kind:`two-hand-pinch-start`}):!r&&i&&e.push({kind:`two-hand-pinch-end`}),jr.left=t,jr.right=n,Rr.subscribers.size>0)for(let t of e)Y.emit(Rr,{hand:`hand`in t?t.hand:null,gesture:t});return e}function oi(e,t){for(let t of e)switch(t.kind){case`pinch-start`:Vr(t.hand,{kind:`pending`,deadline:performance.now()+Ur});break;case`two-hand-pinch-start`:if(vr.left.kind===`pending`&&vr.right.kind===`pending`){let e=st(Q.left.pinch.current,Q.right.pinch.current);Ar.startDistance=Math.max(.01,Math.sqrt(ct(e,e))),Ar.startOffset={...Or},Vr(`left`,{kind:`two-hand-scale`}),Vr(`right`,{kind:`two-hand-scale`})}break;case`two-hand-pinch-end`:vr.left.kind===`two-hand-scale`&&Vr(`left`,{kind:`idle`}),vr.right.kind===`two-hand-scale`&&Vr(`right`,{kind:`idle`});break;case`pinch-end`:si(t.hand);break;case`pinch-hold`:break;case`fine-modifier-on`:br.gainMultiplier=.1;break;case`fine-modifier-off`:br.gainMultiplier=1;break;case`palm-up`:case`palm-down`:case`wrist-flick`:break}let n=performance.now();for(let e of[`left`,`right`]){let t=vr[e];t.kind===`pending`&&n>=t.deadline&&(Tr[e]?Vr(e,{kind:`idle`}):Vr(e,{kind:`dragging`,handOrigin:[...Q[e].pinch.origin],hasSample:!1}))}}function si(e){switch(vr[e].kind){case`dragging`:Tn(),et(Hr[e]);break;case`pending`:case`two-hand-scale`:case`idle`:break}Vr(e,{kind:`idle`});let t=Q[e];t.pinch.active||(t.source=null,t.gazeRay=null,t.currentRay=null)}function ci(e){if(vr.left.kind===`two-hand-scale`&&vr.right.kind===`two-hand-scale`){let e=st(Q.left.pinch.current,Q.right.pinch.current),t=Math.sqrt(ct(e,e));if(Ar.startDistance>=.01){let e=t/Ar.startDistance;Or.z=Math.max(-200,Math.min(-1,Ar.startOffset.z/e)),ni()}return}let t=!1;for(let e of[`left`,`right`]){let n=vr[e],r=Q[e];if(n.kind!==`dragging`||!r.source)continue;let i=r.currentRay;if(!i)continue;t=!0;let a=L.mode===`fluid`?Cn(i.origin,i.dir,0):wn(i.origin,i.dir);if(!a){Tn(),n.hasSample=!1;continue}if(L.mouse.down=!0,L.mouse.worldX=a[0],L.mouse.worldY=a[1],L.mouse.worldZ=a[2],L.mode===`fluid`){let e=Sn(a);if(!e){Tn(),n.hasSample=!1;continue}L.mouse.dx=n.hasSample?(e[0]-L.mouse.x)*10:0,L.mouse.dy=n.hasSample?(e[1]-L.mouse.y)*10:0,L.mouse.x=e[0],L.mouse.y=e[1]}else L.mouse.dx=0,L.mouse.dy=0,L.mouse.x=a[0],L.mouse.y=a[1];if(L.mode===`physics`){let t=Hr[e];L.pointerToAttractor.has(t)?$e(t,a):Qe(t,a)}n.hasSample=!0}t||L.xrEnabled&&L.mouse.down&&Tn()}function li(e){if(!Z)return null;let t=e.getViewerPose(Z);if(!t)return null;let n=t.transform;return{position:[n.position.x,n.position.y,n.position.z],orientation:[n.orientation.x,n.orientation.y,n.orientation.z,n.orientation.w]}}function ui(e){ri(e);let t=li(e),n=T(Sr,Q,Cr,{hands:Q,headPose:t},br,16);D(n.sideEffects,Sr),Cr=n.next,wr=n.renderList,Tr.left=E(n.next.states.left),Tr.right=E(n.next.states.right),oi(ai(),e),ci(e)}function di(e){let t=Jr(e);if(t){let e=Q[t];e.pinch.active=!1,e.tracked=!1}let n=yr.indexOf(e);n>=0&&yr.splice(n,1)}function fi(){yr.length=0,Q.left=_r(`left`),Q.right=_r(`right`),Vr(`left`,{kind:`idle`}),Vr(`right`,{kind:`idle`}),jr.left=!1,jr.right=!1,Nr.left=Mr(),Nr.right=Mr(),br.gainMultiplier=1,Cr=w(),wr=[],Tr.left=!1,Tr.right=!1,Tn(),et(Hr.left),et(Hr.right)}function pi(){let e=document.getElementById(`btn-xr`);if(!navigator.xr){e.textContent=`VR Not Available`;return}navigator.xr.isSessionSupported(`immersive-vr`).then(t=>{t?(e.disabled=!1,e.addEventListener(`click`,mi)):e.textContent=`VR Not Supported`}).catch(()=>{e.textContent=`VR Check Failed`})}async function mi(){if(X){j(`xr`,`exiting session (user clicked Exit VR)`),k=`xr:session.end`,X.end();return}let e=document.getElementById(`btn-xr`);e.textContent=`Starting...`,j(`xr`,`toggleXR start`,{hasWebXR:!!navigator.xr,userAgent:navigator.userAgent});try{k=`xr:requestSession`,X=await navigator.xr.requestSession(`immersive-vr`,{requiredFeatures:[`webgpu`],optionalFeatures:[`layers`,`local-floor`,`hand-tracking`]});let t=X.enabledFeatures;hr=!!t&&t.includes(`hand-tracking`),j(`xr`,`session acquired`,{environmentBlendMode:X.environmentBlendMode,interactionMode:X.interactionMode,visibilityState:X.visibilityState,handTracking:hr,enabledFeatures:t});let n=!1;try{k=`xr:requestReferenceSpace(local-floor)`,Z=await X.requestReferenceSpace(`local-floor`),n=!0,j(`xr`,`reference space = local-floor`)}catch(e){j(`xr`,`local-floor unavailable, falling back to local`,e.message),k=`xr:requestReferenceSpace(local)`,Z=await X.requestReferenceSpace(`local`)}fr=Z,kr=n?1.6:0,Or.x=0,Or.y=0,Or.z=-5,ni(),k=`xr:new XRGPUBinding`,pr=new XRGPUBinding(X,U);let r=pr.getPreferredColorFormat(),i=pr.nativeProjectionScaleFactor;j(`xr`,`binding ready`,{preferredFormat:r,nativeProjectionScaleFactor:i}),Dt(r,1);let a=[{colorFormat:r,depthStencilFormat:`depth24plus`,scaleFactor:i,textureType:`texture-array`},{colorFormat:r,depthStencilFormat:`depth24plus`,textureType:`texture-array`},{colorFormat:r,scaleFactor:i,textureType:`texture-array`},{colorFormat:r,textureType:`texture-array`},{colorFormat:r,scaleFactor:i},{colorFormat:r}];k=`xr:createProjectionLayer`;let o=null,s=[];for(let e of a)try{mr=pr.createProjectionLayer(e),o=e;break}catch(t){let n=t.message;s.push({config:e,error:n}),j(`xr`,`projection layer config rejected`,{config:e,error:n}),mr=null}if(!mr)throw Error(`All projection layer configurations failed. Attempts: ${JSON.stringify(s)}`);j(`xr`,`projection layer created`,{config:o,textureWidth:mr.textureWidth,textureHeight:mr.textureHeight,textureArrayLength:mr.textureArrayLength,ignoreDepthValues:mr.ignoreDepthValues});try{mr.fixedFoveation=0,j(`xr`,`fixedFoveation set to 0`)}catch(e){j(`xr`,`fixedFoveation unsupported on this platform`,e.message)}k=`xr:updateRenderState`;try{X.updateRenderState({layers:[mr]}),j(`xr`,`render state updated with projection layer`)}catch(e){throw A(`xr:updateRenderState`,e),e}X.addEventListener(`selectstart`,e=>{yr.push(e.inputSource)}),X.addEventListener(`selectend`,e=>{di(e.inputSource)}),e.textContent=`Exit VR`,L.xrEnabled=!0,k=`xr:awaiting first frame`;let c=[0,0,0,1],l={x:.16,y:.06},u={x:.02,y:.02};Sr.layouts.set(`debug`,{id:`debug-panel`,kind:`panel`,anchor:{kind:`world`,pose:{position:[0,1.55,-.6],orientation:c}},size:{x:1.1,y:.5},children:[{id:`debug-row-1`,kind:`group`,layout:`row`,children:[{id:`debug-s1`,kind:`slider`,binding:`physics.G`,orientation:`horizontal`,interaction:{kind:`direct-drag`,axis:`x`},visualSize:l,hitPadding:u},{id:`debug-b1`,kind:`button`,binding:`preset.physics.Default`,style:`primary`,visualSize:l,hitPadding:u},{id:`debug-r1`,kind:`readout`,binding:`physics.G`,visualSize:l,hitPadding:u},{id:`debug-d1`,kind:`dial`,binding:`physics.softening`,interaction:{kind:`direct-drag`,axis:`x`},visualSize:l,hitPadding:u}]},{id:`debug-row-2`,kind:`group`,layout:`row`,children:[{id:`debug-tg1`,kind:`toggle`,binding:`app.paused`,style:`switch`,visualSize:l,hitPadding:u},{id:`debug-st1`,kind:`stepper`,binding:`physics.count`,step:1e3,visualSize:l,hitPadding:u},{id:`debug-en1`,kind:`enum-chips`,binding:`physics.distribution`,visualSize:l,hitPadding:u},{id:`debug-pt1`,kind:`preset-tile`,binding:`preset.physics.Spiral Galaxy`,visualSize:l,hitPadding:u},{id:`debug-ct1`,kind:`category-tile`,targetTabId:`physics`,summary:{},visualSize:l,hitPadding:u}]}]});let f={position:[.1,0,-.05],orientation:c},p={x:.17,y:.03};Sr.layouts.set(`clipboard`,{id:`clipboard-panel`,kind:`panel`,anchor:{kind:`held`,hand:xr,offset:f},size:{x:.2,y:.28},children:[{id:`clipboard-col`,kind:`group`,layout:`column`,gap:.015,children:[{id:`clipboard-title`,kind:`readout`,binding:`app.mode`,visualSize:{x:.18,y:.025},hitPadding:{x:0,y:0}},{id:`clipboard-G`,kind:`slider`,binding:`physics.G`,orientation:`horizontal`,interaction:{kind:`direct-drag`,axis:`x`},visualSize:p,hitPadding:d.defaultHitPadding},{id:`clipboard-soft`,kind:`slider`,binding:`physics.softening`,orientation:`horizontal`,interaction:{kind:`direct-drag`,axis:`x`},visualSize:p,hitPadding:d.defaultHitPadding},{id:`clipboard-int`,kind:`slider`,binding:`physics.interactionStrength`,orientation:`horizontal`,interaction:{kind:`direct-drag`,axis:`x`},visualSize:p,hitPadding:d.defaultHitPadding}]}]}),Sr.activeLayoutId=`clipboard`,X.addEventListener(`visibilitychange`,()=>{j(`xr`,`visibilitychange`,{visibilityState:X?.visibilityState})}),X.requestAnimationFrame(gi),j(`xr`,`first frame requested; waiting for xrFrame callback`),X.addEventListener(`end`,()=>{j(`xr`,`session ended`,{finalPhase:k,framesRendered:$}),X=null,Z=null,fr=null,pr=null,mr=null,hr=!1,L.xrEnabled=!1,$=0,k=`desktop`,Dt(Ct,1),fi(),e.textContent=`Enter VR`,requestAnimationFrame(Bi)})}catch(t){if(A(`xr:toggle`,t,`session failed to start (phase=${k})`),e.textContent=`XR Error: ${t.message}`,X)try{X.end()}catch(e){A(`xr:cleanup-end`,e)}X=null,k=`desktop`,setTimeout(()=>{e.textContent=`Enter VR`},4e3)}}var $=0,hi=3;function gi(e,t){if(!X)return;X.requestAnimationFrame(gi),Re(e);let n=$<hi;n&&j(`xr:frame`,`xrFrame #${$} entered`,{mode:L.mode}),Ze(Ke()),_i++,e-vi>=1e3&&(yi=_i,_i=0,vi=e),k=`xr:frame:${$}:pre-encode`,U.pushErrorScope(`validation`);try{let e=t.getViewerPose(Z);if(!e){n&&j(`xr:frame`,`no viewer pose yet`);return}let r=G[L.mode];if(!r){A(`xr:frame`,Error(`simulation for mode=${L.mode} is not initialized`));return}ui(t),k=`xr:frame:${$}:createCommandEncoder`;let i=U.createCommandEncoder({label:`xr-frame-${$}`});L.paused||(k=`xr:frame:${$}:sim.compute(${L.mode})`,r.compute(i)),n&&j(`xr:frame`,`pose has ${e.views.length} views`);for(let t=0;t<e.views.length;t++){let a=e.views[t];k=`xr:frame:${$}:getViewSubImage(eye=${t})`;let o=pr,s=o.getViewSubImage?o.getViewSubImage(mr,a):o.getSubImage(mr,a);if(!s){A(`xr:frame`,Error(`subImage null for eye ${t}`));continue}n&&t===0&&j(`xr:frame`,`subImage`,{viewport:s.viewport,colorFormat:s.colorTexture.format,hasDepth:!!s.depthStencilTexture}),k=`xr:frame:${$}:createView(color,eye=${t})`;let c=s.getViewDescriptor?s.getViewDescriptor():{},l=s.colorTexture.createView(c);k=`xr:frame:${$}:createView(depth,eye=${t})`;let u=(mr.textureArrayLength??1)>1,d=s.depthStencilTexture;dt=d&&u?d.createView(c):null;let f=a.transform.position;ut={viewMatrix:new Float32Array(a.transform.inverse.matrix),projMatrix:new Float32Array(a.projectionMatrix),eye:[f.x,f.y,f.z]};let{x:p,y:m,width:h,height:g}=s.viewport;k=`xr:frame:${$}:ensureHdrTargets(${h}x${g})`,gt(h,g),H.needsClear=!0;let _=H.sceneIdx;k=`xr:frame:${$}:sim.render(${L.mode},eye=${t})`;let v=H.scene[_].createView();r.render(i,v,null,t),Er||=(Dr=U.createBuffer({label:`xr-widgets-camera`,size:R*2,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),ge(U,Dr,()=>xt(h/g))),k=`xr:frame:${$}:xr-widgets(eye=${t})`,Er.draw(i,v,H.scene[_].format,t,wr),k=`xr:frame:${$}:bloom(eye=${t})`,Ri(i),k=`xr:frame:${$}:composite(eye=${t})`;let y=s.colorTexture.format;zi(i,l,y,[p,m,h,g])}k=`xr:frame:${$}:submit`,U.queue.submit([i.finish()]),n&&j(`xr:frame`,`frame #${$} submitted OK`)}catch(e){A(`xr:frame`,e,`frame #${$} threw synchronously`)}finally{ut=null,dt=null,U.popErrorScope().then(e=>{e&&A(`xr:frame:validation`,e,`frame #${$}`)}).catch(e=>A(`xr:frame:popScope`,e)),$++}}var _i=0,vi=0,yi=0,bi=-1,xi=0,Si={compute:0,render:0,post:0},Ci=!1,wi=0,Ti=2e3,Ei=6,Di=null;function Oi(){U.features.has(`timestamp-query`)&&(Di={querySet:U.createQuerySet({type:`timestamp`,count:Ei}),resolveBuf:U.createBuffer({size:Ei*8,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),stagingBuf:U.createBuffer({size:Ei*8,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),pending:!1})}function ki(e){if(Di)return{querySet:Di.querySet,beginningOfPassWriteIndex:e*2,endOfPassWriteIndex:e*2+1}}function Ai(e,t){if(!Di||Di.pending||t-wi<Ti)return;wi=t,e.resolveQuerySet(Di.querySet,0,Ei,Di.resolveBuf,0),e.copyBufferToBuffer(Di.resolveBuf,0,Di.stagingBuf,0,Ei*8),Di.pending=!0;let n=Di;U.queue.onSubmittedWorkDone().then(()=>{n.stagingBuf.mapAsync(GPUMapMode.READ).then(()=>{let e=new BigUint64Array(n.stagingBuf.getMappedRange().slice(0));n.stagingBuf.unmap(),n.pending=!1;let t=(e,t)=>Number(t-e)/1e6;Si={compute:t(e[0],e[1]),render:t(e[2],e[3]),post:t(e[4],e[5])},xi=t(e[0],e[5])}).catch(()=>{n.pending=!1})})}function ji(e){if(Di||Ci||e-wi<Ti)return;wi=e,Ci=!0;let t=performance.now();U.queue.onSubmittedWorkDone().then(()=>{xi=performance.now()-t,Ci=!1}).catch(()=>{Ci=!1})}function Mi(e,t){console.error(`[sim:${e}]`,t);let n=document.getElementById(`gpu-error-overlay`);n||(n=document.createElement(`div`),n.id=`gpu-error-overlay`,n.style.cssText=`position:fixed;top:60px;left:10px;right:10px;max-height:60vh;overflow:auto;background:rgba(20,0,0,0.92);color:#ff8080;font:11px monospace;padding:10px;border:1px solid #ff4040;border-radius:4px;z-index:9999;white-space:pre-wrap;`,document.body.appendChild(n));let r=new Date().toLocaleTimeString();n.textContent=`[${r}] [sim:${e}] ${t}\n\n`+n.textContent}function Ni(){let e=L.mode;if(G[e])return;let t={boids:Ft,physics:It,physics_classic:Lt,fluid:Rt,parametric:zt,reaction:Bt};U.pushErrorScope(`validation`),U.pushErrorScope(`internal`),U.pushErrorScope(`out-of-memory`);let n=null;try{n=t[e]()}catch(t){Mi(e,`factory threw: ${t.message}`)}let r=n,i=e,a=e=>{if(Mi(i,e),r&&G[i]===r){try{r.destroy()}catch{}delete G[i]}};U.popErrorScope().then(e=>{e&&a(`OOM: ${e.message}`)}),U.popErrorScope().then(e=>{e&&a(`internal: ${e.message}`)}),U.popErrorScope().then(e=>{e&&a(`validation: ${e.message}`)}),n&&(G[e]=n)}function Pi(){let e=L.mode;G[e]&&(G[e].destroy(),delete G[e]),Ni()}function Fi(){let e=yi>0?(1e3/yi).toFixed(1):`--`,t=Si,n=t.compute>0?` (C:${t.compute.toFixed(1)} R:${t.render.toFixed(1)} P:${t.post.toFixed(1)})`:xi>0?` gpu:${xi.toFixed(1)}ms`:``;document.getElementById(`stat-fps`).textContent=`${yi} fps ${e}ms${n}`;let r=G[L.mode],i=r?r.getCount():`--`;document.getElementById(`stat-count`).textContent=L.mode===`fluid`||L.mode===`reaction`?`Grid: ${i}`:`Particles: ${i}`;let a=document.getElementById(`stat-step`);if(a)if(L.mode===`physics`&&r&&`getSimStep`in r){let e=r.getSimStep(),t=r.getTimeDirection();a.style.display=``,a.textContent=`Step: ${e} ${t<0?`◀`:`▶`}`}else a.style.display=`none`}function Ii(){let e=document.getElementById(`canvas-container`),t=window.devicePixelRatio||1,n=Math.floor(e.clientWidth*t),r=Math.floor(e.clientHeight*t);(W.width!==n||W.height!==r)&&(W.width=n,W.height=r),gt(W.width,W.height)}function Li(e,t,n){if(H.needsClear)return;let r=L.fx.trailPersistence;if(r<.001)return;H.fadeParams[0]=r,U.queue.writeBuffer(H.fadeUBO,0,H.fadeParams);let i=e.beginRenderPass({colorAttachments:[{view:H.sceneViews[n],clearValue:ke,loadOp:`clear`,storeOp:`store`}]});i.setPipeline(H.fadePipeline),i.setBindGroup(0,H.fadeBGs[t]),i.draw(3),i.end()}function Ri(e){let t=L.fx,n=H.sceneIdx;for(let r=0;r<pt;r++){let i=r===0?H.scene[n]:H.bloomMips[r-1],a=H.downsampleParams[r];a[0]=1/i.width,a[1]=1/i.height,a[2]=t.bloomThreshold,a[3]=r===0?1:0,U.queue.writeBuffer(H.downsampleUBO[r],0,a);let o=H.downsampleBGs[r===0?n:r+1],s=e.beginRenderPass({colorAttachments:[{view:H.bloomMipViews[r],clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}]});s.setPipeline(H.downsamplePipeline),s.setBindGroup(0,o),s.draw(3),s.end()}for(let n=pt-1;n>0;n--){let r=H.bloomMips[n],i=H.upsampleParams[n];i[0]=1/r.width,i[1]=1/r.height,i[2]=t.bloomRadius,U.queue.writeBuffer(H.upsampleUBO[n],0,i);let a=e.beginRenderPass({colorAttachments:[{view:H.bloomMipViews[n-1],clearValue:{r:0,g:0,b:0,a:1},loadOp:`load`,storeOp:`store`}]});a.setPipeline(H.upsamplePipelineAdditive),a.setBindGroup(0,H.upsampleBGs[n]),a.draw(3),a.end()}}function zi(e,t,n,r=null){let i=L.fx,a=Le(),o=H.compositeParams,s=new Uint32Array(o.buffer);o[0]=i.bloomIntensity,o[1]=i.exposure,o[2]=i.vignette,o[3]=i.chromaticAberration,o[4]=i.grading;let c=r?r[2]/r[3]:W.width/W.height,l=L.camera.fov*Math.PI/180,u=lt(),d=ut?ut.viewMatrix:u.view,f=ut?ut.projMatrix:z.perspective(l,c,.01,it),p=performance.now()*.001,m=Math.max(0,Ke()-(qe()>0?1:0)),h=L.physics.interactionStrength??1,g=L.attractors,_=Math.min(g.length,We);s[5]=_,o[6]=0,o[7]=0,o[8]=a.primary[0],o[9]=a.primary[1],o[10]=a.primary[2],o[12]=a.accent[0],o[13]=a.accent[1],o[14]=a.accent[2],o[16]=p;for(let e=0;e<_;e++){let t=g[e],n=t.x,r=t.y,i=t.z,a=d[0]*n+d[4]*r+d[8]*i+d[12],s=d[1]*n+d[5]*r+d[9]*i+d[13],c=d[2]*n+d[6]*r+d[10]*i+d[14],l=d[3]*n+d[7]*r+d[11]*i+d[15],u=f[0]*a+f[4]*s+f[8]*c+f[12]*l,p=f[1]*a+f[5]*s+f[9]*c+f[13]*l,_=f[3]*a+f[7]*s+f[11]*c+f[15]*l,v=_===0?0:u/_,y=_===0?0:p/_,b=20+e*4;o[b]=v*.5+.5,o[b+1]=1-(y*.5+.5),o[b+2]=Ye(t,m,h),o[b+3]=0}for(let e=_;e<We;e++){let t=20+e*4;o[t]=0,o[t+1]=0,o[t+2]=0,o[t+3]=0}U.queue.writeBuffer(H.compositeUBO,0,o);let v=ht(n),y=H.compositeBGs[H.sceneIdx],b=ki(2),x=e.beginRenderPass({colorAttachments:[{view:t,clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}],...b?{timestampWrites:b}:{}});x.setPipeline(v),x.setBindGroup(0,y),r&&x.setViewport(r[0],r[1],r[2],r[3],0,1),x.draw(3),x.end()}function Bi(e){if(L.xrEnabled)return;requestAnimationFrame(Bi),bi>=0&&un(e-bi),bi=e,Re(e),Ii(),Ze(Ke()),_i++,e-vi>=1e3&&(yi=_i,_i=0,vi=e,Fi());let t=G[L.mode];if(!t)return;let n=L.mode;try{let n=U.createCommandEncoder();fn(t,n),hn();let r=H.sceneIdx,i=1-r;H.sceneIdx=i,Li(n,r,i),t.render(n,H.sceneViews[i],null),Ri(n),zi(n,St.getCurrentTexture().createView(),Ct),Ai(n,e),U.queue.submit([n.finish()]),ji(e),H.needsClear=!1}catch(e){if(Mi(n,`frame threw: ${e.message}`),G[n]===t){try{t.destroy()}catch{}delete G[n]}}}var Vi=`shader-playground-state`;function Hi(){try{let e={};for(let t of Object.keys(N))e[t]=I(t);let t={mode:L.mode,colorTheme:L.colorTheme,camera:L.camera,fx:L.fx,...e};localStorage.setItem(Vi,JSON.stringify(t))}catch{}}function Ui(){try{let e=localStorage.getItem(Vi);if(!e)return;let t=JSON.parse(e);t.mode&&t.mode in N&&(L.mode=t.mode),t.colorTheme&&P[t.colorTheme]&&(L.colorTheme=t.colorTheme);for(let e of Object.keys(N))t[e]&&Object.assign(I(e),t[e]);t.camera&&Object.assign(L.camera,t.camera),t.fx&&Object.assign(L.fx,t.fx),ze(L.colorTheme)}catch{}}function Wi(){document.querySelectorAll(`.mode-tab`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===L.mode)),document.querySelectorAll(`.param-group`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===L.mode)),document.querySelectorAll(`.debug-panel`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===L.mode));for(let e of Object.keys(De)){let t=e,n=document.getElementById(`params-${t}`),r=I(t);n.querySelectorAll(`input[type="range"]`).forEach(e=>{let n=e.dataset.key;if(n&&n in r){e.value=String(r[n]);let i=e.parentElement?.querySelector(`.control-value`);if(i){let e=Yt(t,n);i.textContent=qt(Number(r[n]),e?e.step??.01:.01)}}}),n.querySelectorAll(`select`).forEach(e=>{let t=e.dataset.key;t&&t in r&&(e.value=String(r[t]))})}document.querySelectorAll(`#theme-presets .preset-btn`).forEach(e=>e.classList.toggle(`active`,e.dataset.theme===L.colorTheme)),Kt()}function Gi(){for(let t of Object.keys(De))for(let n of De[t])if(!n.dynamic)for(let r of n.params)r.type===`dropdown`?e.register({kind:`enum`,id:`${t}.${r.key}`,label:r.label,group:t,get:()=>String(I(t)[r.key]),set:e=>{let n=I(t),i=n[r.key];n[r.key]=typeof i==`number`?Number(e):e},options:(r.options??[]).map(e=>({value:String(e),label:String(e)}))}):r.min!==void 0&&r.max!==void 0&&e.register({kind:`continuous`,id:`${t}.${r.key}`,label:r.label,group:t,get:()=>Number(I(t)[r.key]),set:e=>{I(t)[r.key]=e},range:{min:r.min,max:r.max},step:r.step});for(let t of Object.keys(Ee))for(let n of Object.keys(Ee[t]))e.register({kind:`action`,id:`preset.${t}.${n}`,label:n,group:`presets`,invoke:()=>Jt(t,n)});e.register({kind:`enum`,id:`app.mode`,label:`Mode`,group:`app`,get:()=>L.mode,set:e=>Zt(e),options:Object.keys(Xt).map(e=>({value:e,label:Xt[e]}))}),e.register({kind:`enum`,id:`app.theme`,label:`Theme`,group:`app`,get:()=>L.colorTheme,set:e=>{L.colorTheme=e,Be(e)},options:Object.keys(P).map(e=>({value:e,label:e}))}),e.register({kind:`toggle`,id:`app.paused`,label:`Pause`,group:`app`,get:()=>L.paused,set:e=>{L.paused=e,$t()}})}async function Ki(){await Et()&&(On=Dn.matches,document.body.classList.toggle(`mobile`,On),Dn.addEventListener(`change`,e=>{let t=e.matches;t!==On&&(On=t,document.body.classList.toggle(`mobile`,On),window.location.reload())}),Nt(),Ui(),On&&Mn(),ze(L.colorTheme),Gi(),Ut(),gn(),Qt(),en(),On?(kn(),An(),jn()):En(),Vn(),nn(),mn(),Wi(),Ii(),Ni(),In(),new ResizeObserver(()=>Ii()).observe(document.getElementById(`canvas-container`)),requestAnimationFrame(Bi),window.__simDiagnose=()=>{let e=G[L.mode];return e?.diagnose?e.diagnose():Promise.resolve({error:1,msg:`no diagnose on this sim`})},window.__simPreset=e=>{let t=document.querySelectorAll(`button`);for(let n of t)if(n.textContent?.trim()===e)return n.click(),`ok`;return`preset not found`},window.__simState=()=>({mode:L.mode,...L[L.mode],fps:yi,gpuMs:xi,gpuDetail:Si}),window.__bindings=e,window.__anchors={evaluateAnchor:r,handFrames:Q},window.__xrUi={layout:m,hitTestWidgets:S,step:T,applyEffects:D,registry:Sr,makeIdlePrev:w,getRenderList:()=>wr,getPrev:()=>Cr,getClaimed:()=>({...Tr})},window.__simStats=()=>{let e=G[L.mode];return{...e?.getStats?e.getStats():{error:`no stats on this sim`},gpuMs:xi,gpuDetail:Si}})}Ki();