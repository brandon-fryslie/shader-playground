...
`)):(t.className=`shader-success`,t.textContent=`Compiled OK — reset simulation to apply`,t.title=``,en(j.mode,q,e))})}catch(e){t.className=`shader-error`,t.textContent=e.message,t.title=e.message}}function $t(){q&&Kt[q]&&(Gt[q]=Kt[q],Xt(),en(j.mode,q,Kt[q]),document.getElementById(`shader-status`).className=`shader-success`,document.getElementById(`shader-status`).textContent=`Shader reset to original`)}function en(e,t,n){let r={boids:{"Compute (Flocking)":()=>{tn=n},"Render (Vert+Frag)":()=>{nn=n}},physics:{"Compute (Gravity)":()=>{rn=n},"Render (Vert+Frag)":()=>{an=n}},physics_classic:{"Compute (Classic)":()=>{on=n},"Render (Classic)":()=>{sn=n}},fluid:{"Forces + Advect":()=>{cn=n},Diffuse:()=>{ln=n},Divergence:()=>{un=n},"Pressure Solve":()=>{dn=n},"Gradient Sub":()=>{fn=n},Render:()=>{pn=n}},parametric:{"Compute (Mesh Gen)":()=>{mn=n},"Render (Phong)":()=>{hn=n}},reaction:{"Compute (Gray-Scott)":()=>{gn=n},"Render (Raymarch)":()=>{_n=n}}}[e]?.[t];r&&r()}var tn=null,nn=null,rn=null,an=null,on=null,sn=null,cn=null,ln=null,un=null,dn=null,fn=null,pn=null,mn=null,hn=null,gn=null,_n=null,J=null,Y=null,vn=null,yn=null,X=null,bn=!1,xn=[`wrist`,`thumb-metacarpal`,`thumb-phalanx-proximal`,`thumb-phalanx-distal`,`thumb-tip`,`index-finger-metacarpal`,`index-finger-phalanx-proximal`,`index-finger-phalanx-intermediate`,`index-finger-phalanx-distal`,`index-finger-tip`,`middle-finger-metacarpal`,`middle-finger-phalanx-proximal`,`middle-finger-phalanx-intermediate`,`middle-finger-phalanx-distal`,`middle-finger-tip`,`ring-finger-metacarpal`,`ring-finger-phalanx-proximal`,`ring-finger-phalanx-intermediate`,`ring-finger-phalanx-distal`,`ring-finger-tip`,`pinky-finger-metacarpal`,`pinky-finger-phalanx-proximal`,`pinky-finger-phalanx-intermediate`,`pinky-finger-phalanx-distal`,`pinky-finger-tip`];function Sn(e){return{hand:e,tracked:!1,source:null,pinch:{active:!1,startTime:0,origin:[0,0,0],current:[0,0,0]},gazeRay:null,currentRay:null,ray:null,palmNormal:null,joints:null,grip:null}}var Z={left:Sn(`left`),right:Sn(`right`)},Q={left:{kind:`idle`},right:{kind:`idle`}},Cn=[],wn={gainMultiplier:1},Tn={x:0,y:0,z:-5},En=0,Dn={startDistance:0,startOffset:{x:0,y:0,z:0}},On={left:!1,right:!1};function kn(){return{fineModifier:!1,palmUp:!1,wristOrient:null,wristTime:0,flickArmed:!1,lastFlickAt:0}}var An={left:kn(),right:kn()},jn=.7,Mn=.4,Nn=4,Pn=300,Fn={left:-1,right:-2},In=150;function Ln(e){let t=e.matrix;return F([-t[8],-t[9],-t[10]])}function Rn(e,t){if(!Y)return null;let n=e.getPose(t.targetRaySpace,Y);if(!n)return null;let r=n.transform.position;return{origin:[r.x,r.y,r.z],dir:Ln(n.transform)}}function zn(e,t){if(!Y)return null;let n=e.getPose(t.gripSpace||t.targetRaySpace,Y);if(!n)return null;let r=n.transform.position;return[r.x,r.y,r.z]}function Bn(e){let t=!Z.left.source,n=!Z.right.source;return e.handedness===`left`&&t?`left`:e.handedness===`right`&&n?`right`:t?`left`:n?`right`:null}function Vn(e){return Z.left.source===e?`left`:Z.right.source===e?`right`:null}var Hn=.03,Un=Hn*Hn;function Wn(e){return[-e[0],-e[1],-e[2],e[3]]}function Gn(e,t){return[e[3]*t[0]+e[0]*t[3]+e[1]*t[2]-e[2]*t[1],e[3]*t[1]-e[0]*t[2]+e[1]*t[3]+e[2]*t[0],e[3]*t[2]+e[0]*t[1]-e[1]*t[0]+e[2]*t[3],e[3]*t[3]-e[0]*t[0]-e[1]*t[1]-e[2]*t[2]]}function Kn(e,t,n){let r={};for(let i of xn){let a=t.get(i),o=a?e.getJointPose(a,n):null;if(!o){r[i]=null;continue}let s=o.transform.position,c=o.transform.orientation;r[i]={position:[s.x,s.y,s.z],orientation:[c.x,c.y,c.z,c.w],radius:o.radius}}return r}function qn(e,t){let n=e.wrist,r=e[`index-finger-metacarpal`],i=e[`pinky-finger-metacarpal`];if(!n||!r||!i)return null;let a=L(r.position,n.position),o=L(i.position,n.position),s=F(t===`right`?I(o,a):I(a,o));return s[0]===0&&s[1]===0&&s[2]===0?null:s}function Jn(e){let t=e[`thumb-tip`];if(!t)return null;let n=e=>{if(!e)return null;let n=L(t.position,e.position);return R(n,n)<Un};return{thumbIndex:n(e[`index-finger-tip`]),thumbMiddle:n(e[`middle-finger-tip`]),thumbRing:n(e[`ring-finger-tip`]),thumbPinky:n(e[`pinky-finger-tip`])}}function Yn(){if(!vn)return;let e=globalThis.XRRigidTransform;Y=vn.getOffsetReferenceSpace(new e({x:Tn.x,y:Tn.y+En,z:Tn.z}))}function Xn(e){for(let t=Cn.length-1;t>=0;t--){let n=Cn[t],r=Rn(e,n);if(!r)continue;Cn.splice(t,1);let i=Bn(n);if(!i)continue;let a=zn(e,n)??r.origin,o=Z[i];o.tracked=!0,o.source=n,o.pinch.active=!0,o.pinch.startTime=performance.now(),o.pinch.origin=a,o.pinch.current=a,o.gazeRay={origin:[...r.origin],dir:[...r.dir]},o.currentRay=r}for(let t of[`left`,`right`]){let n=Z[t];if(!n.pinch.active||!n.source)continue;let r=Rn(e,n.source);r&&(n.currentRay=r);let i=zn(e,n.source);i&&(n.pinch.current=i)}for(let e of[`left`,`right`]){let t=Z[e];t.joints=null,t.palmNormal=null,t.grip=null,t.ray=null}if(Y)for(let t of e.session.inputSources){if(t.handedness===`none`||!t.hand)continue;let n=t.handedness,r=Z[n],i=Kn(e,t.hand,Y);r.joints=i,r.palmNormal=qn(i,n),r.grip=Jn(i),r.ray=Zn(i)}}function Zn(e){let t=e.wrist,n=e[`index-finger-metacarpal`];if(!t||!n)return null;let r=F(L(n.position,t.position));return r[0]===0&&r[1]===0&&r[2]===0?null:{origin:[...n.position],dir:r}}function Qn(){let e=[],t=Z.left.pinch.active,n=Z.right.pinch.active,r=t&&n,i=On.left&&On.right,a=performance.now();for(let t of[`left`,`right`]){let n=Z[t],r=On[t],i=n.pinch.active;i&&!r&&n.gazeRay?e.push({kind:`pinch-start`,hand:t,gazeRay:n.gazeRay}):i&&r?e.push({kind:`pinch-hold`,hand:t,dur:a-n.pinch.startTime}):!i&&r&&e.push({kind:`pinch-end`,hand:t,dur:a-n.pinch.startTime});let o=An[t];if(n.grip){let r=n.grip.thumbRing===!0;r&&!o.fineModifier?e.push({kind:`fine-modifier-on`,hand:t}):!r&&o.fineModifier&&e.push({kind:`fine-modifier-off`,hand:t}),o.fineModifier=r}if(n.palmNormal){let r=n.palmNormal[1],i=o.palmUp?r>Mn:r>jn;i&&!o.palmUp?e.push({kind:`palm-up`,hand:t}):!i&&o.palmUp&&e.push({kind:`palm-down`,hand:t}),o.palmUp=i}let s=n.joints?.wrist?.orientation??null;if(s&&o.wristOrient){let n=Math.max(.001,(a-o.wristTime)/1e3),r=Gn(s,Wn(o.wristOrient)),i=Math.min(1,Math.abs(r[3])),c=2*Math.acos(i),l=Math.sqrt(Math.max(0,1-i*i)),u=r[3]<0?-1:1,d=l>1e-6?r[0]*u/l:0,f=l>1e-6?r[1]*u/l:0,p=l>1e-6?r[2]*u/l:0,m=c/n>Nn;if(m&&o.flickArmed&&a-o.lastFlickAt>Pn){let n=Math.abs(d),r=Math.abs(f),i=Math.abs(p),s=n>=r&&n>=i?`pitch`:r>=i?`yaw`:`roll`,c=(s===`pitch`?d:s===`yaw`?f:p)>=0?1:-1;e.push({kind:`wrist-flick`,hand:t,axis:s,sign:c}),o.lastFlickAt=a}o.flickArmed=m}else o.flickArmed=!1;o.wristOrient=s?[...s]:null,o.wristTime=a}return r&&!i?e.push({kind:`two-hand-pinch-start`}):!r&&i&&e.push({kind:`two-hand-pinch-end`}),On.left=t,On.right=n,e}function $n(e,t){for(let t of e)switch(t.kind){case`pinch-start`:Q[t.hand]={kind:`pending`,deadline:performance.now()+In};break;case`two-hand-pinch-start`:if(Q.left.kind===`pending`&&Q.right.kind===`pending`){let e=L(Z.left.pinch.current,Z.right.pinch.current);Dn.startDistance=Math.max(.01,Math.sqrt(R(e,e))),Dn.startOffset={...Tn},Q.left={kind:`two-hand-scale`},Q.right={kind:`two-hand-scale`}}break;case`two-hand-pinch-end`:Q.left.kind===`two-hand-scale`&&(Q.left={kind:`idle`}),Q.right.kind===`two-hand-scale`&&(Q.right={kind:`idle`});break;case`pinch-end`:er(t.hand);break;case`pinch-hold`:break;case`fine-modifier-on`:wn.gainMultiplier=.1;break;case`fine-modifier-off`:wn.gainMultiplier=1;break;case`palm-up`:case`palm-down`:case`wrist-flick`:break}let n=performance.now();for(let e of[`left`,`right`]){let t=Q[e];t.kind===`pending`&&n>=t.deadline&&(Q[e]={kind:`dragging`,handOrigin:[...Z[e].pinch.origin],hasSample:!1})}}function er(e){switch(Q[e].kind){case`dragging`:jt(),pe(Fn[e]);break;case`pending`:case`two-hand-scale`:case`idle`:break}Q[e]={kind:`idle`};let t=Z[e];t.pinch.active||(t.source=null,t.gazeRay=null,t.currentRay=null)}function tr(e){if(Q.left.kind===`two-hand-scale`&&Q.right.kind===`two-hand-scale`){let e=L(Z.left.pinch.current,Z.right.pinch.current),t=Math.sqrt(R(e,e));if(Dn.startDistance>=.01){let e=t/Dn.startDistance;Tn.z=Math.max(-200,Math.min(-1,Dn.startOffset.z/e)),Yn()}return}let t=!1;for(let e of[`left`,`right`]){let n=Q[e],r=Z[e];if(n.kind!==`dragging`||!r.source)continue;let i=r.currentRay;if(!i)continue;t=!0;let a=j.mode===`fluid`?kt(i.origin,i.dir,0):At(i.origin,i.dir);if(!a){jt(),n.hasSample=!1;continue}if(j.mouse.down=!0,j.mouse.worldX=a[0],j.mouse.worldY=a[1],j.mouse.worldZ=a[2],j.mode===`fluid`){let e=Ot(a);if(!e){jt(),n.hasSample=!1;continue}j.mouse.dx=n.hasSample?(e[0]-j.mouse.x)*10:0,j.mouse.dy=n.hasSample?(e[1]-j.mouse.y)*10:0,j.mouse.x=e[0],j.mouse.y=e[1]}else j.mouse.dx=0,j.mouse.dy=0,j.mouse.x=a[0],j.mouse.y=a[1];if(j.mode===`physics`){let t=Fn[e];j.pointerToAttractor.has(t)?fe(t,a):M(t,a)}n.hasSample=!0}t||j.xrEnabled&&j.mouse.down&&jt()}function nr(e){Xn(e),$n(Qn(),e),tr(e)}function rr(e){let t=Vn(e);if(t){let e=Z[t];e.pinch.active=!1,e.tracked=!1}let n=Cn.indexOf(e);n>=0&&Cn.splice(n,1)}function ir(){Cn.length=0,Z.left=Sn(`left`),Z.right=Sn(`right`),Q.left={kind:`idle`},Q.right={kind:`idle`},On.left=!1,On.right=!1,An.left=kn(),An.right=kn(),wn.gainMultiplier=1,jt(),pe(Fn.left),pe(Fn.right)}function ar(){let e=document.getElementById(`btn-xr`);if(!navigator.xr){e.textContent=`VR Not Available`;return}navigator.xr.isSessionSupported(`immersive-vr`).then(t=>{t?(e.disabled=!1,e.addEventListener(`click`,or)):e.textContent=`VR Not Supported`}).catch(()=>{e.textContent=`VR Check Failed`})}async function or(){if(J){d(`xr`,`exiting session (user clicked Exit VR)`),c=`xr:session.end`,J.end();return}let e=document.getElementById(`btn-xr`);e.textContent=`Starting...`,d(`xr`,`toggleXR start`,{hasWebXR:!!navigator.xr,userAgent:navigator.userAgent});try{c=`xr:requestSession`,J=await navigator.xr.requestSession(`immersive-vr`,{requiredFeatures:[`webgpu`],optionalFeatures:[`layers`,`local-floor`,`hand-tracking`]});let t=J.enabledFeatures;bn=!!t&&t.includes(`hand-tracking`),d(`xr`,`session acquired`,{environmentBlendMode:J.environmentBlendMode,interactionMode:J.interactionMode,visibilityState:J.visibilityState,handTracking:bn,enabledFeatures:t});let n=!1;try{c=`xr:requestReferenceSpace(local-floor)`,Y=await J.requestReferenceSpace(`local-floor`),n=!0,d(`xr`,`reference space = local-floor`)}catch(e){d(`xr`,`local-floor unavailable, falling back to local`,e.message),c=`xr:requestReferenceSpace(local)`,Y=await J.requestReferenceSpace(`local`)}vn=Y,En=n?1.6:0,Tn.x=0,Tn.y=0,Tn.z=-5,Yn(),c=`xr:new XRGPUBinding`,yn=new XRGPUBinding(J,V);let r=yn.getPreferredColorFormat(),i=yn.nativeProjectionScaleFactor;d(`xr`,`binding ready`,{preferredFormat:r,nativeProjectionScaleFactor:i}),Fe(r,1);let a=[{colorFormat:r,depthStencilFormat:`depth24plus`,scaleFactor:i,textureType:`texture-array`},{colorFormat:r,depthStencilFormat:`depth24plus`,textureType:`texture-array`},{colorFormat:r,scaleFactor:i,textureType:`texture-array`},{colorFormat:r,textureType:`texture-array`},{colorFormat:r,scaleFactor:i},{colorFormat:r}];c=`xr:createProjectionLayer`;let o=null,s=[];for(let e of a)try{X=yn.createProjectionLayer(e),o=e;break}catch(t){let n=t.message;s.push({config:e,error:n}),d(`xr`,`projection layer config rejected`,{config:e,error:n}),X=null}if(!X)throw Error(`All projection layer configurations failed. Attempts: ${JSON.stringify(s)}`);d(`xr`,`projection layer created`,{config:o,textureWidth:X.textureWidth,textureHeight:X.textureHeight,textureArrayLength:X.textureArrayLength,ignoreDepthValues:X.ignoreDepthValues});try{X.fixedFoveation=0,d(`xr`,`fixedFoveation set to 0`)}catch(e){d(`xr`,`fixedFoveation unsupported on this platform`,e.message)}c=`xr:updateRenderState`;try{J.updateRenderState({layers:[X]}),d(`xr`,`render state updated with projection layer`)}catch(e){throw u(`xr:updateRenderState`,e),e}J.addEventListener(`selectstart`,e=>{Cn.push(e.inputSource)}),J.addEventListener(`selectend`,e=>{rr(e.inputSource)}),e.textContent=`Exit VR`,j.xrEnabled=!0,c=`xr:awaiting first frame`,J.addEventListener(`visibilitychange`,()=>{d(`xr`,`visibilitychange`,{visibilityState:J?.visibilityState})}),J.requestAnimationFrame(cr),d(`xr`,`first frame requested; waiting for xrFrame callback`),J.addEventListener(`end`,()=>{d(`xr`,`session ended`,{finalPhase:c,framesRendered:$}),J=null,Y=null,vn=null,yn=null,X=null,bn=!1,j.xrEnabled=!1,$=0,c=`desktop`,Fe(U,1),ir(),e.textContent=`Enter VR`,requestAnimationFrame(Mr)})}catch(t){if(u(`xr:toggle`,t,`session failed to start (phase=${c})`),e.textContent=`XR Error: ${t.message}`,J)try{J.end()}catch(e){u(`xr:cleanup-end`,e)}J=null,c=`desktop`,setTimeout(()=>{e.textContent=`Enter VR`},4e3)}}var $=0,sr=3;function cr(e,t){if(!J)return;J.requestAnimationFrame(cr),O(e);let n=$<sr;n&&d(`xr:frame`,`xrFrame #${$} entered`,{mode:j.mode}),de(oe()),lr++,e-ur>=1e3&&(dr=lr,lr=0,ur=e),c=`xr:frame:${$}:pre-encode`,V.pushErrorScope(`validation`);try{let e=t.getViewerPose(Y);if(!e){n&&d(`xr:frame`,`no viewer pose yet`);return}let r=G[j.mode];if(!r){u(`xr:frame`,Error(`simulation for mode=${j.mode} is not initialized`));return}nr(t),c=`xr:frame:${$}:createCommandEncoder`;let i=V.createCommandEncoder({label:`xr-frame-${$}`});j.paused||(c=`xr:frame:${$}:sim.compute(${j.mode})`,r.compute(i)),n&&d(`xr:frame`,`pose has ${e.views.length} views`);for(let t=0;t<e.views.length;t++){let a=e.views[t];c=`xr:frame:${$}:getViewSubImage(eye=${t})`;let o=yn,s=o.getViewSubImage?o.getViewSubImage(X,a):o.getSubImage(X,a);if(!s){u(`xr:frame`,Error(`subImage null for eye ${t}`));continue}n&&t===0&&d(`xr:frame`,`subImage`,{viewport:s.viewport,colorFormat:s.colorTexture.format,hasDepth:!!s.depthStencilTexture}),c=`xr:frame:${$}:createView(color,eye=${t})`;let l=s.getViewDescriptor?s.getViewDescriptor():{},f=s.colorTexture.createView(l);c=`xr:frame:${$}:createView(depth,eye=${t})`;let p=(X.textureArrayLength??1)>1,m=s.depthStencilTexture;xe=m&&p?m.createView(l):null;let h=a.transform.position;z={viewMatrix:new Float32Array(a.transform.inverse.matrix),projMatrix:new Float32Array(a.projectionMatrix),eye:[h.x,h.y,h.z]};let{x:g,y:_,width:v,height:y}=s.viewport;c=`xr:frame:${$}:ensureHdrTargets(${v}x${y})`,Ee(v,y),B.needsClear=!0;let b=B.sceneIdx;c=`xr:frame:${$}:sim.render(${j.mode},eye=${t})`,r.render(i,B.scene[b].createView(),null,t),c=`xr:frame:${$}:bloom(eye=${t})`,Ar(i),c=`xr:frame:${$}:composite(eye=${t})`;let x=s.colorTexture.format;jr(i,f,x,[g,_,v,y])}c=`xr:frame:${$}:submit`,V.queue.submit([i.finish()]),n&&d(`xr:frame`,`frame #${$} submitted OK`)}catch(e){u(`xr:frame`,e,`frame #${$} threw synchronously`)}finally{z=null,xe=null,V.popErrorScope().then(e=>{e&&u(`xr:frame:validation`,e,`frame #${$}`)}).catch(e=>u(`xr:frame:popScope`,e)),$++}}var lr=0,ur=0,dr=0,fr=-1,pr=0,mr={compute:0,render:0,post:0},hr=!1,gr=0,_r=2e3,vr=6,yr=null;function br(){V.features.has(`timestamp-query`)&&(yr={querySet:V.createQuerySet({type:`timestamp`,count:vr}),resolveBuf:V.createBuffer({size:vr*8,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),stagingBuf:V.createBuffer({size:vr*8,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),pending:!1})}function xr(e){if(yr)return{querySet:yr.querySet,beginningOfPassWriteIndex:e*2,endOfPassWriteIndex:e*2+1}}function Sr(e,t){if(!yr||yr.pending||t-gr<_r)return;gr=t,e.resolveQuerySet(yr.querySet,0,vr,yr.resolveBuf,0),e.copyBufferToBuffer(yr.resolveBuf,0,yr.stagingBuf,0,vr*8),yr.pending=!0;let n=yr;V.queue.onSubmittedWorkDone().then(()=>{n.stagingBuf.mapAsync(GPUMapMode.READ).then(()=>{let e=new BigUint64Array(n.stagingBuf.getMappedRange().slice(0));n.stagingBuf.unmap(),n.pending=!1;let t=(e,t)=>Number(t-e)/1e6;mr={compute:t(e[0],e[1]),render:t(e[2],e[3]),post:t(e[4],e[5])},pr=t(e[0],e[5])}).catch(()=>{n.pending=!1})})}function Cr(e){if(yr||hr||e-gr<_r)return;gr=e,hr=!0;let t=performance.now();V.queue.onSubmittedWorkDone().then(()=>{pr=performance.now()-t,hr=!1}).catch(()=>{hr=!1})}function wr(e,t){console.error(`[sim:${e}]`,t);let n=document.getElementById(`gpu-error-overlay`);n||(n=document.createElement(`div`),n.id=`gpu-error-overlay`,n.style.cssText=`position:fixed;top:60px;left:10px;right:10px;max-height:60vh;overflow:auto;background:rgba(20,0,0,0.92);color:#ff8080;font:11px monospace;padding:10px;border:1px solid #ff4040;border-radius:4px;z-index:9999;white-space:pre-wrap;`,document.body.appendChild(n));let r=new Date().toLocaleTimeString();n.textContent=`[${r}] [sim:${e}] ${t}\n\n`+n.textContent}function Tr(){let e=j.mode;if(G[e])return;let t={boids:Ue,physics:We,physics_classic:Ge,fluid:Ke,parametric:qe,reaction:Je};V.pushErrorScope(`validation`),V.pushErrorScope(`internal`),V.pushErrorScope(`out-of-memory`);let n=null;try{n=t[e]()}catch(t){wr(e,`factory threw: ${t.message}`)}let r=n,i=e,a=e=>{if(wr(i,e),r&&G[i]===r){try{r.destroy()}catch{}delete G[i]}};V.popErrorScope().then(e=>{e&&a(`OOM: ${e.message}`)}),V.popErrorScope().then(e=>{e&&a(`internal: ${e.message}`)}),V.popErrorScope().then(e=>{e&&a(`validation: ${e.message}`)}),n&&(G[e]=n)}function Er(){let e=j.mode;G[e]&&(G[e].destroy(),delete G[e]),Tr()}function Dr(){let e=dr>0?(1e3/dr).toFixed(1):`--`,t=mr,n=t.compute>0?` (C:${t.compute.toFixed(1)} R:${t.render.toFixed(1)} P:${t.post.toFixed(1)})`:pr>0?` gpu:${pr.toFixed(1)}ms`:``;document.getElementById(`stat-fps`).textContent=`${dr} fps ${e}ms${n}`;let r=G[j.mode],i=r?r.getCount():`--`;document.getElementById(`stat-count`).textContent=j.mode===`fluid`||j.mode===`reaction`?`Grid: ${i}`:`Particles: ${i}`;let a=document.getElementById(`stat-step`);if(a)if(j.mode===`physics`&&r&&`getSimStep`in r){let e=r.getSimStep(),t=r.getTimeDirection();a.style.display=``,a.textContent=`Step: ${e} ${t<0?`◀`:`▶`}`}else a.style.display=`none`}function Or(){let e=document.getElementById(`canvas-container`),t=window.devicePixelRatio||1,n=Math.floor(e.clientWidth*t),r=Math.floor(e.clientHeight*t);(H.width!==n||H.height!==r)&&(H.width=n,H.height=r),Ee(H.width,H.height)}function kr(e,t,n){if(B.needsClear)return;let r=j.fx.trailPersistence;if(r<.001)return;B.fadeParams[0]=r,V.queue.writeBuffer(B.fadeUBO,0,B.fadeParams);let i=e.beginRenderPass({colorAttachments:[{view:B.sceneViews[n],clearValue:y,loadOp:`clear`,storeOp:`store`}]});i.setPipeline(B.fadePipeline),i.setBindGroup(0,B.fadeBGs[t]),i.draw(3),i.end()}function Ar(e){let t=j.fx,n=B.sceneIdx;for(let r=0;r<Ce;r++){let i=r===0?B.scene[n]:B.bloomMips[r-1],a=B.downsampleParams[r];a[0]=1/i.width,a[1]=1/i.height,a[2]=t.bloomThreshold,a[3]=r===0?1:0,V.queue.writeBuffer(B.downsampleUBO[r],0,a);let o=B.downsampleBGs[r===0?n:r+1],s=e.beginRenderPass({colorAttachments:[{view:B.bloomMipViews[r],clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}]});s.setPipeline(B.downsamplePipeline),s.setBindGroup(0,o),s.draw(3),s.end()}for(let n=Ce-1;n>0;n--){let r=B.bloomMips[n],i=B.upsampleParams[n];i[0]=1/r.width,i[1]=1/r.height,i[2]=t.bloomRadius,V.queue.writeBuffer(B.upsampleUBO[n],0,i);let a=e.beginRenderPass({colorAttachments:[{view:B.bloomMipViews[n-1],clearValue:{r:0,g:0,b:0,a:1},loadOp:`load`,storeOp:`store`}]});a.setPipeline(B.upsamplePipelineAdditive),a.setBindGroup(0,B.upsampleBGs[n]),a.draw(3),a.end()}}function jr(e,t,n,r=null){let i=j.fx,a=D(),o=B.compositeParams,s=new Uint32Array(o.buffer);o[0]=i.bloomIntensity,o[1]=i.exposure,o[2]=i.vignette,o[3]=i.chromaticAberration,o[4]=i.grading;let c=r?r[2]/r[3]:H.width/H.height,l=j.camera.fov*Math.PI/180,u=be(),d=z?z.viewMatrix:u.view,f=z?z.projMatrix:P.perspective(l,c,.01,_e),p=performance.now()*.001,m=Math.max(0,oe()-(se()>0?1:0)),h=j.physics.interactionStrength??1,g=j.attractors,_=Math.min(g.length,ie);s[5]=_,o[6]=0,o[7]=0,o[8]=a.primary[0],o[9]=a.primary[1],o[10]=a.primary[2],o[12]=a.accent[0],o[13]=a.accent[1],o[14]=a.accent[2],o[16]=p;for(let e=0;e<_;e++){let t=g[e],n=t.x,r=t.y,i=t.z,a=d[0]*n+d[4]*r+d[8]*i+d[12],s=d[1]*n+d[5]*r+d[9]*i+d[13],c=d[2]*n+d[6]*r+d[10]*i+d[14],l=d[3]*n+d[7]*r+d[11]*i+d[15],u=f[0]*a+f[4]*s+f[8]*c+f[12]*l,p=f[1]*a+f[5]*s+f[9]*c+f[13]*l,_=f[3]*a+f[7]*s+f[11]*c+f[15]*l,v=_===0?0:u/_,y=_===0?0:p/_,b=20+e*4;o[b]=v*.5+.5,o[b+1]=1-(y*.5+.5),o[b+2]=le(t,m,h),o[b+3]=0}for(let e=_;e<ie;e++){let t=20+e*4;o[t]=0,o[t+1]=0,o[t+2]=0,o[t+3]=0}V.queue.writeBuffer(B.compositeUBO,0,o);let v=Te(n),y=B.compositeBGs[B.sceneIdx],b=xr(2),x=e.beginRenderPass({colorAttachments:[{view:t,clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}],...b?{timestampWrites:b}:{}});x.setPipeline(v),x.setBindGroup(0,y),r&&x.setViewport(r[0],r[1],r[2],r[3],0,1),x.draw(3),x.end()}function Mr(e){if(j.xrEnabled)return;requestAnimationFrame(Mr),fr>=0&&gt(e-fr),fr=e,O(e),Or(),de(oe()),lr++,e-ur>=1e3&&(dr=lr,lr=0,ur=e,Dr());let t=G[j.mode];if(!t)return;let n=j.mode;try{let n=V.createCommandEncoder();vt(t,n),xt();let r=B.sceneIdx,i=1-r;B.sceneIdx=i,kr(n,r,i),t.render(n,B.sceneViews[i],null),Ar(n),jr(n,Me.getCurrentTexture().createView(),U),Sr(n,e),V.queue.submit([n.finish()]),Cr(e),B.needsClear=!1}catch(e){if(wr(n,`frame threw: ${e.message}`),G[n]===t){try{t.destroy()}catch{}delete G[n]}}}var Nr=`shader-playground-state`;function Pr(){try{let e={};for(let t of Object.keys(p))e[t]=A(t);let t={mode:j.mode,colorTheme:j.colorTheme,camera:j.camera,fx:j.fx,...e};localStorage.setItem(Nr,JSON.stringify(t))}catch{}}function Fr(){try{let e=localStorage.getItem(Nr);if(!e)return;let t=JSON.parse(e);t.mode&&t.mode in p&&(j.mode=t.mode),t.colorTheme&&g[t.colorTheme]&&(j.colorTheme=t.colorTheme);for(let e of Object.keys(p))t[e]&&Object.assign(A(e),t[e]);t.camera&&Object.assign(j.camera,t.camera),t.fx&&Object.assign(j.fx,t.fx),k(j.colorTheme)}catch{}}function Ir(){document.querySelectorAll(`.mode-tab`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===j.mode)),document.querySelectorAll(`.param-group`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===j.mode)),document.querySelectorAll(`.debug-panel`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===j.mode));for(let e of Object.keys(h)){let t=e,n=document.getElementById(`params-${t}`),r=A(t);n.querySelectorAll(`input[type="range"]`).forEach(e=>{let n=e.dataset.key;if(n&&n in r){e.value=String(r[n]);let i=e.parentElement?.querySelector(`.control-value`);if(i){let e=rt(t,n);i.textContent=tt(Number(r[n]),e?e.step??.01:.01)}}}),n.querySelectorAll(`select`).forEach(e=>{let t=e.dataset.key;t&&t in r&&(e.value=String(r[t]))})}document.querySelectorAll(`#theme-presets .preset-btn`).forEach(e=>e.classList.toggle(`active`,e.dataset.theme===j.colorTheme)),et()}async function Lr(){await W()&&(Pt=Nt.matches,document.body.classList.toggle(`mobile`,Pt),Nt.addEventListener(`change`,e=>{let t=e.matches;t!==Pt&&(Pt=t,document.body.classList.toggle(`mobile`,Pt),window.location.reload())}),Ve(),Fr(),Pt&&Rt(),k(j.colorTheme),Ze(),St(),ot(),ct(),Pt?(Ft(),It(),Lt()):Mt(),qt(),lt(),bt(),Ir(),Or(),Tr(),Ht(),new ResizeObserver(()=>Or()).observe(document.getElementById(`canvas-container`)),requestAnimationFrame(Mr),window.__simDiagnose=()=>{let e=G[j.mode];return e?.diagnose?e.diagnose():Promise.resolve({error:1,msg:`no diagnose on this sim`})},window.__simPreset=e=>{let t=document.querySelectorAll(`button`);for(let n of t)if(n.textContent?.trim()===e)return n.click(),`ok`;return`preset not found`},window.__simState=()=>({mode:j.mode,...j[j.mode],fps:dr,gpuMs:pr,gpuDetail:mr}),window.__simStats=()=>{let e=G[j.mode];return{...e?.getStats?e.getStats():{error:`no stats on this sim`},gpuMs:pr,gpuDetail:mr}})}Lr();