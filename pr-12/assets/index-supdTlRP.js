...
`)):(t.className=`shader-success`,t.textContent=`Compiled OK — reset simulation to apply`,t.title=``,en(j.mode,q,e))})}catch(e){t.className=`shader-error`,t.textContent=e.message,t.title=e.message}}function $t(){q&&Kt[q]&&(Gt[q]=Kt[q],Xt(),en(j.mode,q,Kt[q]),document.getElementById(`shader-status`).className=`shader-success`,document.getElementById(`shader-status`).textContent=`Shader reset to original`)}function en(e,t,n){let r={boids:{"Compute (Flocking)":()=>{tn=n},"Render (Vert+Frag)":()=>{nn=n}},physics:{"Compute (Gravity)":()=>{rn=n},"Render (Vert+Frag)":()=>{an=n}},physics_classic:{"Compute (Classic)":()=>{on=n},"Render (Classic)":()=>{sn=n}},fluid:{"Forces + Advect":()=>{cn=n},Diffuse:()=>{ln=n},Divergence:()=>{un=n},"Pressure Solve":()=>{dn=n},"Gradient Sub":()=>{fn=n},Render:()=>{pn=n}},parametric:{"Compute (Mesh Gen)":()=>{mn=n},"Render (Phong)":()=>{hn=n}},reaction:{"Compute (Gray-Scott)":()=>{gn=n},"Render (Raymarch)":()=>{_n=n}}}[e]?.[t];r&&r()}var tn=null,nn=null,rn=null,an=null,on=null,sn=null,cn=null,ln=null,un=null,dn=null,fn=null,pn=null,mn=null,hn=null,gn=null,_n=null,J=null,vn=null,yn=null,bn=null,Y=null,xn=!1,Sn=[`wrist`,`thumb-metacarpal`,`thumb-phalanx-proximal`,`thumb-phalanx-distal`,`thumb-tip`,`index-finger-metacarpal`,`index-finger-phalanx-proximal`,`index-finger-phalanx-intermediate`,`index-finger-phalanx-distal`,`index-finger-tip`,`middle-finger-metacarpal`,`middle-finger-phalanx-proximal`,`middle-finger-phalanx-intermediate`,`middle-finger-phalanx-distal`,`middle-finger-tip`,`ring-finger-metacarpal`,`ring-finger-phalanx-proximal`,`ring-finger-phalanx-intermediate`,`ring-finger-phalanx-distal`,`ring-finger-tip`,`pinky-finger-metacarpal`,`pinky-finger-phalanx-proximal`,`pinky-finger-phalanx-intermediate`,`pinky-finger-phalanx-distal`,`pinky-finger-tip`];function Cn(e){return{hand:e,tracked:!1,source:null,pinch:{active:!1,startTime:0,origin:[0,0,0],current:[0,0,0]},gazeRay:null,currentRay:null,palmNormal:null,joints:null,grip:null}}var X={left:Cn(`left`),right:Cn(`right`)},Z={left:{kind:`idle`},right:{kind:`idle`}},wn=[],Tn={gainMultiplier:1},En={x:0,y:0,z:-5},Dn=0,On={startDistance:0,startOffset:{x:0,y:0,z:0}},kn={left:!1,right:!1},An=-1;function jn(e){let t=e.matrix;return F([-t[8],-t[9],-t[10]])}function Mn(e,t){if(!vn)return null;let n=e.getPose(t.targetRaySpace,vn);if(!n)return null;let r=n.transform.position;return{origin:[r.x,r.y,r.z],dir:jn(n.transform)}}function Nn(e,t){if(!vn)return null;let n=e.getPose(t.gripSpace||t.targetRaySpace,vn);if(!n)return null;let r=n.transform.position;return[r.x,r.y,r.z]}function Pn(e){let t=!X.left.source,n=!X.right.source;return e.handedness===`left`&&t?`left`:e.handedness===`right`&&n?`right`:t?`left`:n?`right`:null}function Fn(e){return X.left.source===e?`left`:X.right.source===e?`right`:null}var In=.03,Ln=In*In;function Rn(e,t,n){let r={};for(let i of Sn){let a=t.get(i),o=a?e.getJointPose(a,n):null;if(!o){r[i]=null;continue}let s=o.transform.position,c=o.transform.orientation;r[i]={position:[s.x,s.y,s.z],orientation:[c.x,c.y,c.z,c.w],radius:o.radius}}return r}function zn(e,t){let n=e.wrist,r=e[`index-finger-metacarpal`],i=e[`pinky-finger-metacarpal`];if(!n||!r||!i)return null;let a=L(r.position,n.position),o=L(i.position,n.position),s=F(t===`right`?I(o,a):I(a,o));return s[0]===0&&s[1]===0&&s[2]===0?null:s}function Bn(e){let t=e[`thumb-tip`];if(!t)return null;let n=e=>{if(!e)return null;let n=L(t.position,e.position);return R(n,n)<Ln};return{thumbIndex:n(e[`index-finger-tip`]),thumbMiddle:n(e[`middle-finger-tip`]),thumbRing:n(e[`ring-finger-tip`]),thumbPinky:n(e[`pinky-finger-tip`])}}function Vn(){if(!yn)return;let e=globalThis.XRRigidTransform;vn=yn.getOffsetReferenceSpace(new e({x:En.x,y:En.y+Dn,z:En.z}))}function Hn(e){for(let t=wn.length-1;t>=0;t--){let n=wn[t],r=Mn(e,n);if(!r)continue;wn.splice(t,1);let i=Pn(n);if(!i)continue;let a=Nn(e,n)??r.origin,o=X[i];o.tracked=!0,o.source=n,o.pinch.active=!0,o.pinch.startTime=performance.now(),o.pinch.origin=a,o.pinch.current=a,o.gazeRay={origin:[...r.origin],dir:[...r.dir]},o.currentRay=r}for(let t of[`left`,`right`]){let n=X[t];if(!n.pinch.active||!n.source)continue;let r=Mn(e,n.source);r&&(n.currentRay=r);let i=Nn(e,n.source);i&&(n.pinch.current=i)}for(let e of[`left`,`right`]){let t=X[e];t.joints=null,t.palmNormal=null,t.grip=null}if(vn)for(let t of e.session.inputSources){if(t.handedness===`none`||!t.hand)continue;let n=t.handedness,r=X[n],i=Rn(e,t.hand,vn);r.joints=i,r.palmNormal=zn(i,n),r.grip=Bn(i)}}function Un(){let e=[],t=X.left.pinch.active,n=X.right.pinch.active,r=t&&n,i=kn.left&&kn.right;for(let t of[`left`,`right`]){let n=X[t],r=kn[t],i=n.pinch.active;i&&!r&&n.gazeRay?e.push({kind:`pinch-start`,hand:t,gazeRay:n.gazeRay}):i&&r?e.push({kind:`pinch-hold`,hand:t,dur:performance.now()-n.pinch.startTime}):!i&&r&&e.push({kind:`pinch-end`,hand:t,dur:performance.now()-n.pinch.startTime})}return r&&!i?e.push({kind:`two-hand-pinch-start`}):!r&&i&&e.push({kind:`two-hand-pinch-end`}),kn.left=t,kn.right=n,e}function Wn(e,t){for(let n of e)switch(n.kind){case`two-hand-pinch-start`:{Kn(`left`),Kn(`right`);let e=X.left.pinch.current,t=X.right.pinch.current,n=L(e,t);On.startDistance=Math.max(.01,Math.sqrt(R(n,n))),On.startOffset={...En},Z.left={kind:`two-hand-scale`},Z.right={kind:`two-hand-scale`};break}case`two-hand-pinch-end`:Z.left.kind===`two-hand-scale`&&(Z.left={kind:`idle`}),Z.right.kind===`two-hand-scale`&&(Z.right={kind:`idle`});break;case`pinch-start`:if(X.left.pinch.active&&X.right.pinch.active)break;Gn(n.hand,n.gazeRay,t);break;case`pinch-hold`:Z[n.hand].kind===`idle`&&X[n.hand].gazeRay&&(X[n.hand===`left`?`right`:`left`].pinch.active||Gn(n.hand,X[n.hand].gazeRay,t));break;case`pinch-end`:Kn(n.hand);break;case`fine-modifier-on`:Tn.gainMultiplier=.1;break;case`fine-modifier-off`:Tn.gainMultiplier=1;break;case`palm-up`:case`palm-down`:case`wrist-flick`:break}}function Gn(e,t,n){Z[e]={kind:`dragging`,handOrigin:X[e].pinch.origin,hasSample:!1}}function Kn(e){switch(Z[e].kind){case`dragging`:jt(),pe(An);break;case`two-hand-scale`:case`idle`:break}Z[e]={kind:`idle`};let t=X[e];t.pinch.active||(t.source=null,t.gazeRay=null,t.currentRay=null)}function qn(e){if(Z.left.kind===`two-hand-scale`&&Z.right.kind===`two-hand-scale`){let e=L(X.left.pinch.current,X.right.pinch.current),t=Math.sqrt(R(e,e));if(On.startDistance>=.01){let e=t/On.startDistance;En.z=Math.max(-200,Math.min(-1,On.startOffset.z/e)),Vn()}return}let t=!1;for(let e of[`left`,`right`]){let n=Z[e],r=X[e];if(n.kind!==`dragging`||!r.source)continue;let i=r.currentRay;if(!i)continue;t=!0;let a=j.mode===`fluid`?kt(i.origin,i.dir,0):At(i.origin,i.dir);if(!a){jt(),n.hasSample=!1;continue}if(j.mouse.down=!0,j.mouse.worldX=a[0],j.mouse.worldY=a[1],j.mouse.worldZ=a[2],j.mode===`fluid`){let e=Ot(a);if(!e){jt(),n.hasSample=!1;continue}j.mouse.dx=n.hasSample?(e[0]-j.mouse.x)*10:0,j.mouse.dy=n.hasSample?(e[1]-j.mouse.y)*10:0,j.mouse.x=e[0],j.mouse.y=e[1]}else j.mouse.dx=0,j.mouse.dy=0,j.mouse.x=a[0],j.mouse.y=a[1];j.mode===`physics`&&(j.pointerToAttractor.has(An)?fe(An,a):M(An,a)),n.hasSample=!0}t||j.xrEnabled&&j.mouse.down&&jt()}function Jn(e){Hn(e),Wn(Un(),e),qn(e)}function Yn(e){let t=Fn(e);if(t){let e=X[t];e.pinch.active=!1,e.tracked=!1}let n=wn.indexOf(e);n>=0&&wn.splice(n,1)}function Xn(){wn.length=0,X.left=Cn(`left`),X.right=Cn(`right`),Z.left={kind:`idle`},Z.right={kind:`idle`},kn.left=!1,kn.right=!1,Tn.gainMultiplier=1,jt(),pe(An)}function Zn(){let e=document.getElementById(`btn-xr`);if(!navigator.xr){e.textContent=`VR Not Available`;return}navigator.xr.isSessionSupported(`immersive-vr`).then(t=>{t?(e.disabled=!1,e.addEventListener(`click`,Qn)):e.textContent=`VR Not Supported`}).catch(()=>{e.textContent=`VR Check Failed`})}async function Qn(){if(J){d(`xr`,`exiting session (user clicked Exit VR)`),c=`xr:session.end`,J.end();return}let e=document.getElementById(`btn-xr`);e.textContent=`Starting...`,d(`xr`,`toggleXR start`,{hasWebXR:!!navigator.xr,userAgent:navigator.userAgent});try{c=`xr:requestSession`,J=await navigator.xr.requestSession(`immersive-vr`,{requiredFeatures:[`webgpu`],optionalFeatures:[`layers`,`local-floor`,`hand-tracking`]});let t=J.enabledFeatures;xn=!!t&&t.includes(`hand-tracking`),d(`xr`,`session acquired`,{environmentBlendMode:J.environmentBlendMode,interactionMode:J.interactionMode,visibilityState:J.visibilityState,handTracking:xn,enabledFeatures:t});let n=!1;try{c=`xr:requestReferenceSpace(local-floor)`,vn=await J.requestReferenceSpace(`local-floor`),n=!0,d(`xr`,`reference space = local-floor`)}catch(e){d(`xr`,`local-floor unavailable, falling back to local`,e.message),c=`xr:requestReferenceSpace(local)`,vn=await J.requestReferenceSpace(`local`)}yn=vn,Dn=n?1.6:0,En.x=0,En.y=0,En.z=-5,Vn(),c=`xr:new XRGPUBinding`,bn=new XRGPUBinding(J,V);let r=bn.getPreferredColorFormat(),i=bn.nativeProjectionScaleFactor;d(`xr`,`binding ready`,{preferredFormat:r,nativeProjectionScaleFactor:i}),Fe(r,1);let a=[{colorFormat:r,depthStencilFormat:`depth24plus`,scaleFactor:i,textureType:`texture-array`},{colorFormat:r,depthStencilFormat:`depth24plus`,textureType:`texture-array`},{colorFormat:r,scaleFactor:i,textureType:`texture-array`},{colorFormat:r,textureType:`texture-array`},{colorFormat:r,scaleFactor:i},{colorFormat:r}];c=`xr:createProjectionLayer`;let o=null,s=[];for(let e of a)try{Y=bn.createProjectionLayer(e),o=e;break}catch(t){let n=t.message;s.push({config:e,error:n}),d(`xr`,`projection layer config rejected`,{config:e,error:n}),Y=null}if(!Y)throw Error(`All projection layer configurations failed. Attempts: ${JSON.stringify(s)}`);d(`xr`,`projection layer created`,{config:o,textureWidth:Y.textureWidth,textureHeight:Y.textureHeight,textureArrayLength:Y.textureArrayLength,ignoreDepthValues:Y.ignoreDepthValues});try{Y.fixedFoveation=0,d(`xr`,`fixedFoveation set to 0`)}catch(e){d(`xr`,`fixedFoveation unsupported on this platform`,e.message)}c=`xr:updateRenderState`;try{J.updateRenderState({layers:[Y]}),d(`xr`,`render state updated with projection layer`)}catch(e){throw u(`xr:updateRenderState`,e),e}J.addEventListener(`selectstart`,e=>{wn.push(e.inputSource)}),J.addEventListener(`selectend`,e=>{Yn(e.inputSource)}),e.textContent=`Exit VR`,j.xrEnabled=!0,c=`xr:awaiting first frame`,J.addEventListener(`visibilitychange`,()=>{d(`xr`,`visibilitychange`,{visibilityState:J?.visibilityState})}),J.requestAnimationFrame(er),d(`xr`,`first frame requested; waiting for xrFrame callback`),J.addEventListener(`end`,()=>{d(`xr`,`session ended`,{finalPhase:c,framesRendered:Q}),J=null,vn=null,yn=null,bn=null,Y=null,xn=!1,j.xrEnabled=!1,Q=0,c=`desktop`,Fe(U,1),Xn(),e.textContent=`Enter VR`,requestAnimationFrame(Cr)})}catch(t){if(u(`xr:toggle`,t,`session failed to start (phase=${c})`),e.textContent=`XR Error: ${t.message}`,J)try{J.end()}catch(e){u(`xr:cleanup-end`,e)}J=null,c=`desktop`,setTimeout(()=>{e.textContent=`Enter VR`},4e3)}}var Q=0,$n=3;function er(e,t){if(!J)return;J.requestAnimationFrame(er),O(e);let n=Q<$n;n&&d(`xr:frame`,`xrFrame #${Q} entered`,{mode:j.mode}),de(oe()),tr++,e-nr>=1e3&&(rr=tr,tr=0,nr=e),c=`xr:frame:${Q}:pre-encode`,V.pushErrorScope(`validation`);try{let e=t.getViewerPose(vn);if(!e){n&&d(`xr:frame`,`no viewer pose yet`);return}let r=G[j.mode];if(!r){u(`xr:frame`,Error(`simulation for mode=${j.mode} is not initialized`));return}Jn(t),c=`xr:frame:${Q}:createCommandEncoder`;let i=V.createCommandEncoder({label:`xr-frame-${Q}`});j.paused||(c=`xr:frame:${Q}:sim.compute(${j.mode})`,r.compute(i)),n&&d(`xr:frame`,`pose has ${e.views.length} views`);for(let t=0;t<e.views.length;t++){let a=e.views[t];c=`xr:frame:${Q}:getViewSubImage(eye=${t})`;let o=bn,s=o.getViewSubImage?o.getViewSubImage(Y,a):o.getSubImage(Y,a);if(!s){u(`xr:frame`,Error(`subImage null for eye ${t}`));continue}n&&t===0&&d(`xr:frame`,`subImage`,{viewport:s.viewport,colorFormat:s.colorTexture.format,hasDepth:!!s.depthStencilTexture}),c=`xr:frame:${Q}:createView(color,eye=${t})`;let l=s.getViewDescriptor?s.getViewDescriptor():{},f=s.colorTexture.createView(l);c=`xr:frame:${Q}:createView(depth,eye=${t})`;let p=(Y.textureArrayLength??1)>1,m=s.depthStencilTexture;xe=m&&p?m.createView(l):null;let h=a.transform.position;z={viewMatrix:new Float32Array(a.transform.inverse.matrix),projMatrix:new Float32Array(a.projectionMatrix),eye:[h.x,h.y,h.z]};let{x:g,y:_,width:v,height:y}=s.viewport;c=`xr:frame:${Q}:ensureHdrTargets(${v}x${y})`,Ee(v,y),B.needsClear=!0;let b=B.sceneIdx;c=`xr:frame:${Q}:sim.render(${j.mode},eye=${t})`,r.render(i,B.scene[b].createView(),null,t),c=`xr:frame:${Q}:bloom(eye=${t})`,xr(i),c=`xr:frame:${Q}:composite(eye=${t})`;let x=s.colorTexture.format;Sr(i,f,x,[g,_,v,y])}c=`xr:frame:${Q}:submit`,V.queue.submit([i.finish()]),n&&d(`xr:frame`,`frame #${Q} submitted OK`)}catch(e){u(`xr:frame`,e,`frame #${Q} threw synchronously`)}finally{z=null,xe=null,V.popErrorScope().then(e=>{e&&u(`xr:frame:validation`,e,`frame #${Q}`)}).catch(e=>u(`xr:frame:popScope`,e)),Q++}}var tr=0,nr=0,rr=0,ir=-1,ar=0,or={compute:0,render:0,post:0},sr=!1,cr=0,lr=2e3,ur=6,$=null;function dr(){V.features.has(`timestamp-query`)&&($={querySet:V.createQuerySet({type:`timestamp`,count:ur}),resolveBuf:V.createBuffer({size:ur*8,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),stagingBuf:V.createBuffer({size:ur*8,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),pending:!1})}function fr(e){if($)return{querySet:$.querySet,beginningOfPassWriteIndex:e*2,endOfPassWriteIndex:e*2+1}}function pr(e,t){if(!$||$.pending||t-cr<lr)return;cr=t,e.resolveQuerySet($.querySet,0,ur,$.resolveBuf,0),e.copyBufferToBuffer($.resolveBuf,0,$.stagingBuf,0,ur*8),$.pending=!0;let n=$;V.queue.onSubmittedWorkDone().then(()=>{n.stagingBuf.mapAsync(GPUMapMode.READ).then(()=>{let e=new BigUint64Array(n.stagingBuf.getMappedRange().slice(0));n.stagingBuf.unmap(),n.pending=!1;let t=(e,t)=>Number(t-e)/1e6;or={compute:t(e[0],e[1]),render:t(e[2],e[3]),post:t(e[4],e[5])},ar=t(e[0],e[5])}).catch(()=>{n.pending=!1})})}function mr(e){if($||sr||e-cr<lr)return;cr=e,sr=!0;let t=performance.now();V.queue.onSubmittedWorkDone().then(()=>{ar=performance.now()-t,sr=!1}).catch(()=>{sr=!1})}function hr(e,t){console.error(`[sim:${e}]`,t);let n=document.getElementById(`gpu-error-overlay`);n||(n=document.createElement(`div`),n.id=`gpu-error-overlay`,n.style.cssText=`position:fixed;top:60px;left:10px;right:10px;max-height:60vh;overflow:auto;background:rgba(20,0,0,0.92);color:#ff8080;font:11px monospace;padding:10px;border:1px solid #ff4040;border-radius:4px;z-index:9999;white-space:pre-wrap;`,document.body.appendChild(n));let r=new Date().toLocaleTimeString();n.textContent=`[${r}] [sim:${e}] ${t}\n\n`+n.textContent}function gr(){let e=j.mode;if(G[e])return;let t={boids:Ue,physics:We,physics_classic:Ge,fluid:Ke,parametric:qe,reaction:Je};V.pushErrorScope(`validation`),V.pushErrorScope(`internal`),V.pushErrorScope(`out-of-memory`);let n=null;try{n=t[e]()}catch(t){hr(e,`factory threw: ${t.message}`)}let r=n,i=e,a=e=>{if(hr(i,e),r&&G[i]===r){try{r.destroy()}catch{}delete G[i]}};V.popErrorScope().then(e=>{e&&a(`OOM: ${e.message}`)}),V.popErrorScope().then(e=>{e&&a(`internal: ${e.message}`)}),V.popErrorScope().then(e=>{e&&a(`validation: ${e.message}`)}),n&&(G[e]=n)}function _r(){let e=j.mode;G[e]&&(G[e].destroy(),delete G[e]),gr()}function vr(){let e=rr>0?(1e3/rr).toFixed(1):`--`,t=or,n=t.compute>0?` (C:${t.compute.toFixed(1)} R:${t.render.toFixed(1)} P:${t.post.toFixed(1)})`:ar>0?` gpu:${ar.toFixed(1)}ms`:``;document.getElementById(`stat-fps`).textContent=`${rr} fps ${e}ms${n}`;let r=G[j.mode],i=r?r.getCount():`--`;document.getElementById(`stat-count`).textContent=j.mode===`fluid`||j.mode===`reaction`?`Grid: ${i}`:`Particles: ${i}`;let a=document.getElementById(`stat-step`);if(a)if(j.mode===`physics`&&r&&`getSimStep`in r){let e=r.getSimStep(),t=r.getTimeDirection();a.style.display=``,a.textContent=`Step: ${e} ${t<0?`◀`:`▶`}`}else a.style.display=`none`}function yr(){let e=document.getElementById(`canvas-container`),t=window.devicePixelRatio||1,n=Math.floor(e.clientWidth*t),r=Math.floor(e.clientHeight*t);(H.width!==n||H.height!==r)&&(H.width=n,H.height=r),Ee(H.width,H.height)}function br(e,t,n){if(B.needsClear)return;let r=j.fx.trailPersistence;if(r<.001)return;B.fadeParams[0]=r,V.queue.writeBuffer(B.fadeUBO,0,B.fadeParams);let i=e.beginRenderPass({colorAttachments:[{view:B.sceneViews[n],clearValue:y,loadOp:`clear`,storeOp:`store`}]});i.setPipeline(B.fadePipeline),i.setBindGroup(0,B.fadeBGs[t]),i.draw(3),i.end()}function xr(e){let t=j.fx,n=B.sceneIdx;for(let r=0;r<Ce;r++){let i=r===0?B.scene[n]:B.bloomMips[r-1],a=B.downsampleParams[r];a[0]=1/i.width,a[1]=1/i.height,a[2]=t.bloomThreshold,a[3]=r===0?1:0,V.queue.writeBuffer(B.downsampleUBO[r],0,a);let o=B.downsampleBGs[r===0?n:r+1],s=e.beginRenderPass({colorAttachments:[{view:B.bloomMipViews[r],clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}]});s.setPipeline(B.downsamplePipeline),s.setBindGroup(0,o),s.draw(3),s.end()}for(let n=Ce-1;n>0;n--){let r=B.bloomMips[n],i=B.upsampleParams[n];i[0]=1/r.width,i[1]=1/r.height,i[2]=t.bloomRadius,V.queue.writeBuffer(B.upsampleUBO[n],0,i);let a=e.beginRenderPass({colorAttachments:[{view:B.bloomMipViews[n-1],clearValue:{r:0,g:0,b:0,a:1},loadOp:`load`,storeOp:`store`}]});a.setPipeline(B.upsamplePipelineAdditive),a.setBindGroup(0,B.upsampleBGs[n]),a.draw(3),a.end()}}function Sr(e,t,n,r=null){let i=j.fx,a=D(),o=B.compositeParams,s=new Uint32Array(o.buffer);o[0]=i.bloomIntensity,o[1]=i.exposure,o[2]=i.vignette,o[3]=i.chromaticAberration,o[4]=i.grading;let c=r?r[2]/r[3]:H.width/H.height,l=j.camera.fov*Math.PI/180,u=be(),d=z?z.viewMatrix:u.view,f=z?z.projMatrix:P.perspective(l,c,.01,_e),p=performance.now()*.001,m=Math.max(0,oe()-(se()>0?1:0)),h=j.physics.interactionStrength??1,g=j.attractors,_=Math.min(g.length,ie);s[5]=_,o[6]=0,o[7]=0,o[8]=a.primary[0],o[9]=a.primary[1],o[10]=a.primary[2],o[12]=a.accent[0],o[13]=a.accent[1],o[14]=a.accent[2],o[16]=p;for(let e=0;e<_;e++){let t=g[e],n=t.x,r=t.y,i=t.z,a=d[0]*n+d[4]*r+d[8]*i+d[12],s=d[1]*n+d[5]*r+d[9]*i+d[13],c=d[2]*n+d[6]*r+d[10]*i+d[14],l=d[3]*n+d[7]*r+d[11]*i+d[15],u=f[0]*a+f[4]*s+f[8]*c+f[12]*l,p=f[1]*a+f[5]*s+f[9]*c+f[13]*l,_=f[3]*a+f[7]*s+f[11]*c+f[15]*l,v=_===0?0:u/_,y=_===0?0:p/_,b=20+e*4;o[b]=v*.5+.5,o[b+1]=1-(y*.5+.5),o[b+2]=le(t,m,h),o[b+3]=0}for(let e=_;e<ie;e++){let t=20+e*4;o[t]=0,o[t+1]=0,o[t+2]=0,o[t+3]=0}V.queue.writeBuffer(B.compositeUBO,0,o);let v=Te(n),y=B.compositeBGs[B.sceneIdx],b=fr(2),x=e.beginRenderPass({colorAttachments:[{view:t,clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}],...b?{timestampWrites:b}:{}});x.setPipeline(v),x.setBindGroup(0,y),r&&x.setViewport(r[0],r[1],r[2],r[3],0,1),x.draw(3),x.end()}function Cr(e){if(j.xrEnabled)return;requestAnimationFrame(Cr),ir>=0&&gt(e-ir),ir=e,O(e),yr(),de(oe()),tr++,e-nr>=1e3&&(rr=tr,tr=0,nr=e,vr());let t=G[j.mode];if(!t)return;let n=j.mode;try{let n=V.createCommandEncoder();vt(t,n),xt();let r=B.sceneIdx,i=1-r;B.sceneIdx=i,br(n,r,i),t.render(n,B.sceneViews[i],null),xr(n),Sr(n,Me.getCurrentTexture().createView(),U),pr(n,e),V.queue.submit([n.finish()]),mr(e),B.needsClear=!1}catch(e){if(hr(n,`frame threw: ${e.message}`),G[n]===t){try{t.destroy()}catch{}delete G[n]}}}var wr=`shader-playground-state`;function Tr(){try{let e={};for(let t of Object.keys(p))e[t]=A(t);let t={mode:j.mode,colorTheme:j.colorTheme,camera:j.camera,fx:j.fx,...e};localStorage.setItem(wr,JSON.stringify(t))}catch{}}function Er(){try{let e=localStorage.getItem(wr);if(!e)return;let t=JSON.parse(e);t.mode&&t.mode in p&&(j.mode=t.mode),t.colorTheme&&g[t.colorTheme]&&(j.colorTheme=t.colorTheme);for(let e of Object.keys(p))t[e]&&Object.assign(A(e),t[e]);t.camera&&Object.assign(j.camera,t.camera),t.fx&&Object.assign(j.fx,t.fx),k(j.colorTheme)}catch{}}function Dr(){document.querySelectorAll(`.mode-tab`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===j.mode)),document.querySelectorAll(`.param-group`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===j.mode)),document.querySelectorAll(`.debug-panel`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===j.mode));for(let e of Object.keys(h)){let t=e,n=document.getElementById(`params-${t}`),r=A(t);n.querySelectorAll(`input[type="range"]`).forEach(e=>{let n=e.dataset.key;if(n&&n in r){e.value=String(r[n]);let i=e.parentElement?.querySelector(`.control-value`);if(i){let e=rt(t,n);i.textContent=tt(Number(r[n]),e?e.step??.01:.01)}}}),n.querySelectorAll(`select`).forEach(e=>{let t=e.dataset.key;t&&t in r&&(e.value=String(r[t]))})}document.querySelectorAll(`#theme-presets .preset-btn`).forEach(e=>e.classList.toggle(`active`,e.dataset.theme===j.colorTheme)),et()}async function Or(){await W()&&(Pt=Nt.matches,document.body.classList.toggle(`mobile`,Pt),Nt.addEventListener(`change`,e=>{let t=e.matches;t!==Pt&&(Pt=t,document.body.classList.toggle(`mobile`,Pt),window.location.reload())}),Ve(),Er(),Pt&&Rt(),k(j.colorTheme),Ze(),St(),ot(),ct(),Pt?(Ft(),It(),Lt()):Mt(),qt(),lt(),bt(),Dr(),yr(),gr(),Ht(),new ResizeObserver(()=>yr()).observe(document.getElementById(`canvas-container`)),requestAnimationFrame(Cr),window.__simDiagnose=()=>{let e=G[j.mode];return e?.diagnose?e.diagnose():Promise.resolve({error:1,msg:`no diagnose on this sim`})},window.__simPreset=e=>{let t=document.querySelectorAll(`button`);for(let n of t)if(n.textContent?.trim()===e)return n.click(),`ok`;return`preset not found`},window.__simState=()=>({mode:j.mode,...j[j.mode],fps:rr,gpuMs:ar,gpuDetail:or}),window.__simStats=()=>{let e=G[j.mode];return{...e?.getStats?e.getStats():{error:`no stats on this sim`},gpuMs:ar,gpuDetail:or}})}Or();