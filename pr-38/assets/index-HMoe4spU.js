...
`,D=`// [LAW:one-source-of-truth] CoD-Advanced-Warfare 13-tap downsample. The first level applies a soft bright-pass.
...
`,O=`// [LAW:dataflow-not-control-flow] Trail decay always runs in the same shape — only the persistence value varies.
...
`,k=`// 9-tap tent filter upsample. Reads from a smaller mip; output is additively blended into a larger one.
...
`,A=`rgba16float`,j=3;function ee(e){let t={scene:[],sceneIdx:0,depth:null,nullColor:null,nullDepth:null,nullColorView:null,nullDepthView:null,bloomMips:[],width:0,height:0,needsClear:!0,linSampler:null,fadePipeline:null,downsamplePipeline:null,upsamplePipelineAdditive:null,upsamplePipelineReplace:null,compositePipelines:new Map,fadeBGL:null,downsampleBGL:null,upsampleBGL:null,compositeBGL:null,fadeUBO:null,downsampleUBO:[],upsampleUBO:[],compositeUBO:null,sceneViews:[],bloomMipViews:[],fadeBGs:[],downsampleBGs:[],upsampleBGs:[],fadeParams:new Float32Array(4),downsampleParams:[],upsampleParams:[],compositeParams:new Float32Array(16),compositeBGs:[]};function n(n){let r=t.compositePipelines.get(n);if(r)return r;let i=e.createShaderModuleChecked(`post.composite`,E);return r=e.device.createRenderPipeline({layout:e.device.createPipelineLayout({bindGroupLayouts:[t.compositeBGL]}),vertex:{module:i,entryPoint:`vs_main`},fragment:{module:i,entryPoint:`fs_main`,targets:[{format:n}]},primitive:{topology:`triangle-list`}}),t.compositePipelines.set(n,r),r}return{init(){t.nullColor=e.device.createTexture({size:[1,1],format:A,usage:GPUTextureUsage.RENDER_ATTACHMENT}),t.nullDepth=e.device.createTexture({size:[1,1],format:`depth24plus`,usage:GPUTextureUsage.RENDER_ATTACHMENT}),t.nullColorView=t.nullColor.createView(),t.nullDepthView=t.nullDepth.createView(),t.linSampler=e.device.createSampler({magFilter:`linear`,minFilter:`linear`,addressModeU:`clamp-to-edge`,addressModeV:`clamp-to-edge`}),t.fadeBGL=e.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:`filtering`}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]}),t.downsampleBGL=e.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:`filtering`}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]}),t.upsampleBGL=e.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:`filtering`}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]}),t.compositeBGL=e.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`}},{binding:2,visibility:GPUShaderStage.FRAGMENT,sampler:{type:`filtering`}},{binding:3,visibility:GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]});let n=e.createShaderModuleChecked(`post.fade`,O),r=e.createShaderModuleChecked(`post.downsample`,D),i=e.createShaderModuleChecked(`post.upsample`,k);t.fadePipeline=e.device.createRenderPipeline({layout:e.device.createPipelineLayout({bindGroupLayouts:[t.fadeBGL]}),vertex:{module:n,entryPoint:`vs_main`},fragment:{module:n,entryPoint:`fs_main`,targets:[{format:A}]},primitive:{topology:`triangle-list`}}),t.downsamplePipeline=e.device.createRenderPipeline({layout:e.device.createPipelineLayout({bindGroupLayouts:[t.downsampleBGL]}),vertex:{module:r,entryPoint:`vs_main`},fragment:{module:r,entryPoint:`fs_main`,targets:[{format:A}]},primitive:{topology:`triangle-list`}}),t.upsamplePipelineAdditive=e.device.createRenderPipeline({layout:e.device.createPipelineLayout({bindGroupLayouts:[t.upsampleBGL]}),vertex:{module:i,entryPoint:`vs_main`},fragment:{module:i,entryPoint:`fs_main`,targets:[{format:A,blend:{color:{srcFactor:`one`,dstFactor:`one`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one`,operation:`add`}}}]},primitive:{topology:`triangle-list`}}),t.upsamplePipelineReplace=e.device.createRenderPipeline({layout:e.device.createPipelineLayout({bindGroupLayouts:[t.upsampleBGL]}),vertex:{module:i,entryPoint:`vs_main`},fragment:{module:i,entryPoint:`fs_main`,targets:[{format:A}]},primitive:{topology:`triangle-list`}}),t.fadeUBO=e.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),t.downsampleUBO=[],t.upsampleUBO=[];for(let n=0;n<j;n++)t.downsampleUBO.push(e.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})),t.upsampleUBO.push(e.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}));t.compositeUBO=e.device.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),t.fadeParams=new Float32Array(4),t.compositeParams=new Float32Array(16),t.downsampleParams=[],t.upsampleParams=[];for(let e=0;e<j;e++)t.downsampleParams.push(new Float32Array(4)),t.upsampleParams.push(new Float32Array(4))},ensureHdrTargets(n,r){if(t.width===n&&t.height===r&&t.scene.length===2)return;for(let e of t.scene)e.destroy();for(let e of t.bloomMips)e.destroy();t.depth?.destroy(),t.scene=[],t.bloomMips=[],t.width=n,t.height=r;for(let i=0;i<2;i++)t.scene.push(e.device.createTexture({size:[n,r],format:A,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}));t.depth=e.device.createTexture({size:[n,r],format:`depth24plus`,usage:GPUTextureUsage.RENDER_ATTACHMENT});let i=Math.max(1,Math.floor(n/2)),a=Math.max(1,Math.floor(r/2));for(let n=0;n<j;n++)t.bloomMips.push(e.device.createTexture({size:[i,a],format:A,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING})),i=Math.max(1,Math.floor(i/2)),a=Math.max(1,Math.floor(a/2));t.needsClear=!0,t.sceneViews=t.scene.map(e=>e.createView()),t.bloomMipViews=t.bloomMips.map(e=>e.createView()),t.fadeBGs=t.sceneViews.map(n=>e.device.createBindGroup({layout:t.fadeBGL,entries:[{binding:0,resource:n},{binding:1,resource:t.linSampler},{binding:2,resource:{buffer:t.fadeUBO}}]})),t.downsampleBGs=[];for(let n=0;n<2;n++)t.downsampleBGs.push(e.device.createBindGroup({layout:t.downsampleBGL,entries:[{binding:0,resource:t.sceneViews[n]},{binding:1,resource:t.linSampler},{binding:2,resource:{buffer:t.downsampleUBO[0]}}]}));for(let n=1;n<j;n++)t.downsampleBGs.push(e.device.createBindGroup({layout:t.downsampleBGL,entries:[{binding:0,resource:t.bloomMipViews[n-1]},{binding:1,resource:t.linSampler},{binding:2,resource:{buffer:t.downsampleUBO[n]}}]}));t.upsampleBGs=t.bloomMipViews.map((n,r)=>e.device.createBindGroup({layout:t.upsampleBGL,entries:[{binding:0,resource:n},{binding:1,resource:t.linSampler},{binding:2,resource:{buffer:t.upsampleUBO[r]}}]})),t.compositeBGs=t.sceneViews.map(n=>e.device.createBindGroup({layout:t.compositeBGL,entries:[{binding:0,resource:n},{binding:1,resource:t.bloomMipViews[0]},{binding:2,resource:t.linSampler},{binding:3,resource:{buffer:t.compositeUBO}}]}))},markNeedsClear(){t.needsClear=!0},getSceneIndex(){return t.sceneIdx},setSceneIndex(e){t.sceneIdx=e},getSceneView(e){return t.sceneViews[e]},getSceneFormat(e){return t.scene[e].format},getCurrentSceneView(){return t.scene[t.sceneIdx].createView()},getColorAttachment(e,n,r,i,a){let o=i>.001&&!t.needsClear;return{view:this.getCurrentSceneView(),clearValue:a,loadOp:o?`load`:`clear`,storeOp:`store`}},getDepthAttachment(e,n,r){return{view:r??t.depth.createView(),depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}},getDepthView(){return t.depth.createView()},getNullColorView(){return t.nullColorView},getNullDepthView(){return t.nullDepthView},runFadePass(n,r,i,a,o){if(t.needsClear||a<.001)return;t.fadeParams[0]=a,e.device.queue.writeBuffer(t.fadeUBO,0,t.fadeParams);let s=n.beginRenderPass({colorAttachments:[{view:t.sceneViews[i],clearValue:o,loadOp:`clear`,storeOp:`store`}]});s.setPipeline(t.fadePipeline),s.setBindGroup(0,t.fadeBGs[r]),s.draw(3),s.end()},runBloomChain(n,r,i){let a=t.sceneIdx;for(let o=0;o<j;o++){let s=o===0?t.scene[a]:t.bloomMips[o-1],c=t.downsampleParams[o];c[0]=1/s.width,c[1]=1/s.height,c[2]=r.bloomThreshold,c[3]=o===0?1:0,e.device.queue.writeBuffer(t.downsampleUBO[o],0,c);let l=t.downsampleBGs[o===0?a:o+1],u=n.beginRenderPass({colorAttachments:[{view:t.bloomMipViews[o],clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}],...i&&o===0?{timestampWrites:i}:{}});u.setPipeline(t.downsamplePipeline),u.setBindGroup(0,l),u.draw(3),u.end()}for(let i=j-1;i>0;i--){let a=t.bloomMips[i],o=t.upsampleParams[i];o[0]=1/a.width,o[1]=1/a.height,o[2]=r.bloomRadius,e.device.queue.writeBuffer(t.upsampleUBO[i],0,o);let s=n.beginRenderPass({colorAttachments:[{view:t.bloomMipViews[i-1],clearValue:{r:0,g:0,b:0,a:1},loadOp:`load`,storeOp:`store`}]});s.setPipeline(t.upsamplePipelineAdditive),s.setBindGroup(0,t.upsampleBGs[i]),s.draw(3),s.end()}},runComposite(r,i,a,o,s,c,l){let u=t.compositeParams;u[0]=s.bloomIntensity,u[1]=s.exposure,u[2]=s.vignette,u[3]=s.chromaticAberration,u[4]=s.grading,u[8]=c.primary[0],u[9]=c.primary[1],u[10]=c.primary[2],u[12]=c.accent[0],u[13]=c.accent[1],u[14]=c.accent[2],e.device.queue.writeBuffer(t.compositeUBO,0,u);let d=n(a),f=t.compositeBGs[t.sceneIdx],p=r.beginRenderPass({colorAttachments:[{view:i,clearValue:{r:0,g:0,b:0,a:1},loadOp:`clear`,storeOp:`store`}],...l?{timestampWrites:l}:{}});o&&p.setViewport(o[0],o[1],o[2],o[3],0,1),p.setPipeline(d),p.setBindGroup(0,f),p.draw(3),p.end(),t.needsClear=!1}}}var te=`rgba16float`,M=1;function N(e){let t=document.getElementById(`fallback`);t.querySelector(`p`).textContent=e,t.classList.add(`visible`)}async function ne(e){if(!navigator.gpu)return N(`navigator.gpu not found. This browser may not support WebGPU, or it may need to be enabled in settings.`),null;let t;try{t=await navigator.gpu.requestAdapter({powerPreference:`high-performance`,xrCompatible:!0})}catch(e){return N(`requestAdapter() failed: ${e.message}`),null}if(!t)return N(`requestAdapter() returned null. WebGPU may be available but no suitable GPU adapter was found.`),null;let n;try{let e=t.features.has(`timestamp-query`)?[`timestamp-query`]:[];n=await t.requestDevice({requiredFeatures:e})}catch(e){return N(`requestDevice() failed: ${e.message}`),null}let r=h();r.init(n),n.lost.then(t=>{e.logError(`webgpu:device-lost`,Error(t.message),`reason=${t.reason}`),t.reason!==`destroyed`&&e.restoreAfterDeviceLoss().catch(t=>e.logError(`webgpu:device-restore`,t))}),n.onuncapturederror=t=>{e.logError(`webgpu:uncaptured`,t.error)};let i=document.getElementById(`gpu-canvas`),a=i.getContext(`webgpu`),o=navigator.gpu.getPreferredCanvasFormat();a.configure({device:n,format:o,alphaMode:`opaque`});let s=S(e.state.camera),c=ee({createShaderModuleChecked:(t,r)=>e.createShaderModuleChecked(n,t,r),device:n,renderSampleCount:M});c.init();let l={cameraSystem:s,canvas:i,canvasFormat:o,context:a,device:n,postFx:c,renderSampleCount:M,renderTargetFormat:te,timing:r},u=T({currentSimStep:e.currentSimStep,currentTimeDirection:e.currentTimeDirection,dropSimulationIfCurrent:e.dropSimulationIfCurrent,getCanvas:()=>l.canvas,getCanvasContainer:e.getCanvasContainer,getCanvasFormat:()=>l.canvasFormat,getContext:()=>l.context,getCurrentSimulation:e.getCurrentSimulation,getDefaultClearColor:e.getDefaultClearColor,getDevice:()=>l.device,getPostFx:()=>l.postFx,getThemeColors:e.getThemeColors,gpuTiming:l.timing,pruneAttractors:e.pruneAttractors,refreshThemeColors:e.refreshThemeColors,runDebugCompute:e.runDebugCompute,showSimError:e.showSimError,state:e.state,tickMarkers:e.tickMarkers,updateAdaptiveChunk:e.updateAdaptiveChunk,updateDebugPanel:e.updateDebugPanel});return{...l,frameRuntime:u}}function re(e){return{mode:`physics`,colorTheme:`Dracula`,xrEnabled:!1,paused:!1,boids:{...e.boids},physics:{...e.physics},physics_classic:{...e.physics_classic},fluid:{...e.fluid},parametric:{...e.parametric},reaction:{...e.reaction},camera:{distance:5,fov:60,rotX:.3,rotY:0,panX:0,panY:0},mouse:{down:!1,x:0,y:0,dx:0,dy:0,worldX:0,worldY:0,worldZ:0},attractors:[],markers:[],pointerToAttractor:new Map,fx:{bloomIntensity:.7,bloomThreshold:4,bloomRadius:1,trailPersistence:0,exposure:1,vignette:.35,chromaticAberration:.25,grading:.5,timeScale:1},debug:{xrLog:!1}}}var P=1e3;function F(e){let{config:t,state:n}=e;function r(e){let r=t.shapeParams[e]??{},i=n.parametric;r.p1?(i.p1Min=r.p1.animMin,i.p1Max=r.p1.animMax,i.p1Rate=r.p1.animRate):(i.p1Min=0,i.p1Max=0,i.p1Rate=0),r.p2?(i.p2Min=r.p2.animMin,i.p2Max=r.p2.animMax,i.p2Rate=r.p2.animRate):(i.p2Min=0,i.p2Max=0,i.p2Rate=0)}function i(e,n){for(let r of t.paramDefs[e])for(let e of r.params)if(e.key===n)return e;return null}function a(e,t){if(t>=1)return String(Math.round(e));let n=Math.max(0,-Math.floor(Math.log10(t)));return e.toFixed(n)}function o(e,t){let n=t?.step??.01;return t?.maxLabel!==void 0&&t.max!==void 0&&e>=t.max-n/2?t.maxLabel:a(e,n)}function s(e,t,n){let r=(Math.log(e)-Math.log(t))/(Math.log(n)-Math.log(t));return Math.round(P*Math.max(0,Math.min(1,r)))}function c(e,t,n){let r=e/P;return Math.exp(Math.log(t)+r*(Math.log(n)-Math.log(t)))}function l(r){let i=document.createElement(`div`);i.className=`param-section`;let o=document.createElement(`div`);o.className=`param-section-title`,o.textContent=`Visual FX`,i.appendChild(o);for(let r of t.fxParamDefs){let t=document.createElement(`div`);t.className=`control-row`;let o=document.createElement(`span`);o.className=`control-label`,o.textContent=r.label,t.appendChild(o);let s=document.createElement(`input`);s.type=`range`,s.min=String(r.min),s.max=String(r.max),s.step=String(r.step),s.value=String(n.fx[r.key]);let c=document.createElement(`span`);c.className=`control-value`,c.textContent=a(n.fx[r.key],r.step),s.addEventListener(`input`,()=>{let t=Number(s.value);n.fx[r.key]=t,c.textContent=a(t,r.step),e.actions.saveState()}),s.addEventListener(`change`,()=>e.actions.flushSaveState()),t.appendChild(s),t.appendChild(c),i.appendChild(t)}r.appendChild(i)}function u(t,n,i){let a=document.createElement(`div`);a.className=`control-row`;let l=document.createElement(`span`);if(l.className=`control-label`,l.textContent=i.label,a.appendChild(l),i.type===`dropdown`){let t=document.createElement(`select`);t.dataset.mode=n,t.dataset.key=i.key;for(let e of i.options??[]){let n=document.createElement(`option`);n.value=String(e),n.textContent=String(e),t.appendChild(n)}t.value=String(e.modeParams(n)[i.key]),t.addEventListener(`change`,()=>{let a=Number.isNaN(Number(t.value))?t.value:Number(t.value);e.modeParams(n)[i.key]=a,i.requiresReset&&e.actions.resetCurrentSimulation(),i.key===`shape`&&(r(String(a)),d()),e.actions.updateAll(),e.actions.flushSaveState()}),a.appendChild(t)}else if(i.type===`toggle`){let t=document.createElement(`input`);t.type=`checkbox`,t.checked=!!e.modeParams(n)[i.key],t.dataset.mode=n,t.dataset.key=i.key,t.addEventListener(`change`,()=>{e.modeParams(n)[i.key]=t.checked,i.requiresReset&&e.actions.resetCurrentSimulation(),e.actions.updateAll(),e.actions.flushSaveState()}),a.appendChild(t)}else{let t=document.createElement(`input`);t.type=`range`,i.logScale&&i.min!==void 0&&i.max!==void 0?(t.min=`0`,t.max=String(P),t.step=`1`,t.value=String(s(Number(e.modeParams(n)[i.key]),i.min,i.max)),t.dataset.logScale=`1`):(t.min=String(i.min),t.max=String(i.max),t.step=String(i.step),t.value=String(e.modeParams(n)[i.key])),t.dataset.mode=n,t.dataset.key=i.key;let r=document.createElement(`span`);r.className=`control-value`,r.textContent=o(Number(e.modeParams(n)[i.key]),i),t.addEventListener(`input`,()=>{let a=i.logScale&&i.min!==void 0&&i.max!==void 0?c(Number(t.value),i.min,i.max):Number(t.value);e.modeParams(n)[i.key]=a,r.textContent=o(a,i),i.requiresReset&&(t.dataset.needsReset=`1`),e.actions.updateAll()}),t.addEventListener(`change`,()=>{t.dataset.needsReset===`1`&&(t.dataset.needsReset=`0`,e.actions.resetCurrentSimulation()),e.actions.flushSaveState()}),a.appendChild(t),a.appendChild(r)}t.appendChild(a)}function d(){let e=document.getElementById(`shape-params-section`);if(!e)return;for(;e.children.length>1;)e.removeChild(e.lastChild);let r=n.parametric.shape,i=t.shapeParams[r]??{};for(let[t,n]of Object.entries(i)){let r=document.createElement(`div`);r.className=`anim-param-label`,r.textContent=n.label,e.appendChild(r),u(e,`parametric`,{key:`${t}Min`,label:`Min`,min:n.min,max:n.max,step:n.step}),u(e,`parametric`,{key:`${t}Max`,label:`Max`,min:n.min,max:n.max,step:n.step}),u(e,`parametric`,{key:`${t}Rate`,label:`Rate`,min:0,max:3,step:.05})}}function f(e){document.querySelectorAll(`.mode-tab`).forEach(t=>t.classList.toggle(`active`,t.dataset.mode===e)),document.querySelectorAll(`.param-group`).forEach(t=>t.classList.toggle(`active`,t.dataset.mode===e)),document.querySelectorAll(`.debug-panel`).forEach(t=>t.classList.toggle(`active`,t.dataset.mode===e));let n=document.getElementById(`mode-stepper-label`);n&&(n.textContent=t.modeTabLabels[e])}function p(){let e=document.getElementById(`btn-pause`);e&&(e.textContent=n.paused?`Resume`:`Pause`,e.classList.toggle(`active`,n.paused));let t=document.getElementById(`fab-pause`);t&&(t.textContent=n.paused?`▶`:`⏸`,t.classList.toggle(`active`,n.paused))}function m(t){e.actions.setPaused(t)}function h(n,r){let i=e.modeParams(n),a=t.presets[n][r];return Object.entries(a).every(([e,t])=>i[e]===t)}function g(e){let t=document.getElementById(`params-${e}`);t&&t.querySelectorAll(`.preset-btn`).forEach(t=>{let n=t.dataset.preset;t.classList.toggle(`active`,!!n&&h(e,n))})}function _(t,n){e.actions.applyPreset(t,n),e.actions.flushSaveState()}function v(){for(let[e,n]of Object.entries(t.paramDefs)){let r=e,i=document.getElementById(`params-${r}`),a=document.createElement(`div`);a.className=`presets`;for(let e of Object.keys(t.presets[r])){let t=document.createElement(`button`);t.className=`preset-btn`+(e===`Default`?` active`:``),t.textContent=e,t.dataset.preset=e,t.dataset.mode=r,t.addEventListener(`click`,()=>_(r,e)),a.appendChild(t)}i.appendChild(a);for(let e of n){let t=document.createElement(`div`);t.className=`param-section`;let n=document.createElement(`div`);if(n.className=`param-section-title`,n.textContent=e.section,t.appendChild(n),e.dynamic){t.id=e.id??``,i.appendChild(t);continue}for(let n of e.params)u(t,r,n);i.appendChild(t)}l(i)}}function y(t){e.actions.selectMode(t),f(t)}function b(){document.querySelectorAll(`.mode-tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.mode;y(t)})})}function x(){document.getElementById(`btn-pause`).addEventListener(`click`,()=>{m(!n.paused)}),document.getElementById(`btn-reset`).addEventListener(`click`,()=>{e.actions.resetCurrentSimulation()}),document.getElementById(`copy-btn`).addEventListener(`click`,()=>{let e=document.getElementById(`prompt-text`).textContent??``;navigator.clipboard.writeText(e).then(()=>{let e=document.getElementById(`copy-btn`);e.textContent=`Copied!`,setTimeout(()=>{e.textContent=`Copy`},1500)})}),document.getElementById(`btn-reset-all`).addEventListener(`click`,()=>{localStorage.removeItem(e.storageKey),location.reload()}),e.setupRecordButton();let t=document.getElementById(`toggle-xr-log`);t.addEventListener(`change`,()=>{n.debug.xrLog=t.checked,e.setXrDebugLogging(n.debug.xrLog),e.actions.flushSaveState()}),e.setupXRButton()}function S(){f(n.mode);for(let n of Object.keys(t.paramDefs)){let t=n,r=document.getElementById(`params-${t}`),a=e.modeParams(t);r.querySelectorAll(`input[type="range"]`).forEach(e=>{let n=e.dataset.key;if(n&&n in a){let r=i(t,n),c=Number(a[n]);e.value=r?.logScale&&r.min!==void 0&&r.max!==void 0?String(s(c,r.min,r.max)):String(a[n]);let l=e.parentElement?.querySelector(`.control-value`);l&&(l.textContent=o(c,r))}}),r.querySelectorAll(`select`).forEach(e=>{let t=e.dataset.key;t&&t in a&&(e.value=String(a[t]))}),r.querySelectorAll(`input[type="checkbox"]`).forEach(e=>{let t=e.dataset.key;t&&t in a&&(e.checked=!!a[t])}),g(t)}e.syncThemeButtons(n.colorTheme);let r=document.getElementById(`toggle-xr-log`);r&&(r.checked=n.debug.xrLog),e.setXrDebugLogging(n.debug.xrLog),d(),p()}return{buildControls:v,setupGlobalControls:x,setupTabs:b,syncPauseButtons:p,syncUiFromState:S}}var ie=1.3,ae=.85,oe=.1,I=16.7,se=1.3,ce=.7,le=1,ue=5e3;function de(e){let t={skipTarget:null,targetStepsPerSec:6e3,adaptiveChunk:8,breakAtStep:null,manualStepsRemaining:0,manualDirection:1,lastSkipDispatches:0,idleBaselineMs:I};function n(){return Math.max(1,Math.ceil(t.targetStepsPerSec*t.idleBaselineMs/1e3))}function r(){let e=document.getElementById(`debug-break-status`),n=document.getElementById(`debug-break-val`);!e||!n||(t.breakAtStep===null?e.style.display=`none`:(n.textContent=String(t.breakAtStep),e.style.display=``))}function i(){t.skipTarget=null,t.manualStepsRemaining=0,t.lastSkipDispatches=0}function a(){i(),t.breakAtStep=null,r()}return{cancelMovement:i,clearAll:a,updateAdaptiveChunk(e){if(t.lastSkipDispatches<=0){t.idleBaselineMs=t.idleBaselineMs*(1-oe)+e*oe;return}let r=t.idleBaselineMs*ie,i=t.idleBaselineMs*ae,a=n();e>r?t.adaptiveChunk=Math.max(le,Math.floor(t.adaptiveChunk*ce)):e<i&&t.adaptiveChunk<a&&(t.adaptiveChunk=Math.min(ue,Math.ceil(t.adaptiveChunk*se)))},runCompute(a,o){let s=e.state.mode===`physics`?e.getPhysicsSimulation():null;if(!s||a!==s){t.lastSkipDispatches=0,e.state.paused||a.compute(o);return}let c=0,l=null,u=!1;if(t.skipTarget!==null){let r=t.skipTarget-s.getSimStep();if(r===0){t.skipTarget=null,t.lastSkipDispatches=0,s.setBlurTime(0),e.state.paused=!0,e.syncPauseButtons();return}l=r>0?1:-1,c=Math.min(n(),t.adaptiveChunk,Math.abs(r)),u=!0}else t.manualStepsRemaining>0?(l=t.manualDirection,c=Math.min(t.adaptiveChunk,t.manualStepsRemaining),t.manualStepsRemaining-=c):e.state.paused||(c=1);if(c===0){s.setBlurTime(0),t.lastSkipDispatches=0;return}let d=s.getTimeDirection(),f=l!==null&&l!==d;f&&s.setTimeDirection(l);let p=l===null?d:l,m=.016*e.state.fx.timeScale;s.setBlurTime(u?c*m*p:0),t.lastSkipDispatches=u?c:0;for(let n=0;n<c;n++){s.compute(o);let n=s.getSimStep();if(t.breakAtStep!==null&&n===t.breakAtStep){t.breakAtStep=null,i(),e.state.paused=!0,e.syncPauseButtons(),r(),s.setBlurTime(0);break}if(t.skipTarget!==null&&n===t.skipTarget){t.skipTarget=null,e.state.paused=!0,e.syncPauseButtons(),s.setBlurTime(0),t.lastSkipDispatches=0;break}}f&&s.setTimeDirection(d)},setupControls(){let n=e=>document.getElementById(e),a=(n,r)=>{i(),e.state.paused=!0,e.syncPauseButtons(),t.manualStepsRemaining=n,t.manualDirection=r};n(`debug-rev60`)?.addEventListener(`click`,()=>a(60,-1)),n(`debug-rev10`)?.addEventListener(`click`,()=>a(10,-1)),n(`debug-rev1`)?.addEventListener(`click`,()=>a(1,-1)),n(`debug-fwd1`)?.addEventListener(`click`,()=>a(1,1)),n(`debug-fwd10`)?.addEventListener(`click`,()=>a(10,1)),n(`debug-fwd60`)?.addEventListener(`click`,()=>a(60,1));let o=n(`debug-skip-chunk`);if(o){let e=parseInt(o.value,10);Number.isFinite(e)&&e>0&&(t.targetStepsPerSec=e),o.addEventListener(`change`,()=>{let e=parseInt(o.value,10);Number.isFinite(e)&&e>0&&(t.targetStepsPerSec=e)})}let s=n=>{n<0||(i(),e.state.paused=!0,e.syncPauseButtons(),t.skipTarget=n)},c=n(`debug-skip-target`);n(`debug-skip-btn`)?.addEventListener(`click`,()=>{let e=parseInt(c?.value??``,10);Number.isFinite(e)&&s(e)}),c?.addEventListener(`keydown`,e=>{if(e.key!==`Enter`)return;let t=parseInt(c.value,10);Number.isFinite(t)&&s(t)});let l=n(`debug-break-step`);n(`debug-break-btn`)?.addEventListener(`click`,()=>{let e=parseInt(l?.value??``,10);Number.isFinite(e)&&e>=0&&(t.breakAtStep=e,r())}),l?.addEventListener(`keydown`,e=>{if(e.key!==`Enter`)return;let n=parseInt(l.value,10);Number.isFinite(n)&&n>=0&&(t.breakAtStep=n,r())}),n(`debug-break-clear`)?.addEventListener(`click`,()=>{t.breakAtStep=null,r()});let u=n(`debug-scrub`);u?.addEventListener(`change`,()=>{let e=parseInt(u.value,10);Number.isFinite(e)&&s(e)}),n(`debug-screenshot`)?.addEventListener(`click`,()=>{let t=e.getPhysicsSimulation(),n=t?t.getSimStep():0;e.canvas.toBlob(e=>{if(!e)return;let t=URL.createObjectURL(e),r=document.createElement(`a`);r.href=t,r.download=`shader-playground-step-${n}.png`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(t)},`image/png`)})},updatePanel(){let t=e.getPhysicsSimulation();if(e.state.mode!==`physics`||!t)return;let n=t.getSimStep(),r=t.getTimeDirection(),i=t.getJournalHighWater(),a=document.getElementById(`debug-step-num`);a&&(a.textContent=String(n));let o=document.getElementById(`debug-step-dir`);o&&(o.textContent=r<0?`◀`:`▶`);let s=document.getElementById(`debug-scrub`),c=document.getElementById(`debug-scrub-high`);if(s&&c){let e=Math.max(i,n);s.max!==String(e)&&(s.max=String(e)),document.activeElement!==s&&(s.value=String(n)),c.textContent=String(e)}}}}function fe(e){let t=!1,n=null,r=null,i={},a={};function o(){n&&(i[n]=document.getElementById(`shader-editor`).value)}function s(){let e=document.getElementById(`shader-editor`),t=document.getElementById(`shader-status`);e.value=n&&i[n]||``,t.textContent=``,t.className=`shader-success`}function c(){let t=e.getShaderSources(e.state.mode);a={...t},r!==e.state.mode&&(r=e.state.mode,i={...t});let c=document.getElementById(`shader-tabs`);c.innerHTML=``;let l=Object.keys(t);n=n&&l.includes(n)?n:l[0]??null;for(let e of l){let t=document.createElement(`button`);t.className=`shader-tab${e===n?` active`:``}`,t.textContent=e,t.addEventListener(`click`,()=>{o(),n=e,c.querySelectorAll(`.shader-tab`).forEach(t=>{t.classList.toggle(`active`,t.textContent===e)}),s()}),c.appendChild(t)}s()}function l(){if(o(),!n)return;let t=n,r=i[t],a=document.getElementById(`shader-status`);try{e.createShaderModule(r).getCompilationInfo().then(n=>{let i=n.messages.filter(e=>e.type===`error`);if(i.length>0){a.className=`shader-error`,a.textContent=i.map(e=>`Line ${e.lineNum}: ${e.message}`).join(`; `),a.title=i.map(e=>`Line ${e.lineNum}: ${e.message}`).join(`
`);return}if(!e.applyShaderEdit(e.state.mode,t,r)){a.className=`shader-error`,a.textContent=`Shader tab "${t}" is not editable from this panel`,a.title=a.textContent;return}a.className=`shader-success`,a.textContent=`Compiled OK - reset simulation to apply`,a.title=``})}catch(e){a.className=`shader-error`,a.textContent=e.message,a.title=e.message}}function u(){if(!n||!a[n])return;let t=e.resetShaderEdit(e.state.mode,n);if(t===null){let e=document.getElementById(`shader-status`);e.className=`shader-error`,e.textContent=`Shader tab "${n}" is not editable from this panel`,e.title=e.textContent;return}i[n]=t,s();let r=document.getElementById(`shader-status`);r.className=`shader-success`,r.textContent=`Shader reset to original`}return{setup(){let e=document.getElementById(`shader-toggle`),n=document.getElementById(`shader-panel`);e.addEventListener(`click`,()=>{t=!t,n.classList.toggle(`open`,t),e.classList.toggle(`active`,t),t&&c()}),document.getElementById(`shader-compile`).addEventListener(`click`,l),document.getElementById(`shader-reset`).addEventListener(`click`,u),document.getElementById(`shader-editor`).addEventListener(`keydown`,e=>{if(e.key!==`Tab`)return;e.preventDefault();let t=e.target,n=t.selectionStart;t.value=t.value.substring(0,n)+`  `+t.value.substring(t.selectionEnd),t.selectionStart=n+2,t.selectionEnd=n+2})},update(){t&&r!==e.state.mode&&c()}}}function L(e){let t=parseInt(e.slice(1),16);return[(t>>16&255)/255,(t>>8&255)/255,(t&255)/255]}function pe(e,t,n){return e.map((e,r)=>e+(t[r]-e)*n)}function me(e){function t(t){let n=e.themes[t]||e.themes[e.defaultTheme];return{primary:L(n.primary),secondary:L(n.secondary),accent:L(n.accent),bg:L(n.bg),fg:L(n.fg),clearColor:{r:L(n.bg)[0],g:L(n.bg)[1],b:L(n.bg)[2],a:1}}}function n(e,t,n){let r=pe(e.bg,t.bg,n);return{primary:pe(e.primary,t.primary,n),secondary:pe(e.secondary,t.secondary,n),accent:pe(e.accent,t.accent,n),bg:r,fg:pe(e.fg,t.fg,n),clearColor:{r:r[0],g:r[1],b:r[2],a:1}}}let r={from:t(e.defaultTheme),to:t(e.defaultTheme),startedAtMs:0},i=t(e.defaultTheme);function a(t){let i=e.fadeMs<=0?1:Math.max(0,Math.min(1,(t-r.startedAtMs)/e.fadeMs));return n(r.from,r.to,i)}function o(){return i}function s(e){i=a(e)}function c(e){document.querySelectorAll(`#theme-presets .preset-btn`).forEach(t=>t.classList.toggle(`active`,t.dataset.theme===e))}function l(e){let n=t(e);r.from=n,r.to=n,r.startedAtMs=0,i=n,c(e)}function u(e,n=performance.now()){let o=t(e),s=a(n);r.from=s,r.to=o,r.startedAtMs=n,i=s,c(e)}function d(t,n=performance.now()){e.state.colorTheme!==t&&(e.state.colorTheme=t,u(t,n),e.onThemeSelected())}function f(){let t=document.getElementById(`theme-presets`);for(let n of Object.keys(e.themes)){let r=e.themes[n],i=document.createElement(`button`);i.className=`preset-btn`+(n===e.state.colorTheme?` active`:``),i.textContent=n,i.dataset.theme=n,i.style.borderLeftWidth=`3px`,i.style.borderLeftColor=r.primary,i.addEventListener(`click`,()=>{d(n)}),t.appendChild(i)}}return{buildThemeSelector:f,getThemeColors:o,refreshThemeColors:s,selectTheme:d,startThemeTransition:u,syncThemeButtons:c,syncThemeTransition:l}}var R={boids:`boids/flocking`,physics:`N-body gravitational`,physics_classic:`classic N-body (vintage shader)`,fluid:`fluid dynamics`,parametric:`parametric shape`,reaction:`Gray-Scott reaction-diffusion (3D)`};function z(e,t,n,r){let i=e.mode,a=n(i),o=t[i],s=[];for(let[e,t]of Object.entries(a))t!==o[e]&&s.push(he(e,t));let c=`WebGPU ${R[i]} simulation`;e.colorTheme!==r&&(c+=` (${e.colorTheme} theme)`),s.length>0&&(c+=` with ${s.filter(Boolean).join(`, `)}`),c+=`.`,document.getElementById(`prompt-text`).textContent=c}function he(e,t){let n=Number(t),r={count:()=>`${t} particles`,separationRadius:()=>n<15?`tight separation (${t})`:n>50?`wide separation (${t})`:`separation radius ${t}`,alignmentRadius:()=>`alignment range ${t}`,cohesionRadius:()=>n>80?`strong cohesion (${t})`:`cohesion range ${t}`,maxSpeed:()=>n>4?`high speed (${t})`:n<1?`slow movement (${t})`:`speed ${t}`,maxForce:()=>n>.1?`strong steering (${t})`:`steering force ${t}`,visualRange:()=>`visual range ${t}`,G:()=>n>5?`strong gravity (G=${t})`:n<.5?`weak gravity (G=${t})`:`G=${t}`,softening:()=>`softening ${t}`,damping:()=>n<.995?`high damping (${t})`:`damping ${t}`,haloMass:()=>n>8?`heavy halo (${t})`:n<2?`light halo (${t})`:`halo mass ${t}`,haloScale:()=>`halo scale ${t}`,diskMass:()=>n<.1?`no disk potential`:`disk mass ${t}`,diskScaleA:()=>`disk scale A ${t}`,diskScaleB:()=>`disk scale B ${t}`,gasMassFraction:()=>n<.01?`no gas reservoir`:`gas mass fraction ${t}`,gasSoundSpeed:()=>`gas sound speed ${t}`,gasVisible:()=>t?null:`gas hidden`,distribution:()=>`${t} distribution`,resolution:()=>`${t}x${t} grid`,viscosity:()=>n>.5?`thick fluid (viscosity ${t})`:n<.05?`thin fluid (viscosity ${t})`:`viscosity ${t}`,diffusionRate:()=>`diffusion ${t}`,forceStrength:()=>n>200?`strong forces (${t})`:`force strength ${t}`,volumeScale:()=>n>2?`large volume (${t})`:n<1?`compact volume (${t})`:`volume scale ${t}`,dyeMode:()=>`${t} dye`,jacobiIterations:()=>`${t} solver iterations`,shape:()=>`${t} shape`,scale:()=>n===1?null:`scale ${t}`,p1Min:()=>null,p1Max:()=>null,p1Rate:()=>null,p2Min:()=>null,p2Max:()=>null,p2Rate:()=>null,p3Min:()=>null,p3Max:()=>null,p3Rate:()=>null,p4Min:()=>null,p4Max:()=>null,p4Rate:()=>null,twistMin:()=>null,twistMax:()=>null,twistRate:()=>null}[e];return r?r():`${e}: ${t}`}function ge(e){let{state:t,catalog:n,modeParams:r}=e,i=null,a,o=me({defaultTheme:n.defaultTheme,fadeMs:n.themeFadeMs,onThemeSelected:()=>e.getActions().updateAll(),state:t,themes:n.themes}),s=de({canvas:e.getCanvas(),getPhysicsSimulation:e.getPhysicsSimulation,state:t,syncPauseButtons:()=>a.syncPauseButtons()}),c=fe({applyShaderEdit:e.applyShaderEdit,createShaderModule:e.createShaderModule,getShaderSources:e.getShaderSources,resetShaderEdit:e.resetShaderEdit,state:t});function l(){return i||(i=F({actions:e.getActions(),config:{fxParamDefs:n.fxParamDefs,modeTabLabels:n.modeTabLabels,paramDefs:n.paramDefs,presets:n.presets,shapeParams:n.shapeParams},modeParams:r,setXrDebugLogging:e.setXrDebugLogging,setupRecordButton:d,setupXRButton:u,state:t,storageKey:e.storageKey,syncThemeButtons:e=>o.syncThemeButtons(e)}),i)}function u(){let t=document.getElementById(`btn-xr`);if(!navigator.xr){t.textContent=`VR Not Available`;return}navigator.xr.isSessionSupported(`immersive-vr`).then(n=>{n?(t.disabled=!1,t.addEventListener(`click`,()=>{e.toggleXr()})):t.textContent=`VR Not Supported`}).catch(()=>{t.textContent=`VR Check Failed`})}function d(){let t=document.getElementById(`btn-xr-record`);if(!t)return;let n=()=>{let r=e.metrics.status(),i=e.getXrSession();if(r.phase===`idle`){t.textContent=`Record XR Session`,t.disabled=!!i;return}t.textContent=`Recording — exit XR to stop`,t.disabled=!0,requestAnimationFrame(n)};t.addEventListener(`click`,async()=>{if(e.metrics.status().phase!==`idle`||e.getXrSession())return;e.metrics.record({}).then(e=>{window.__xrLastRecording=e;let t={};for(let n of e)t[n.channel]=(t[n.channel]??0)+1;let n=Object.entries(t).map(([e,t])=>`${e}: ${t}`).join(`, `);console.group(`[xr] recording — ${e.length} samples (${n})`);for(let t of e){if(t.channel===`xr.snap`||t.channel===`xr.gesture`&&t.payload.gesture.kind===`pinch-hold`)continue;let e=t.channel;if(t.channel===`xr.gesture`){let n=t.payload;e=`xr.gesture:${n.gesture.kind}${n.hand?`(${n.hand})`:``}`}else if(t.channel===`xr.state`){let n=t.payload;e=`xr.state:${n.hand} ${n.from}→${n.to}`}console.log(`[t=${t.t.toFixed(0).padStart(5)}ms] ${e}`,t.payload)}console.groupEnd()}),requestAnimationFrame(n),await e.toggleXr();let t=e.getXrSession();if(!t){e.metrics.stop();return}t.addEventListener(`end`,()=>e.metrics.stop(),{once:!0})})}function f(){let n=n=>{let r=e.getActiveSimulation();C(r)&&(r.setTimeDirection(n?-1:1),!n&&t.paused&&(t.paused=!1))};document.addEventListener(`keydown`,e=>{if(e.key!==`r`&&e.key!==`R`||e.repeat)return;let t=e.target?.tagName;t===`INPUT`||t===`TEXTAREA`||t===`SELECT`||n(!0)}),document.addEventListener(`keyup`,e=>{(e.key===`r`||e.key===`R`)&&n(!1)});let r=document.getElementById(`fab-rewind`);r&&(r.addEventListener(`pointerdown`,()=>n(!0)),r.addEventListener(`pointerup`,()=>n(!1)),r.addEventListener(`pointercancel`,()=>n(!1)),r.addEventListener(`pointerleave`,()=>n(!1)))}return a={init(){let e=l();e.buildControls(),o.buildThemeSelector(),e.setupTabs(),e.setupGlobalControls(),c.setup(),f(),s.setupControls()},getThemeColors:()=>o.getThemeColors(),refreshThemeColors:e=>o.refreshThemeColors(e),syncThemeTransition:e=>o.syncThemeTransition(e),selectTheme:e=>o.selectTheme(e),syncPauseButtons:()=>l().syncPauseButtons(),syncUiFromState:()=>l().syncUiFromState(),updatePrompt:()=>z(t,n.defaults,r,n.defaultTheme),updateShaderPanel:()=>c.update(),cancelDebugMovement:()=>s.cancelMovement(),clearDebugState:()=>s.clearAll(),runDebugCompute:(e,t)=>s.runCompute(e,t),updateAdaptiveChunk:e=>s.updateAdaptiveChunk(e),updateDebugPanel:()=>s.updatePanel()},a}var B=`shader-playground-state`;function _e(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function ve(e,t,n){try{let r={};for(let e of Object.keys(t))r[e]=n(e);let i={mode:e.mode,colorTheme:e.colorTheme,camera:e.camera,fx:e.fx,debug:e.debug,...r};localStorage.setItem(B,JSON.stringify(i))}catch{}}function ye(e,t,n,r,i){try{let a=localStorage.getItem(B);if(!a)return;let o=JSON.parse(a);typeof o.mode==`string`&&o.mode in t&&(e.mode=o.mode),typeof o.colorTheme==`string`&&n[o.colorTheme]&&(e.colorTheme=o.colorTheme);for(let e of Object.keys(t))_e(o[e])&&Object.assign(r(e),o[e]);_e(o.camera)&&Object.assign(e.camera,o.camera),_e(o.fx)&&Object.assign(e.fx,o.fx),_e(o.debug)&&Object.assign(e.debug,o.debug),i(e.colorTheme)}catch{}}function be(e){for(let t of Object.keys(e.paramDefs))for(let n of e.paramDefs[t])if(!n.dynamic)for(let r of n.params)r.type===`dropdown`?e.registry.register({kind:`enum`,id:`${t}.${r.key}`,label:r.label,group:t,get:()=>String(e.modeParams(t)[r.key]),set:n=>{let i=e.modeParams(t),a=i[r.key];i[r.key]=typeof a==`number`?Number(n):n},options:(r.options??[]).map(e=>({value:String(e),label:String(e)}))}):r.type===`toggle`?e.registry.register({kind:`toggle`,id:`${t}.${r.key}`,label:r.label,group:t,get:()=>!!e.modeParams(t)[r.key],set:n=>{e.modeParams(t)[r.key]=n}}):r.min!==void 0&&r.max!==void 0&&e.registry.register({kind:`continuous`,id:`${t}.${r.key}`,label:r.label,group:t,get:()=>Number(e.modeParams(t)[r.key]),set:n=>{e.modeParams(t)[r.key]=n},range:{min:r.min,max:r.max},step:r.step,scale:r.logScale?`log`:`linear`});for(let t of Object.keys(e.presets))for(let n of Object.keys(e.presets[t]))e.registry.register({kind:`action`,id:`preset.${t}.${n}`,label:n,group:`presets`,invoke:()=>e.actions.applyPreset(t,n)});e.registry.register({kind:`enum`,id:`app.mode`,label:`Mode`,group:`app`,get:()=>e.state.mode,set:t=>e.actions.selectMode(t),options:Object.keys(e.modeTabLabels).map(t=>({value:t,label:e.modeTabLabels[t]}))}),e.registry.register({kind:`enum`,id:`app.theme`,label:`Theme`,group:`app`,get:()=>e.state.colorTheme,set:t=>e.actions.setTheme(t),options:Object.keys(e.themes).map(e=>({value:e,label:e}))}),e.registry.register({kind:`toggle`,id:`app.paused`,label:`Pause`,group:`app`,get:()=>e.state.paused,set:t=>e.actions.setPaused(t)}),e.registry.register({kind:`continuous`,id:`metrics.fps`,label:`FPS`,group:`metrics`,get:()=>e.metrics.fps(),set:()=>{},range:{min:0,max:120},format:e=>`${Math.round(e)} fps`}),e.registry.register({kind:`continuous`,id:`metrics.gpuMs`,label:`GPU`,group:`metrics`,get:()=>e.metrics.gpuMs(),set:()=>{},range:{min:0,max:50},format:e=>`${e.toFixed(1)} ms`}),e.registry.register({kind:`continuous`,id:`metrics.errorCount`,label:`Errors`,group:`metrics`,get:()=>e.metrics.errorCount(),set:()=>{},range:{min:0,max:100},format:e=>`${Math.round(e)} err`});for(let t of e.fxParamDefs)e.registry.register({kind:`continuous`,id:`fx.${t.key}`,label:t.label,group:`visuals`,get:()=>e.state.fx[t.key],set:n=>{e.state.fx[t.key]=n},range:{min:t.min,max:t.max},step:t.step})}function xe(e){let t=window;t.__simDiagnose=()=>{let t=e.getCurrentSimulation();return t?.diagnose?t.diagnose():Promise.resolve({error:1,msg:`no diagnose on this sim`})},t.__simPreset=e=>{let t=document.querySelectorAll(`button`);for(let n of t)if(n.textContent?.trim()===e)return n.click(),`ok`;return`preset not found`},t.__simState=()=>{let t=e.getGpuStats();return{mode:e.state.mode,...e.state[e.state.mode],fps:t.currentFps,gpuMs:t.gpuFrameMs,gpuDetail:t.gpuTimingDetail}},t.__pmDumpDensity=()=>{let t=e.getCurrentSimulation();return t?.dumpDensity?t.dumpDensity():Promise.resolve(null)},t.__pmDumpPotential=()=>{let t=e.getCurrentSimulation();return t?.dumpPotential?t.dumpPotential():Promise.resolve(null)},t.__pmDumpOuterDensity=()=>{let t=e.getCurrentSimulation();return t?.dumpOuterDensity?t.dumpOuterDensity():Promise.resolve(null)},t.__pmDumpOuterPotential=()=>{let t=e.getCurrentSimulation();return t?.dumpOuterPotential?t.dumpOuterPotential():Promise.resolve(null)},t.__pmMaxResidual=()=>{let t=e.getCurrentSimulation();return t?.maxResidual?t.maxResidual():Promise.resolve(null)},t.__pmReversibilityTest=(t=1e3)=>{let n=e.getCurrentSimulation();return n?.reversibilityTest?n.reversibilityTest(t):Promise.resolve(null)},t.__gasDumpDensity=()=>{let t=e.getCurrentSimulation();return t?.gasDumpDensity?t.gasDumpDensity():Promise.resolve(null)},t.__gasEnergyBreakdown=()=>{let t=e.getCurrentSimulation();return t?.gasEnergyBreakdown?t.gasEnergyBreakdown():Promise.resolve(null)},t.__gasWakeProbe=(t=0)=>{let n=e.getCurrentSimulation();return n?.gasWakeProbe?n.gasWakeProbe(t):Promise.resolve(null)},t.__gasReversibilityTest=(t=1e3)=>{let n=e.getCurrentSimulation();return n?.gasReversibilityTest?n.gasReversibilityTest(t):Promise.resolve(null)},t.__bindings=e.bindings,t.__anchors=e.anchors,t.__xrUi=e.xrUi,t.__simStats=()=>{let t=e.getCurrentSimulation(),n=t&&`getStats`in t&&typeof t.getStats==`function`?t.getStats():{error:`no stats on this sim`},r=e.getGpuStats();return{...n,gpuMs:r.gpuFrameMs,gpuDetail:r.gpuTimingDetail}}}var Se=[0,0,0,1];function Ce(e){return[-e[0],-e[1],-e[2],e[3]]}function we(e,t){switch(e.kind){case`world`:return e.pose;case`wrist`:case`held`:{let n=t.hands[e.hand].joints?.wrist??null;return n?Oe(Te(n),e.offset):null}case`palm`:{let n=t.hands[e.hand],r=n.joints?.wrist??null,i=n.palmNormal;return!r||!i?null:Oe({position:Ee(r.position),orientation:je([0,0,1],Ee(i))},e.offset)}case`head-hud`:return t.headPose?Oe(Oe(t.headPose,{position:[0,0,-e.distance],orientation:Se}),e.offset):null}}function Te(e){return{position:Ee(e.position),orientation:De(e.orientation)}}function Ee(e){return[e[0],e[1],e[2]]}function De(e){return[e[0],e[1],e[2],e[3]]}function Oe(e,t){let n=Ae(e.orientation,t.position);return{position:[e.position[0]+n[0],e.position[1]+n[1],e.position[2]+n[2]],orientation:ke(e.orientation,t.orientation)}}function ke(e,t){return[e[3]*t[0]+e[0]*t[3]+e[1]*t[2]-e[2]*t[1],e[3]*t[1]-e[0]*t[2]+e[1]*t[3]+e[2]*t[0],e[3]*t[2]+e[0]*t[1]-e[1]*t[0]+e[2]*t[3],e[3]*t[3]-e[0]*t[0]-e[1]*t[1]-e[2]*t[2]]}function Ae(e,t){let n=e[0],r=e[1],i=e[2],a=e[3],o=r*t[2]-i*t[1],s=i*t[0]-n*t[2],c=n*t[1]-r*t[0],l=o+a*t[0],u=s+a*t[1],d=c+a*t[2];return[t[0]+2*(r*d-i*u),t[1]+2*(i*l-n*d),t[2]+2*(n*u-r*l)]}function je(e,t){let n=e[0],r=e[1],i=e[2],a=t[0],o=t[1],s=t[2],c=n*a+r*o+i*s;if(c>.999999)return[0,0,0,1];if(c<-.999999){let e=Math.abs(n)<.9?[1,0,0]:[0,1,0],t=r*e[2]-i*e[1],a=i*e[0]-n*e[2],o=n*e[1]-r*e[0],s=Math.hypot(t,a,o)||1;return[t/s,a/s,o/s,0]}let l=n+a,u=r+o,d=i+s,f=Math.hypot(l,u,d),p=l/f,m=u/f,h=d/f;return[r*h-i*m,i*p-n*h,n*m-r*p,n*p+r*m+i*h]}var V=Object.freeze({minHitHalfExtent:Object.freeze({x:.06,y:.06}),defaultHitPadding:Object.freeze({x:.02,y:.02}),minNeighborHitGap:.02}),Me=new Set([`slider`,`dial`,`toggle`,`stepper`,`enum-chips`,`button`,`preset-tile`,`category-tile`,`readout`]);function Ne(e){return Me.has(e.kind)}function Pe(e,t,n,r){let i=we(e.anchor,t);if(!i)return null;let a=new Map,o=[];return Re(e.children,i,{x:0,y:0},e.id,a,o,n,r),a.set(e.id,{pose:i,visualRect:{halfExtent:We(e.size)},hitRect:{halfExtent:We(e.size)},widget:null,containerKind:`panel`,childrenIds:o}),a}function Fe(e,t,n,r,i,a,o,s){if(Ne(e)){let c=He(e,o),l=Ge(t,n),u=Be(e,c.visualHalf,c.hitHalf,s),d=u?{x:0,y:0}:c.hitHalf;if(i.set(e.id,{pose:l,visualRect:{halfExtent:c.visualHalf},hitRect:{halfExtent:d},widget:e,parentId:r,childrenIds:u?u.map(t=>`${e.id}::${t.id}`):[]}),a.push(e.id),u)for(let t of u){let n=`${e.id}::${t.id}`;i.set(n,{pose:Ge(l,t.offset),visualRect:{halfExtent:t.halfExtent},hitRect:{halfExtent:t.halfExtent},widget:e,parentId:e.id,childrenIds:[],subZoneId:t.id})}return}switch(e.kind){case`group`:ze(e,t,n,r,i,a,o,s);return;case`tabs`:{let c=e.tabs.find(t=>t.id===e.activeTabId);c&&Fe(c.body,t,n,r,i,a,o,s);return}case`focus-view`:Ie(e,t,n,r,i,a,o,s);return;case`panel`:return}}function Ie(e,t,n,r,i,a,o,s){let c=o?.get(e.id),l=c?.t??0;if(l<=0){Re(e.children,t,n,r,i,a,o,s);return}let u=c?.rendered??null,d=u==null?void 0:e.children.find(e=>e.id===u);if(!d||!Ne(d))return;let f=He(d,o),p=We(e.expandedSize),m={x:Math.max(p.x+d.hitPadding.x,V.minHitHalfExtent.x),y:Math.max(p.y+d.hitPadding.y,V.minHitHalfExtent.y)};i.set(d.id,{pose:Ge(t,n),visualRect:{halfExtent:Le(f.visualHalf,p,l)},hitRect:{halfExtent:Le(f.hitHalf,m,l)},widget:d,parentId:r,childrenIds:[]}),a.push(d.id)}function Le(e,t,n){return{x:e.x+(t.x-e.x)*n,y:e.y+(t.y-e.y)*n}}function Re(e,t,n,r,i,a,o,s){let c=e.map(e=>He(e,o)),l=V.minNeighborHitGap,u=Ue(c,`y`,l)/2;for(let d=0;d<e.length;d++){let f=c[d],p=u-f.hitHalf.y;Fe(e[d],t,{x:n.x,y:n.y+p},r,i,a,o,s),u-=f.hitHalf.y*2+l}}function ze(e,t,n,r,i,a,o,s){let c=Math.max(e.gap??0,V.minNeighborHitGap),l=e.children.map(e=>He(e,o));if(e.layout===`row`){let u=-Ue(l,`x`,c)/2;for(let d=0;d<e.children.length;d++){let f=l[d],p=u+f.hitHalf.x;Fe(e.children[d],t,{x:n.x+p,y:n.y},r,i,a,o,s),u+=f.hitHalf.x*2+c}return}if(e.layout===`column`){let u=Ue(l,`y`,c)/2;for(let d=0;d<e.children.length;d++){let f=l[d],p=u-f.hitHalf.y;Fe(e.children[d],t,{x:n.x,y:n.y+p},r,i,a,o,s),u-=f.hitHalf.y*2+c}return}let u=Math.max(1,e.columns??1),d=Math.max(0,...l.map(e=>e.hitHalf.x)),f=Math.max(0,...l.map(e=>e.hitHalf.y)),p=Math.ceil(e.children.length/u),m=u*d*2+Math.max(0,u-1)*c,h=p*f*2+Math.max(0,p-1)*c;for(let l=0;l<e.children.length;l++){let p=Math.floor(l/u),g=l%u,_=-m/2+g*(d*2+c)+d,v=h/2-p*(f*2+c)-f;Fe(e.children[l],t,{x:n.x+_,y:n.y+v},r,i,a,o,s)}}function Be(e,t,n,r){if(e.kind===`stepper`)return Ve(t,n,[{id:`left`},{id:`right`}]);if(e.kind===`enum-chips`){let i=r?.get(e.binding);return!i||i.kind!==`enum`||i.options.length===0?void 0:Ve(t,n,i.options.map(e=>({id:e.value})))}}function Ve(e,t,n){let r=n.length,i=e.x/r,a=[];for(let o=0;o<r;o++){let r=-e.x+i*(2*o+1);a.push({id:n[o].id,offset:{x:r,y:0},halfExtent:{x:i,y:t.y}})}return a}function He(e,t){if(Ne(e)){let t=We(e.visualSize);return{hitHalf:{x:Math.max(t.x+e.hitPadding.x,V.minHitHalfExtent.x),y:Math.max(t.y+e.hitPadding.y,V.minHitHalfExtent.y)},visualHalf:t}}switch(e.kind){case`panel`:return{hitHalf:We(e.size),visualHalf:We(e.size)};case`group`:{let n=Math.max(e.gap??0,V.minNeighborHitGap),r=e.children.map(e=>He(e,t));if(e.layout===`row`){let e=Ue(r,`x`,n),t=r.length===0?0:Math.max(...r.map(e=>e.hitHalf.y*2));return{hitHalf:{x:e/2,y:t/2},visualHalf:{x:e/2,y:t/2}}}if(e.layout===`column`){let e=Ue(r,`y`,n),t=r.length===0?0:Math.max(...r.map(e=>e.hitHalf.x*2));return{hitHalf:{x:t/2,y:e/2},visualHalf:{x:t/2,y:e/2}}}let i=Math.max(1,e.columns??1),a=r.length===0?0:Math.max(...r.map(e=>e.hitHalf.x)),o=r.length===0?0:Math.max(...r.map(e=>e.hitHalf.y)),s=Math.ceil(e.children.length/i),c=i*a*2+Math.max(0,i-1)*n,l=s*o*2+Math.max(0,s-1)*n;return{hitHalf:{x:c/2,y:l/2},visualHalf:{x:c/2,y:l/2}}}case`tabs`:{let n=e.tabs.find(t=>t.id===e.activeTabId);return n?He(n.body,t):{hitHalf:{x:0,y:0},visualHalf:{x:0,y:0}}}case`focus-view`:{let n=V.minNeighborHitGap,r=e.children.map(e=>He(e,t)),i=Ue(r,`y`,n),a=r.length===0?0:Math.max(...r.map(e=>e.hitHalf.x*2));return{hitHalf:{x:a/2,y:i/2},visualHalf:{x:a/2,y:i/2}}}}}function Ue(e,t,n){let r=0;for(let i=0;i<e.length;i++)r+=(t===`x`?e[i].hitHalf.x:e[i].hitHalf.y)*2,i>0&&(r+=n);return r}function We(e){return{x:e.x/2,y:e.y/2}}function Ge(e,t){return Oe(e,{position:[t.x,t.y,0],orientation:[0,0,0,1]})}function Ke(e,t){let n=null,r,i=1/0,a=1/0,o=1e-4;for(let[s,c]of e){if(!c.widget)continue;let e=qe(t,c.pose,c.hitRect.halfExtent);if(e===null)continue;let l=c.subZoneId===void 0?s:c.parentId??s;e.t<i-o?(i=e.t,n=l,r=c.subZoneId,a=e.centerDist):Math.abs(e.t-i)<=o&&l===n&&c.subZoneId!==void 0&&e.centerDist<a&&(r=c.subZoneId,a=e.centerDist)}return n===null?null:{widgetId:n,subZoneId:r}}function qe(e,t,n){let r=Ce(t.orientation),i=Ae(r,[e.origin[0]-t.position[0],e.origin[1]-t.position[1],e.origin[2]-t.position[2]]),a=Ae(r,[e.dir[0],e.dir[1],e.dir[2]]);if(Math.abs(a[2])<1e-9)return null;let o=-i[2]/a[2];if(o<=0)return null;let s=i[0]+o*a[0],c=i[1]+o*a[1];return Math.abs(s)>n.x||Math.abs(c)>n.y?null:{t:o,centerDist:Math.sqrt(s*s+c*c)}}var Je=150,Ye=Math.PI/2,Xe=200,Ze=.5,Qe=.7,$e=.4,et=1,tt=.1;function nt(){return{states:{left:{kind:`idle`},right:{kind:`idle`}},pinches:{left:!1,right:!1},focusTransitions:new Map,visibilityTransitions:new Map}}var rt=[`left`,`right`];function it(e,t,n,r,i,a){let o=[],s=[],c={states:{left:n.states.left,right:n.states.right},pinches:{left:t.left.pinch.active,right:t.right.pinch.active},focusTransitions:n.focusTransitions,visibilityTransitions:n.visibilityTransitions},l=new Set,u=new Set,d=i.gainMultiplier<1,f=e.activeLayoutId,p=f==null?void 0:e.layouts.get(f);if(!p||f==null)return c.states.left={kind:`idle`},c.states.right={kind:`idle`},ot(e,r,n.states,c,a,d,l,u,s),bt(c.focusTransitions,l),bt(c.visibilityTransitions,u),{next:c,sideEffects:o,renderList:s};ht(p,c.focusTransitions,l,a);let m=Pe(p,r,c.focusTransitions,e.bindings);if(!m)return c.states.left={kind:`idle`},c.states.right={kind:`idle`},ot(e,r,n.states,c,a,d,l,u,s),bt(c.focusTransitions,l),bt(c.visibilityTransitions,u),{next:c,sideEffects:o,renderList:s};u.add(p.id),yt(p,c.visibilityTransitions,n.states,m,r,a);let h=(c.visibilityTransitions.get(p.id)?.alpha??0)>=Ze;for(let r of rt){let a=t[r],s=n.pinches[r],l=a.pinch.active,u=n.states[r],d=u;if(l&&!s){let t=a.gazeRay?Ke(m,a.gazeRay):null,n=h?t:null,r=n?m.get(n.widgetId)??null:null,o=r?.widget??null;if(d=o&&n&&r?Et(o,n.widgetId,n.subZoneId,r.pose,e.bindings,a,p,f,i.gainMultiplier):{kind:`idle`},d.kind===`dragging`&&d.focusViewId!=null){let e=ft(p,d.focusViewId);e&&(e.focused=d.widgetId)}}else if(!l&&s){if(u.kind===`pressing`&&!u.cancelPending){let e=u.commit;if(e.kind===`invoke`)o.push({kind:`binding-invoke`,bindingId:e.bindingId});else if(e.kind===`toggle`)o.push({kind:`binding-set`,bindingId:e.bindingId,value:!e.valueAtOrigin});else if(e.kind===`increment`){let t=Math.max(e.min,Math.min(e.max,e.valueAtOrigin+e.step));o.push({kind:`binding-set`,bindingId:e.bindingId,value:t})}else e.kind===`enum-set`?o.push({kind:`binding-set`,bindingId:e.bindingId,value:e.value}):o.push({kind:`tab-switch`,layoutId:e.layoutId,tabId:e.tabId})}if(u.kind===`dragging`&&u.focusViewId!=null){let e=ft(p,u.focusViewId);e&&(e.focused=null)}d={kind:`idle`}}else if(l&&s){if(u.kind===`dragging`){let t=e.bindings.get(u.bindingId),n=u;if(t&&t.kind===`continuous`&&n.appliedGain!==i.gainMultiplier){let e=Dt(n,a,t,n.appliedGain),r=a.joints?.wrist,o=r?[r.orientation[0],r.orientation[1],r.orientation[2],r.orientation[3]]:n.wristQuatAtOrigin;n={...n,valueAtOrigin:e,handOriginPos:[a.pinch.current[0],a.pinch.current[1],a.pinch.current[2]],wristQuatAtOrigin:o,appliedGain:i.gainMultiplier}}if(t&&t.kind===`continuous`){let e=Dt(n,a,t,i.gainMultiplier);o.push({kind:`binding-set`,bindingId:n.bindingId,value:e})}d=n}else if(u.kind===`pressing`){let e=a.currentRay?Ke(m,a.currentRay):null,t=e!==null&&e.widgetId===u.widgetId;d={...u,cancelPending:!t}}}else{let e=a.ray?Ke(m,a.ray):null,t=h?e:null;d=t?{kind:`hovering`,widgetId:t.widgetId,subZoneId:t.subZoneId}:{kind:`idle`}}c.states[r]=d}return at(m,c.states,c.visibilityTransitions,e.bindings,d,s),ot(e,r,n.states,c,a,d,l,u,s),bt(c.focusTransitions,l),bt(c.visibilityTransitions,u),{next:c,sideEffects:o,renderList:s}}function at(e,t,n,r,i,a){for(let[o,s]of e){if(!s.widget||s.subZoneId!==void 0)continue;let e=s.widget,c=ut(t,e=>e.kind===`hovering`&&e.widgetId===o),l=ut(t,e=>e.kind===`pressing`&&e.widgetId===o),u=ut(t,e=>e.kind===`dragging`&&e.widgetId===o),d=s.parentId,f=d==null?1:n.get(d)?.alpha??1;a.push({widgetId:o,pose:s.pose,visualHalfExtent:s.visualRect.halfExtent,kind:e.kind,state:{hover:c,pressed:l,dragging:u,value:Tt(e,r)},subZones:Ct(e,o,t,r),label:xt(e,r),fineMode:i,alpha:f})}}function ot(e,t,n,r,i,a,o,s,c){for(let l of e.hudLayoutIds){let u=e.layouts.get(l);if(!u)continue;ht(u,r.focusTransitions,o,i);let d=Pe(u,t,r.focusTransitions,e.bindings);d&&(s.add(u.id),yt(u,r.visibilityTransitions,n,d,t,i),at(d,r.states,r.visibilityTransitions,e.bindings,a,c))}}function st(e){return e.kind===`pressing`||e.kind===`dragging`}function ct(e,t){for(let n of e){if(n.kind===`tab-switch`){let e=t.layouts.get(n.layoutId);e&&lt(e,n.tabId);continue}let e=t.bindings.get(n.bindingId);if(e){if(n.kind===`binding-invoke`&&e.kind===`action`){e.invoke();continue}n.kind===`binding-set`&&(e.kind===`continuous`&&typeof n.value==`number`||e.kind===`toggle`&&typeof n.value==`boolean`||e.kind===`enum`&&typeof n.value==`string`)&&e.set(n.value)}}}function lt(e,t){if(Ne(e))return!1;if(e.kind===`tabs`&&e.tabs.some(e=>e.id===t))return e.activeTabId=t,!0;switch(e.kind){case`panel`:case`group`:case`focus-view`:for(let n of e.children)if(lt(n,t))return!0;return!1;case`tabs`:for(let n of e.tabs)if(lt(n.body,t))return!0;return!1}}function ut(e,t){return t(e.left)||t(e.right)}function dt(e,t){if(!Ne(e))switch(e.kind===`focus-view`&&t(e),e.kind){case`panel`:case`group`:case`focus-view`:for(let n of e.children)dt(n,t);return;case`tabs`:for(let n of e.tabs)dt(n.body,t);return}}function ft(e,t){let n=null;return dt(e,e=>{e.id===t&&(n=e)}),n}function pt(e,t){let n=null;return dt(e,e=>{e.children.some(e=>mt(e,t))&&(n=e.id)}),n}function mt(e,t){if(Ne(e))return e.id===t;switch(e.kind){case`panel`:case`group`:case`focus-view`:return e.children.some(e=>mt(e,t));case`tabs`:return e.tabs.some(e=>mt(e.body,t))}}function ht(e,t,n,r){let i=Math.max(0,r)/Je;dt(e,e=>{n.add(e.id);let r=t.get(e.id)??{rendered:null,t:0},a=e.focused==null?0:1,o=a>r.t?1:a<r.t?-1:0,s=gt(r.t+o*i),c=e.focused==null?s>0?r.rendered:null:e.focused;t.set(e.id,{rendered:c,t:s})})}function gt(e){return e<0?0:e>1?1:e}function _t(e,t,n){if(!e||e.kind===`always`)return!0;if(e.kind===`palm-facing-user`){let r=t.hands[e.hand],i=r.joints?.wrist,a=r.palmNormal,o=t.headPose;if(!i||!a||!o)return n;let s=o.position[0]-i.position[0],c=o.position[1]-i.position[1],l=o.position[2]-i.position[2],u=Math.sqrt(s*s+c*c+l*l);if(u<1e-6)return n;let d=(a[0]*s+a[1]*c+a[2]*l)/u,f=e.threshold??Qe;return n?d>$e:d>f}if(e.kind===`hand-raised`){let r=t.hands[e.hand].joints?.wrist;if(!r)return n;let i=e.minY??et,a=n?i-tt:i;return r.position[1]>a}return!0}function vt(e,t,n){for(let r of rt){let i=e[r],a=i.kind===`pressing`||i.kind===`dragging`?i.widgetId:null;if(a!=null&&t.get(a)?.parentId===n)return!0}return!1}function yt(e,t,n,r,i,a){let o=Math.max(0,a)/Xe,s=t.get(e.id)??{satisfied:!1,alpha:0},c=_t(e.visibility,i,s.satisfied),l=vt(n,r,e.id),u=c||l?1:0,d=u>s.alpha?1:u<s.alpha?-1:0,f=gt(s.alpha+d*o);t.set(e.id,{satisfied:c,alpha:f})}function bt(e,t){for(let n of e.keys())t.has(n)||e.delete(n)}function xt(e,t){if(e.kind===`category-tile`){let t=e.summary.label;return typeof t==`string`?t:void 0}let n=t.get(e.binding);if(n){if(e.kind===`slider`||e.kind===`dial`||e.kind===`readout`||e.kind===`stepper`){if(n.kind!==`continuous`)return n.label;let e=n.get();return n.format?n.format(e):St(e)}if(e.kind===`toggle`)return n.kind===`toggle`?n.get()?`On`:`Off`:n.label;if(e.kind===`enum-chips`)return n.kind===`enum`?n.get():n.label;if(e.kind===`button`||e.kind===`preset-tile`)return n.label}}function St(e){if(Number.isInteger(e))return String(e);let t=Math.abs(e);return t>=100?e.toFixed(0):t>=10?e.toFixed(1):t>=1?e.toFixed(2):e.toFixed(3)}function Ct(e,t,n,r){if(e.kind===`stepper`){let e=wt(n,t,`hovering`),r=wt(n,t,`pressing`),i=e=>e===`left`?`left`:e===`right`?`right`:null;return{kind:`stepper`,hoverSide:i(e),pressSide:i(r)}}if(e.kind===`enum-chips`){let i=r.get(e.binding);if(!i||i.kind!==`enum`)return;let a=e=>e===void 0?-1:i.options.findIndex(t=>t.value===e);return{kind:`chips`,count:i.options.length,activeIdx:a(i.get()),hoverIdx:a(wt(n,t,`hovering`)),pressIdx:a(wt(n,t,`pressing`))}}}function wt(e,t,n){for(let r of rt){let i=e[r];if(i.kind===n&&i.widgetId===t)return i.subZoneId}}function Tt(e,t){if(e.kind!==`slider`&&e.kind!==`dial`&&e.kind!==`readout`)return;let n=t.get(e.binding);if(!n||n.kind!==`continuous`)return;let r=n.range.max-n.range.min;return r<=0?0:(n.get()-n.range.min)/r}function Et(e,t,n,r,i,a,o,s,c){if(e.kind===`button`||e.kind===`preset-tile`){let n=i.get(e.binding);return!n||n.kind!==`action`?{kind:`idle`}:{kind:`pressing`,widgetId:t,startedAt:a.pinch.startTime,cancelPending:!1,commit:{kind:`invoke`,bindingId:n.id}}}if(e.kind===`toggle`){let n=i.get(e.binding);return!n||n.kind!==`toggle`?{kind:`idle`}:{kind:`pressing`,widgetId:t,startedAt:a.pinch.startTime,cancelPending:!1,commit:{kind:`toggle`,bindingId:n.id,valueAtOrigin:n.get()}}}if(e.kind===`stepper`){let r=i.get(e.binding);if(!r||r.kind!==`continuous`||n!==`left`&&n!==`right`)return{kind:`idle`};let o=n===`left`?-e.step:e.step;return{kind:`pressing`,widgetId:t,subZoneId:n,startedAt:a.pinch.startTime,cancelPending:!1,commit:{kind:`increment`,bindingId:r.id,valueAtOrigin:r.get(),step:o,min:r.range.min,max:r.range.max}}}if(e.kind===`enum-chips`){let r=i.get(e.binding);return!r||r.kind!==`enum`||n===void 0||!r.options.some(e=>e.value===n)?{kind:`idle`}:{kind:`pressing`,widgetId:t,subZoneId:n,startedAt:a.pinch.startTime,cancelPending:!1,commit:{kind:`enum-set`,bindingId:r.id,value:n}}}if(e.kind===`category-tile`)return{kind:`pressing`,widgetId:t,startedAt:a.pinch.startTime,cancelPending:!1,commit:{kind:`tab-switch`,layoutId:s,tabId:e.targetTabId}};if(e.kind===`slider`||e.kind===`dial`){let n=i.get(e.binding);if(!n||n.kind!==`continuous`)return{kind:`idle`};let s=pt(o,t),l=a.joints?.wrist,u=l?[l.orientation[0],l.orientation[1],l.orientation[2],l.orientation[3]]:null;return{kind:`dragging`,widgetId:t,bindingId:n.id,handOriginPos:[...a.pinch.origin],widgetOrientationAtOrigin:[r.orientation[0],r.orientation[1],r.orientation[2],r.orientation[3]],wristQuatAtOrigin:u,valueAtOrigin:n.get(),appliedGain:c,interaction:e.interaction,cancelPending:!1,focusViewId:s}}return{kind:`idle`}}function Dt(e,t,n,r){let i=[t.pinch.current[0]-e.handOriginPos[0],t.pinch.current[1]-e.handOriginPos[1],t.pinch.current[2]-e.handOriginPos[2]],a=Ae(Ce(e.widgetOrientationAtOrigin),i),o=a[0],s=a[1],c=a[2],l=n.range.max-n.range.min,u=n=>{switch(n.kind){case`direct-drag`:return(n.axis===`x`?o:s)*l;case`pinch-pull`:{let e=n.axis;return(e===`forward`?-c:e===`up`?s:o)*n.unitsPerMeter}case`pinch-twist`:{let r=t.joints?.wrist;if(!e.wristQuatAtOrigin||!r)return 0;let i=r.orientation,a=ke(Ce(e.wristQuatAtOrigin),[i[0],i[1],i[2],i[3]]),o=n.axis===`pitch`?0:n.axis===`yaw`?1:2;return 2*Math.atan2(a[o],a[3])/Ye*l}case`expand-to-focus`:return u(n.underlying)}},d=u(e.interaction),f=e.valueAtOrigin+d*r;return Math.max(n.range.min,Math.min(n.range.max,f))}function Ot(e){e.initGrid(),ye(e.state,e.catalog.defaults,e.catalog.themes,e.modeParams,t=>e.uiOrchestrator.syncThemeTransition(t)),e.isMobile&&e.mobileInput.applyMobileDefaults(),e.uiOrchestrator.syncThemeTransition(e.state.colorTheme),be({actions:e.appActions,fxParamDefs:e.catalog.fxParamDefs,metrics:e.metrics,modeParams:e.modeParams,modeTabLabels:e.catalog.modeTabLabels,paramDefs:e.catalog.paramDefs,presets:e.catalog.presets,registry:e.bindingRegistry,state:e.state,themes:e.catalog.themes}),e.uiOrchestrator.init(),e.isMobile?(e.mobileInput.setupTouchControls(),e.mobileInput.setupFab(),e.mobileInput.setupBottomSheet()):e.pointerSystem.setupMouseControls(),e.uiOrchestrator.syncUiFromState(),e.gpuContext.frameRuntime.resize(),e.ensureSimulation(),e.appActions.updateAll(),e.gpuContext.frameRuntime.start(),xe({state:e.state,getCurrentSimulation:e.getCurrentSimulation,getGpuStats:()=>e.gpuContext.frameRuntime.getGpuStats(),bindings:e.bindingRegistry,anchors:{evaluateAnchor:we,handFrames:e.xrInputSystem.getHandFrames()},xrUi:{layout:Pe,hitTestWidgets:Ke,step:it,applyEffects:ct,registry:e.xrInputSystem.getUiRegistry(),makeIdlePrev:nt,getRenderList:()=>e.xrInputSystem.getRenderList(),getPrev:()=>e.xrInputSystem.getPrev(),getClaimed:()=>e.xrInputSystem.getClaimed()}})}var kt=`struct Particle {
  pos: vec3f,
  vel: vec3f,
}
...
`,jt=`// [LAW:one-source-of-truth] DKD leapfrog integrator with ALL conservative forces.
...
`,Mt=`// [LAW:one-source-of-truth] System-wide statistics computed in one reduction pass.
...
`,Pt=`// Marker particles: small bright tracers orbiting each active attractor. Shares the same HDR scene
...
`,It=`// PM CIC (cloud-in-cell) deposition. Each particle scatters its mass into
...
`,Lt=`// PM density post-processing. Two entry points share one bind group layout:
...
`,Rt=`// Red-black Gauss-Seidel smoother for the multigrid V-cycle.
...
`,zt=`// Compute residual r = 4πGρ - ∇²φ with the same 7-point stencil + periodic
...
`,Bt=`// Restriction (fine → coarse) for the multigrid V-cycle. Each coarse cell
...
`,Ht=`// PM force interpolation (CIC-weighted). For each particle, read the
...
`,Ut=`// Classic n-body render — preserved verbatim for A/B comparison. World-space billboards, soft fuzzy falloff.
...
`,Qt=`// Gray-Scott reaction-diffusion on a 3D volume.
...
`,$t=`// Raymarched volume render of the Gray-Scott v-field.
...
`,tn=`// Gas pressure potential construction.
//
...
`,nn=`// Gas pressure force interpolation.
//
...
`,rn=`// Gas DKD leapfrog integrator.
//
...
`,Tn=`// Dirichlet BC seed for the inner PM grid. Runs once per frame AFTER the outer
...
`,br=64,xr=64,Sr=208,Cr=256,wr=512,Tr=64,Er=br,Dr=Tr*Er,Or={slider:0,button:1,readout:2,dial:3,toggle:4,stepper:5,"enum-chips":6,"preset-tile":7,"category-tile":8};function kr(e,t,n){let r=e.createShaderModule({code:yr,label:`xr-widgets`}),i=e.createBindGroupLayout({label:`xr-widgets-bgl`,entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`read-only-storage`}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{}}]}),a=e.createPipelineLayout({bindGroupLayouts:[i]}),o=e.createBuffer({label:`xr-widgets-instances`,size:xr*br,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),s=new ArrayBuffer(xr*br),c=new Float32Array(s),l=new Uint32Array(s),u=document.createElement(`canvas`);u.width=wr,u.height=Dr;let d=u.getContext(`2d`);if(!d)throw Error(`xr-widgets: 2D canvas context unavailable`);let f=d;f.font=`600 40px system-ui, -apple-system, sans-serif`,f.textAlign=`center`,f.textBaseline=`middle`;let p=e.createTexture({label:`xr-widgets-label-atlas`,size:[wr,Dr,1],format:`rgba8unorm`,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),m=p.createView(),h=e.createSampler({label:`xr-widgets-atlas-sampler`,magFilter:`linear`,minFilter:`linear`,addressModeU:`clamp-to-edge`,addressModeV:`clamp-to-edge`}),g=Array(Er).fill(``);function _(t,n){if(g[t]===n)return t;g[t]=n;let r=t*Tr;return f.clearRect(0,r,wr,Tr),f.fillStyle=`rgba(255, 255, 255, 1)`,f.fillText(n,wr/2,r+Tr/2),e.queue.copyExternalImageToTexture({source:u,origin:{x:0,y:r}},{texture:p,origin:{x:0,y:r}},[wr,Tr,1]),t}let v=[];for(let n=0;n<2;n++)v.push(e.createBindGroup({label:`xr-widgets-bg-eye${n}`,layout:i,entries:[{binding:0,resource:{buffer:t,offset:n*Cr,size:Sr}},{binding:1,resource:{buffer:o}},{binding:2,resource:m},{binding:3,resource:h}]}));let y=new Map;function b(t){let n=y.get(t);return n||(n=e.createRenderPipeline({label:`xr-widgets-pipeline-${t}`,layout:a,vertex:{module:r,entryPoint:`vs`},fragment:{module:r,entryPoint:`fs`,targets:[{format:t,blend:{color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`}}),y.set(t,n),n)}function x(e){let t=Math.min(e.length,br);for(let n=0;n<t;n++){let t=e[n],r=xr/4*n;c[r+0]=t.pose.position[0],c[r+1]=t.pose.position[1],c[r+2]=t.pose.position[2],c[r+3]=t.visualHalfExtent.x,c[r+4]=t.pose.orientation[0],c[r+5]=t.pose.orientation[1],c[r+6]=t.pose.orientation[2],c[r+7]=t.pose.orientation[3],c[r+8]=t.visualHalfExtent.y,l[r+9]=Or[t.kind]??0;let i=(t.state.hover?1:0)|(t.state.pressed?2:0)|(t.state.dragging?4:0)|(t.fineMode?8:0);l[r+10]=i>>>0,c[r+11]=t.state.value??0;let a=t.label!=null&&t.label.length>0?_(n,t.label):-1;l[r+12]=a>=0?a>>>0:0,l[r+13]=a>=0?1:0,c[r+14]=t.alpha,l[r+15]=S(t.subZones)}return t}function S(e){if(!e)return 0;let t=e=>e<0||e>14?15:e;if(e.kind===`chips`)return Math.min(15,Math.max(0,e.count))&15|(t(e.activeIdx)&15)<<4|(t(e.hoverIdx)&15)<<8|(t(e.pressIdx)&15)<<12;let n=e=>e===`left`?1:e===`right`?2:0;return n(e.hoverSide)<<16|n(e.pressSide)<<18}return{draw(r,i,a,c,l){e.queue.writeBuffer(t,c*Cr,n(c));let u=x(l);u>0&&e.queue.writeBuffer(o,0,s,0,u*xr);let d=r.beginRenderPass({label:`xr-widgets-pass-eye${c}`,colorAttachments:[{view:i,loadOp:`load`,storeOp:`store`}]});u>0&&(d.setPipeline(b(a)),d.setBindGroup(0,v[c]),d.draw(6,u)),d.end()},destroy(){o.destroy(),p.destroy()}}}var Ar=Math.PI*.33,jr=Math.sin(Ar),Mr=Math.cos(Ar),Nr={x:.2,y:.28},Pr={x:.17,y:.03},Fr={x:.18,y:.18},Ir={x:.08,y:.05},Lr={x:.17,y:.025},Rr={x:.08,y:.06},zr=`root`,Br=[`preset.physics.Default`,`preset.physics.Spiral Galaxy`,`preset.physics.Cosmic Web`],Vr=[{id:`physics`,label:`Physics`,body:{kind:`sliders`,bindings:[`physics.G`,`physics.softening`,`physics.haloMass`,`physics.haloScale`,`physics.diskMass`,`physics.tidalStrength`,`physics.attractorDecayTime`]}},{id:`visuals`,label:`Visuals`,body:{kind:`sliders`,bindings:[`fx.bloomIntensity`,`fx.bloomThreshold`,`fx.chromaticAberration`,`fx.vignette`,`fx.exposure`,`fx.timeScale`]}},{id:`gas`,label:`Gas`,body:{kind:`sliders`,bindings:[`physics.gasSoundSpeed`,`physics.gasMassFraction`]}},{id:`presets`,label:`Presets`,body:{kind:`tiles`,bindings:[`preset.physics.Default`,`preset.physics.Spiral Galaxy`,`preset.physics.Cosmic Web`]}}];function Hr(e,t){return{id:e,kind:`slider`,binding:t,orientation:`horizontal`,interaction:{kind:`direct-drag`,axis:`x`},visualSize:Pr,hitPadding:V.defaultHitPadding}}function Ur(e){return{id:`clipboard-tile-${e.id}`,kind:`category-tile`,targetTabId:e.id,summary:{label:e.label},visualSize:Ir,hitPadding:V.defaultHitPadding}}function Wr(e){return{id:`clipboard-back-${e}`,kind:`category-tile`,targetTabId:zr,summary:{label:`Back`},visualSize:Lr,hitPadding:V.defaultHitPadding}}function Gr(e,t){return{id:`${e}-${Yr(t)}`,kind:`preset-tile`,binding:t,visualSize:Rr,hitPadding:V.defaultHitPadding}}function Kr(){return{id:`clipboard-preset-strip`,kind:`group`,layout:`row`,gap:V.minNeighborHitGap,children:Br.map(e=>Gr(`clipboard-strip`,e))}}function qr(e){let t=e.body.kind===`sliders`?{id:`clipboard-focus-${e.id}`,kind:`focus-view`,focused:null,expandedSize:Fr,children:e.body.bindings.map(t=>Hr(`clipboard-${e.id}-${Yr(t)}`,t))}:{id:`clipboard-grid-${e.id}`,kind:`group`,layout:`grid`,columns:2,gap:V.minNeighborHitGap,children:e.body.bindings.map(t=>Gr(`clipboard-${e.id}`,t))};return{id:`clipboard-tab-${e.id}`,kind:`group`,layout:`column`,children:[Wr(e.id),t]}}function Jr(){return{id:`clipboard-tab-root`,kind:`group`,layout:`grid`,columns:2,gap:V.minNeighborHitGap,children:Vr.map(Ur)}}function Yr(e){return e.replace(/[^a-z0-9]/gi,`-`)}function Xr(e){let t={id:`clipboard-tabs`,kind:`tabs`,activeTabId:zr,tabs:[{id:zr,label:`Categories`,body:Jr()},...Vr.map(e=>({id:e.id,label:e.label,body:qr(e)}))]};return{id:`clipboard-panel`,kind:`panel`,anchor:{kind:`held`,hand:e,offset:{position:[0,.15,-.1],orientation:[jr,0,0,Mr]}},size:Nr,children:[t,Kr()],visibility:{kind:`palm-facing-user`,hand:e}}}var Zr=[{id:`hud-readout-fps`,bindingId:`metrics.fps`},{id:`hud-readout-gpu`,bindingId:`metrics.gpuMs`},{id:`hud-readout-errors`,bindingId:`metrics.errorCount`}],Qr={x:.08,y:.022},$r={x:.1,y:.1},ei=.6,ti=.18,ni=.12;function ri(e,t){return{id:e,kind:`readout`,binding:t,visualSize:Qr,hitPadding:V.defaultHitPadding}}function ii(){let e={id:`hud-column`,kind:`group`,layout:`column`,gap:V.minNeighborHitGap,children:Zr.map(e=>ri(e.id,e.bindingId))};return{id:`debug-hud-panel`,kind:`panel`,anchor:{kind:`head-hud`,distance:ei,offset:{position:[ti,ni,0],orientation:[0,0,0,1]}},size:$r,children:[e],visibility:{kind:`always`}}}function ai(e){let t=null,n=null,r=null,i=null,a=null,o=null,s=0,c=(l,u)=>{if(!t)return;t.requestAnimationFrame(c),e.refreshThemeColors(l);let d=s<3;d&&e.logInfo(`xr:frame`,`xrFrame #${s} entered`,{mode:e.state.mode}),e.pruneAttractors(e.currentSimStep());let{frameDeltaMs:f,fpsUpdated:p}=e.tickFrameStats(l);e.tickMarkers(Math.min(.05,f*.001)*e.state.fx.timeScale*e.currentTimeDirection()),p&&e.updateStats(),e.setCurrentPhase(`xr:frame:${s}:pre-encode`),e.device.pushErrorScope(`validation`);try{let t=e.getRefSpace();if(!t){e.logError(`xr:frame`,Error(`XR reference space unavailable during frame`));return}let c=u.getViewerPose(t);if(!c){d&&e.logInfo(`xr:frame`,`no viewer pose yet`);return}let l=e.getCurrentSimulation();if(!l){e.logError(`xr:frame`,Error(`simulation for mode=${e.state.mode} is not initialized`));return}e.inputStep(u),e.setCurrentPhase(`xr:frame:${s}:createCommandEncoder`);let f=e.device.createCommandEncoder({label:`xr-frame-${s}`});e.state.paused||(e.setCurrentPhase(`xr:frame:${s}:sim.compute(${e.state.mode})`),l.compute(f)),d&&e.logInfo(`xr:frame`,`pose has ${c.views.length} views`);for(let t=0;t<c.views.length;t++){let u=c.views[t];e.setCurrentPhase(`xr:frame:${s}:getViewSubImage(eye=${t})`);let p=n,m=p.getViewSubImage?p.getViewSubImage(r,u):p.getSubImage(r,u);if(!m){e.logError(`xr:frame`,Error(`subImage null for eye ${t}`));continue}d&&t===0&&e.logInfo(`xr:frame`,`subImage`,{viewport:m.viewport,colorFormat:m.colorTexture.format,hasDepth:!!m.depthStencilTexture}),e.setCurrentPhase(`xr:frame:${s}:createView(color,eye=${t})`);let h=m.getViewDescriptor?m.getViewDescriptor():{},g=m.colorTexture.createView(h);e.setCurrentPhase(`xr:frame:${s}:createView(depth,eye=${t})`);let _=(r.textureArrayLength??1)>1,v=m.depthStencilTexture;o=v&&_?v.createView(h):null;let y=u.transform.position;e.cameraSystem.setXrOverride({viewMatrix:new Float32Array(u.transform.inverse.matrix),projMatrix:new Float32Array(u.projectionMatrix),eye:[y.x,y.y,y.z]});let{x:b,y:x,width:S,height:C}=m.viewport;e.setCurrentPhase(`xr:frame:${s}:ensureHdrTargets(${S}x${C})`),e.ensureHdrTargets(S,C),e.markPostFxNeedsClear();let w=e.getPostFxSceneIndex();e.setCurrentPhase(`xr:frame:${s}:sim.render(${e.state.mode},eye=${t})`);let T=e.getPostFxSceneView(w);l.render(f,T,null,t),i||=(a=e.device.createBuffer({label:`xr-widgets-camera`,size:e.cameraStride*2,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),kr(e.device,a,()=>{let t=S/C;return e.getCameraUniformData(t)})),e.setCurrentPhase(`xr:frame:${s}:xr-widgets(eye=${t})`),i.draw(f,T,e.getPostFxSceneFormat(w),t,e.getUiRenderList()),e.setCurrentPhase(`xr:frame:${s}:bloom(eye=${t})`),e.postFxRunBloomChain(f),e.setCurrentPhase(`xr:frame:${s}:composite(eye=${t})`);let E=m.colorTexture.format;e.postFxRunComposite(f,g,E,[b,x,S,C])}e.setCurrentPhase(`xr:frame:${s}:submit`),e.device.queue.submit([f.finish()]),d&&e.logInfo(`xr:frame`,`frame #${s} submitted OK`)}catch(t){e.logError(`xr:frame`,t,`frame #${s} threw synchronously`)}finally{e.cameraSystem.clearXrOverride(),o=null,e.device.popErrorScope().then(t=>{t&&e.logError(`xr:frame:validation`,t,`frame #${s}`)}).catch(t=>e.logError(`xr:frame:popScope`,t)),s++}};return{getDepthOverride(){return o},getSession(){return t},async toggle(){if(t){e.logInfo(`xr`,`ending session on toggle`),t.end();return}if(!navigator.xr){e.logError(`xr`,Error(`WebXR not supported (navigator.xr missing)`));return}let i=document.getElementById(`btn-xr`);e.setCurrentPhase(`xr:requestSession`);try{t=await navigator.xr.requestSession(`immersive-vr`,{requiredFeatures:[`webgpu`],optionalFeatures:[`layers`,`local-floor`,`hand-tracking`]});let a=t.enabledFeatures,o=a?.includes(`hand-tracking`)??!1;e.setHandTrackingAvailable(o),e.logInfo(`xr`,`session acquired`,{enabledFeatures:a?Array.from(a):[],environmentBlendMode:t.environmentBlendMode,interactionMode:t.interactionMode,visibilityState:t.visibilityState,handTracking:o}),e.setCurrentPhase(`xr:requestReferenceSpace(local-floor)`);let l,u=!1;try{l=await t.requestReferenceSpace(`local-floor`),u=!0,e.logInfo(`xr`,`using local-floor reference space`)}catch(n){e.logInfo(`xr`,`local-floor unavailable, falling back to local`,n.message),e.setCurrentPhase(`xr:requestReferenceSpace(local)`),l=await t.requestReferenceSpace(`local`)}e.initializeReferenceSpace(l,u),e.setCurrentPhase(`xr:createBinding`),n=new XRGPUBinding(t,e.device);let d=n.getPreferredColorFormat(),f=n.nativeProjectionScaleFactor;e.logInfo(`xr`,`projection preferences`,{preferredFormat:d,nativeProjectionScaleFactor:f}),e.markPostFxNeedsClear();let p=[{colorFormat:d,depthStencilFormat:`depth24plus`,scaleFactor:f,textureType:`texture-array`},{colorFormat:d,depthStencilFormat:`depth24plus`,textureType:`texture-array`},{colorFormat:d,scaleFactor:f,textureType:`texture-array`},{colorFormat:d,textureType:`texture-array`},{colorFormat:d,scaleFactor:f},{colorFormat:d}];e.setCurrentPhase(`xr:createProjectionLayer`);let m=null,h=[];for(let t of p)try{r=n.createProjectionLayer(t),m=t;break}catch(n){let i=n.message;h.push({config:t,error:i}),e.logInfo(`xr`,`projection layer config rejected`,{config:t,error:i}),r=null}if(!r)throw Error(`All projection layer configurations failed. Attempts: ${JSON.stringify(h)}`);e.logInfo(`xr`,`projection layer created`,{config:m,textureWidth:r.textureWidth,textureHeight:r.textureHeight,textureArrayLength:r.textureArrayLength,ignoreDepthValues:r.ignoreDepthValues});try{r.fixedFoveation=0,e.logInfo(`xr`,`fixedFoveation set to 0`)}catch(t){e.logInfo(`xr`,`fixedFoveation unsupported on this platform`,t.message)}e.setCurrentPhase(`xr:updateRenderState`),t.updateRenderState({layers:[r]}),e.logInfo(`xr`,`render state updated with projection layer`),t.addEventListener(`selectstart`,t=>{e.queuePendingSource(t.inputSource)}),t.addEventListener(`selectend`,t=>{e.onSelectEnd(t.inputSource)}),i.textContent=`Exit VR`,e.state.xrEnabled=!0,e.setCurrentPhase(`xr:awaiting first frame`),e.uiRegistry.layouts.set(`clipboard`,Xr(`left`)),e.uiRegistry.activeLayoutId=`clipboard`,e.uiRegistry.layouts.set(`debug-hud`,ii()),e.uiRegistry.hudLayoutIds.includes(`debug-hud`)||e.uiRegistry.hudLayoutIds.push(`debug-hud`),t.addEventListener(`visibilitychange`,()=>{e.logInfo(`xr`,`visibilitychange`,{visibilityState:t?.visibilityState})}),t.requestAnimationFrame(c),e.logInfo(`xr`,`first frame requested; waiting for xrFrame callback`),t.addEventListener(`end`,()=>{e.logInfo(`xr`,`session ended`,{finalPhase:e.getCurrentPhase(),framesRendered:s}),t=null,n=null,r=null,e.clearReferenceSpace(),e.setHandTrackingAvailable(!1),e.state.xrEnabled=!1,s=0,e.setCurrentPhase(`desktop`),e.markPostFxNeedsClear(),e.resetInputState(),i.textContent=`Enter VR`,e.requestDesktopFrame()})}catch(n){if(e.logError(`xr:toggle`,n,`session failed to start (phase=${e.getCurrentPhase()})`),i.textContent=`XR Error: ${n.message}`,t)try{t.end()}catch(t){e.logError(`xr:cleanup-end`,t)}t=null,e.clearReferenceSpace(),e.setHandTrackingAvailable(!1),e.setCurrentPhase(`desktop`),setTimeout(()=>{i.textContent=`Enter VR`},4e3)}}}}var J,oi=`boot`,si=Hn({getDevice:()=>J.device,getPhase:()=>oi});si.installGlobalHandlers();var{createShaderModuleChecked:ci,createShaderModuleCheckedForDevice:li,logError:ui,logInfo:di,showSimError:fi}=si,Y=re(t),pi,X;function mi(e){return Y[e]}var Z,Q,hi=96,gi=4,_i=208,vi=256,yi=null,$;function bi(e){return J.cameraSystem.getUniformData(e,X.getThemeColors(),Y.mouse)}function xi(){return{createShaderModuleChecked:li,currentSimStep:Z.currentSimStep,currentTimeDirection:Z.currentTimeDirection,dropSimulationIfCurrent:Ai,getCanvasContainer:()=>document.getElementById(`canvas-container`),getCurrentSimulation:()=>Di[Y.mode],getDefaultClearColor:()=>s,getThemeColors:()=>X.getThemeColors(),logError:ui,pruneAttractors:Z.prune,refreshThemeColors:e=>X.refreshThemeColors(e),restoreAfterDeviceLoss:Si,runDebugCompute:(e,t)=>X.runDebugCompute(e,t),showSimError:fi,state:Y,tickMarkers:Z.tickMarkers,updateAdaptiveChunk:e=>X.updateAdaptiveChunk(e),updateDebugPanel:()=>X.updateDebugPanel()}}async function Si(){let e=await ne(xi());e&&(J=e,Ti(),Fi(),J.frameRuntime.requestFrame())}function Ci(){let e=Di.physics;return C(e)?e:null}var wi=null;function Ti(){wi?.destroy(),wi=nr({cameraSize:_i,cameraStride:vi,createShaderModuleChecked:ci,device:J.device,getCameraUniformData:bi,renderSampleCount:J.renderSampleCount,renderTargetFormat:J.renderTargetFormat})}function Ei(e,t,n=0){wi?.render(e,t,n)}var Di={},Oi=null;function ki(e){let t=Oi?.get(e);t?Di[e]=t:delete Di[e]}function Ai(e,t){Oi?.dropIfCurrent(e,t),ki(e)}function ji(){let e=J.postFx;return{attractorMax:32,baseDt:Gn,cameraSize:_i,cameraStride:vi,clearColor:s,createShaderModuleChecked:ci,device:J.device,fluidGridResolution:hi,fluidWorldSize:gi,getAttractorStrength:Z.attractorStrength,getCameraUniformData:bi,getColorAttachment:(t,n,r)=>e.getColorAttachment(t,n,r,Y.fx.trailPersistence,s),getCurrentSceneView:()=>e.getCurrentSceneView(),getDefaultAspect:()=>J.canvas.width/J.canvas.height,getDepthAttachment:(t,n)=>e.getDepthAttachment(t,n,yi?.getDepthOverride()??null),getXrDepthOverride:()=>yi?.getDepthOverride()??null,markersPerAttractor:36,nullColorView:e.getNullColorView(),nullDepthView:e.getNullDepthView(),postFxDepthView:()=>e.getDepthView(),renderGrid:Ei,renderSampleCount:J.renderSampleCount,renderTargetFormat:J.renderTargetFormat,shapeIds:c,state:Y,tsWrites:e=>J.frameRuntime.tsWrites(e)}}function Mi(){Oi=zn({device:J.device,factories:Rn(ji()),reportError:(e,t)=>{fi(e,t),delete Di[e]}})}var Ni=matchMedia(`(max-width: 768px)`),Pi=Ni.matches;function Fi(){let e=Y.mode;Oi||Mi(),Oi?.ensure(e),ki(e)}function Ii(){let e=Y.mode;X.clearDebugState(),Oi||Mi(),Oi?.reset(e),ki(e)}async function Li(){Z=Qn({getCurrentPhysicsStep:()=>Ci()?.getSimStep()??0,getCurrentTimeDirection:()=>Ci()?.getTimeDirection()??1,getThemeColors:()=>X.getThemeColors(),state:Y}),Q=$n({fluidWorldSize:gi,getCanvas:()=>J.canvas,onCreateAttractor:Z.create,onMoveAttractor:Z.move,onReleaseAttractor:Z.release,state:Y});let s=await ne(xi());if(!s)return;J=s,X=ge({state:Y,storageKey:B,modeParams:mi,catalog:{defaults:t,defaultTheme:a,themeFadeMs:o,themes:i,fxParamDefs:u,modeTabLabels:d,paramDefs:r,presets:n,shapeParams:l},getActions:()=>pi,getCanvas:()=>J.canvas,getPhysicsSimulation:Ci,getActiveSimulation:()=>Di[Y.mode],getXrSession:()=>yi?.getSession()??null,toggleXr:async()=>{await yi?.toggle()},setXrDebugLogging:e=>$.setDebugLogging(e),createShaderModule:e=>J.device.createShaderModule({code:e}),applyShaderEdit:dn,resetShaderEdit:fn,getShaderSources:un,metrics:Wn}),pi=f({cancelDebugMovement:()=>X.cancelDebugMovement(),clearDebugState:()=>X.clearDebugState(),ensureSimulation:Fi,modeParams:mi,presets:n,reflectPaused:()=>X.syncPauseButtons(),resetCurrentSimulationInternal:Ii,saveStateInternal:()=>ve(Y,t,mi),selectTheme:e=>X.selectTheme(e),state:Y,syncUi:()=>X.syncUiFromState(),updatePrompt:()=>X.updatePrompt(),updateShaderPanel:()=>X.updateShaderPanel(),updateStats:()=>J.frameRuntime.updateStats()});let c=tr({actions:pi,applySimulationInteraction:(e,t,n,r)=>Q.applySimulationInteraction(e,t,n,r),getCanvas:()=>J.canvas,modeTabLabels:d,releasePointerInteraction:e=>Q.releasePointerInteraction(e),setSimulationInteractionInactive:Q.setSimulationInteractionInactive,state:Y,storageKey:B});$=vr({bindings:e,closestPointOnRayToOrigin:Q.closestPointOnRayToOrigin,createAttractor:Z.create,intersectRayWithPlane:Q.intersectRayWithPlane,metrics:Wn,moveAttractor:Z.move,releaseAttractor:Z.release,setSimulationInteractionInactive:Q.setSimulationInteractionInactive,state:Y,worldToFluidUV:Q.worldToFluidUV}),Mi(),yi=ai({cameraStride:vi,cameraSystem:J.cameraSystem,currentSimStep:Z.currentSimStep,currentTimeDirection:Z.currentTimeDirection,device:J.device,ensureHdrTargets:J.postFx.ensureHdrTargets,getCameraUniformData:bi,getCurrentPhase:()=>oi,getCurrentSimulation:()=>Di[Y.mode],getPostFxSceneFormat:e=>J.postFx.getSceneFormat(e),getPostFxSceneIndex:()=>J.postFx.getSceneIndex(),getPostFxSceneView:e=>J.postFx.getSceneView(e),getRefSpace:()=>$.getRefSpace(),getUiRenderList:()=>$.getRenderList(),initializeReferenceSpace:(e,t)=>$.initializeReferenceSpace(e,t),inputStep:e=>$.inputStep(e),logError:ui,logInfo:di,markPostFxNeedsClear:()=>J.postFx.markNeedsClear(),onSelectEnd:e=>$.onSelectEnd(e),postFxRunBloomChain:e=>J.frameRuntime.runBloomChain(e),postFxRunComposite:(e,t,n,r)=>J.frameRuntime.runComposite(e,t,n,r),pruneAttractors:Z.prune,queuePendingSource:e=>{$.queuePendingSource(e)},refreshThemeColors:e=>X.refreshThemeColors(e),requestDesktopFrame:()=>J.frameRuntime.requestFrame(),resetInputState:()=>$.reset(),clearReferenceSpace:()=>$.clearReferenceSpace(),setCurrentPhase:e=>{oi=e},setHandTrackingAvailable:()=>{},state:Y,tickFrameStats:e=>J.frameRuntime.tickFrameStats(e),tickMarkers:Z.tickMarkers,uiRegistry:$.getUiRegistry(),updateStats:()=>J.frameRuntime.updateStats()}),Pi=Ni.matches,document.body.classList.toggle(`mobile`,Pi),Ni.addEventListener(`change`,e=>{let t=e.matches;t!==Pi&&(Pi=t,document.body.classList.toggle(`mobile`,Pi),window.location.reload())}),Ot({appActions:pi,bindingRegistry:e,catalog:{defaults:t,fxParamDefs:u,modeTabLabels:d,paramDefs:r,presets:n,themes:i},ensureSimulation:Fi,getCurrentSimulation:()=>Di[Y.mode],gpuContext:J,initGrid:Ti,isMobile:Pi,metrics:{fps:()=>J.frameRuntime.getGpuStats().currentFps,gpuMs:()=>J.frameRuntime.getGpuStats().gpuFrameMs,errorCount:()=>si.getErrorCount()},mobileInput:c,modeParams:mi,pointerSystem:Q,state:Y,uiOrchestrator:X,xrInputSystem:$})}var Ri=Li;async function zi(){await Ri()}zi();